...
* The AFX 1K storage system utilizes 400GbEx100GbE breakout cables. The 400GBE connections are made to the switch ports, and the 100GbE connections are made to the controller and drive shelf ports. Storage and HA/Cluster connections can be made to any non-ISL port on the switch.

NOTE: Cisco Nexus 9332D-GX2B and 9364D-GX2A switch configurations to the AFX 1K system require 400GbEx100GbE breakout cable connections.
...
== Step 6: Configure the switches for your AFX 1K storage system
After you have cabled your AFX 1K storage system, you must configure the switches to support the AFX 1K storage system.
...
After you’ve cabled the hardware and configured the switches for your AFX 1K system, you link:power-on-hardware.html[power on the AFX 1K storage system].
