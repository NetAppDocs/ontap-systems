...
== Configure the switches for your AFX 1K storage system
...
After you’ve cabled the hardware and configured the switches for your AFF AFK 1K system, you link:power-on-hardware.html[power on the AFX 1K storage system].
