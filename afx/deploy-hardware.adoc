...
[.lead]
After you install the switches, you should install the hardware for your AFX storage system. First, install the rail kits. Then install and secure your storage system in a cabinet or telco rack.
