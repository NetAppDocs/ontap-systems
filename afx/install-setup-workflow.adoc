...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png[Five]link:cable-hardware.html[Cable the controllers and storage shelves for your AFX 1k storage system]
[role="quick-margin-para"]
...
[role="quick-margin-para"]
Before you power on the controllers, power on each storage shelf and assign a unique shelf ID to ensure each shelf is uniquely identified within the setup.
