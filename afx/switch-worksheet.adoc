...
---
= Complete the switch port assignment worksheet for your AFX 1K storage system
:icons: font
:imagesdir: ../media/

[.lead]
The sample port assignment worksheet provides examples of recommended port assignments from the switches to the controllers. The blank worksheet provides a template that you can use in setting up your cluster. Download a PDF of this page to complete the blank worksheet. 

* <<Sample port assignment worksheet>>
* <<Blank port assignment worksheet>>
