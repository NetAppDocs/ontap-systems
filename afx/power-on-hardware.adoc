...
NOTE: INTERNAL - Temporary link for IDR approvers.
After you've turned on your AFX 1K storage system, you link:https://review.docs.netapp.com/us-en/ontap-afx_main/install-setup/cluster-setup.html[set up an ONTAP AFX cluster].
