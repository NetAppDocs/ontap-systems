...
[.lead]
After you install the rack hardware for your AFX storage system and install the cables for the nodes and storage shelves, you should power on your storage shelves and nodes.
