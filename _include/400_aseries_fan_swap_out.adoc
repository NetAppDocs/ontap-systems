...
+
Use the BMC message or the fan LED to identify the fan module to replace. BMC maps fan modules as Fan#_# where the first number is the slot and the second is the row (1=top, 2=bottom); for example, slot 1, second row = Fan1_2.
