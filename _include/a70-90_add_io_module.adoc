...
. Install the I/O module:
 .. Align the I/O module with the edges of the chassis slot opening.
...
. If you installed a storage I/O module, install and cable your NS224 shelves, as described in https://docs.netapp.com/us-en/ontap-systems/ns224/hot-add-shelf.html[Hot-adds a shelf^].
