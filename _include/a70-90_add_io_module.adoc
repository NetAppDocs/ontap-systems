...
. Install the I/O module:
 ...
 .. Slide the I/O module into the slot until the cam latch begins to rotate a little upward.
 .. Rotate the I/O cam latch all the way up to lock the module in place.
...
.. Remove the I/O module from the chassis by pulling on the module cam latch.
+
