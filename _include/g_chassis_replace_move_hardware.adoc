Move the power supplies, drives, controllers, and bezel from the impaired chassis to the new chassis (of the same model), and then replace the chassis within the equipment rack or system cabinet.
