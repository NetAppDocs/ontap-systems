...
You remove the impaired chassis from the equipment rack or system cabinet, install the replacement chassis, and then install the drives.
...
Test: Reinstall the controllers into the chassis and reboot it.
