...
The NVRAM module disengages from the chassis and moves out a few inches.
 ...
 .. Remove the NVRAM module from the chassis by pulling the cam handle.
+
...
. Install the replacement NVRAM module into the chassis:
 ...
 .. Gently slide the module into the slot until the cam latch begins to engage with the I/O cam pin, and then push the cam latch all the way up to lock the module in place.
