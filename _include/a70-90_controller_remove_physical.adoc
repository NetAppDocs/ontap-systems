...
. Before removing the controller, ensure that all drives on the front of the chassis are firmly seated against the midplane by using your thumbs to push each drive until you feel a positive stop.  See the following illustration or video for guidance.
