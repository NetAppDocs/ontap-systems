...
. Before removing the controller module, verify that all drives on the front of the chassis are fully seated against the midplane. Gently press each drive with your thumbs until you feel it securely in place. Refer to the following illustration or video for guidance.
// ontap-systems-internal/issues/1151 
+
image::../media/drw_a800_drive_seated_IEOPS-960.svg[Seat disk drives]
+
video::bc172527-34bb-4fb7-9c58-b3800114821b[panopto, title="Video - Seating the drives before removing the controller module", width=640, height=360]
+
