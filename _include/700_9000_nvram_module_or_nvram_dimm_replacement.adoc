...
+
image::../media/drw_9000_remove_flashcache.png[Replacie the caching module]
+
...
+
NOTE: The release button on empty Flash Cache modules is gray.
...
+
image::../media/drw_9000_move_remove_nvram_module.png[Remove the NVRAM module]
+
...
+
image::../media/drw_9000_remove_nvram_module_contents.png[Remove the NVRAM module contents]
+
