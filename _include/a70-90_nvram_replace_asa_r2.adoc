...
. Verify that disk ownership is as expected: `storage disk show`
+
...
1.1.2                  10GB     1   2 spare       present    -         node2
1.1.3                  20GB     1   3 spare       present    -         node2
1.4.4                  20GB     4   4 spare       present    -         node2
...
1.4.11                 10GB     4  11 spare       present    -         node2
