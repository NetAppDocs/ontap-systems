...
Bring the replacement cluster and HA I/O module in slot 4 online, verify the ports initialized successfully, verify slot 4 is powered on, and then verify it is online and recognized.
