...
+
image::../media/drw_a900_remove_install_PSU_module.png[Remove or install a PSU module]
+
...
+
image::../media/drw_a900_remove_install_fan.png[Remove or installing the fan]
+
[cols="1,4"]
|===
a|
...
+
image::../media/drw_a900_remove_PCM.png[Remove the controller]
+
...
+
image:../media/drw_a900_remove_PCIe_module.png[Remove a PCIe module]
...
+
image::../media/drw_a900_remove_NV_battery.png[Remove an NV battery]
+
...
image::../media/drw_a900_remove_replace_LED_mod.png[Remove or replace a USB LED module]
