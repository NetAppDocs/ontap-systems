...
+
image::../media/drw_a900_remove_install_fan.svg[Remove or installing the fan]
+
[cols="1,4"]
|===
a|
...
+
image::../media/drw_a900_remove_PCM.svg[Remove the controller]
+
...
+
image:../media/drw_a900_remove_PCIe_module.svg[Remove a PCIe module]
...
image::../media/drw_a900_remove_replace_LED_mod.svg[Remove or replace a USB LED module]
