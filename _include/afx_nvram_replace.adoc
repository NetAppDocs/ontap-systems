...
+
In the command output, you should see a message that the system ID has changed on the impaired controller. In the following example, node2 has undergone replacement and displays current state.
+
----
...
+
The disks belonging to the controller should show the new system ID. In the following example, the disks owned by node1 now show the Home ID and Owner ID as zero (0) and empty (-). 
+
----
...
----- ------    ----- ------ -------- -------    -------    -------  ---------  ---
1.0.0  aggr0_1  node1  0       -        0        -                      0       Pool0
1.0.1  aggr0_1  node1  0                0        -                      0       Pool0
1.0.2  aggr0_1  node1  0                0        -                      0       Pool0
.
.
----
