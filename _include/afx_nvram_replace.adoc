...
+
The disks belonging to the controller should display. In the following example, the disks owned by node1 now show the Home ID and Owner ID as zero (0). 
+
----
...
----- ------    ----- ------ -------- -------    -------   -------      ---------    ---
1.0.0  aggr0_1  node1  0       -        0         0                      0           Pool0
1.0.1  aggr0_1  node1  0                0         0                      0           Pool0
.
.
----
