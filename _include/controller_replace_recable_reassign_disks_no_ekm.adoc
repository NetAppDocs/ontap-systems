...
--
// EKM not affected - With a controller replacement on these systems, the entire EKM configuration is untouched because nothing changes with SSN, system ID or contents of the boor device (/var). Only OKM requires restoration because of the new TPM chip on the new motherboard.
