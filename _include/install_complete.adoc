...
.Before you begin
Make sure your laptop is connected to the serial console port and the controllers are powered on. 
// See link:install-power-hardware.html('#step-2-power-on-the-controllers')[power on the storage system] for instructions.
