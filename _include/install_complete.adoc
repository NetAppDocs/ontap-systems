...
.Before you begin
Make sure your laptop is connected to the serial console port and the controllers are powered on. See link:install-power-hardware.html[power on the storage system] for instructions.

// Below was removed in favor of above to address CQP issue, but didn't work.
