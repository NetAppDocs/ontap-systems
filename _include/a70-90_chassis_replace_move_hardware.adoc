...
+
The controller module begins to boot as soon as it is fully seated in the chassis or after it is installed and power is restored. If it boots to the LOADER prompt, reboot the controller with the `boot_ontap` command.
