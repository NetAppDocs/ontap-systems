...
Display the status of the authentication keys and complete the appropriate procedure based on your key manager type:

`security key-manager key query`

Review the output and check the value in the `Restored` column. Complete the steps in the appropriate tab below.
--
