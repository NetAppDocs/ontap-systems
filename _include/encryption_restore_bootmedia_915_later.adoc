...
. At the clustershell prompt, enter the `network interface show -is-home false` command to list the logical interfaces that are not on their home controller and port.
+
