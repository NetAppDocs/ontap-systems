...
.. Remove the I/O module from the chassis by looping your finger into the can latch pulling the module out of the chassis.
...
+
image::../media/drw_A70_90_IO_remove_replace_IEOPS-1532.svg[AFF A70-90 IO card remove]
