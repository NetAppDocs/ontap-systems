To replace an I/O module, remove the target I/O module from the controller module and then install the replacement I/O module into the controller module.
