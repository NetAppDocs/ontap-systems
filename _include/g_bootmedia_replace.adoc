...
+
NOTE: Do not completely insert the controller in the chassis until instructed to do so later in the boot media replacement workflow.
+

. Recable the controller, as needed; however, do not plug in the power cord to the PSU at this time.
+
...
+
. Reconnect the power cord to the PSU on the impaired controller.
+
