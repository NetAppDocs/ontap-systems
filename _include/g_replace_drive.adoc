---
permalink: a20-30-50/g-replace-drive.html
sidebar: sidebar
keywords: aff a20, aff a30, aff a50, replace a drive
...
[.lead]
You can replace a failed drive nondisruptively in an AFF A20, AFF A30, and AFF A50 storage system that is powered on, and while I/O is in progress.

.Before you begin

* The drive that you are installing must be supported by the A20, AFF A30, and AFF A50 storage system.
+
...
a|
Push button to release the drive cam handle...
a|
image::../media/legend_icon_02.svg[Callout number 2,width=30px]
a|
Pull the cam handle into the open position...
a|
