...
. Check the amber NVMEM status LED located on the back of the system. There is also a green NVMEM LED on the front panel of the controller module. Look for the NV icon:
+
