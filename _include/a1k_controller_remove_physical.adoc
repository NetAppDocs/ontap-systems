...
+
image::../media/drw_A1K-70-90_NVRAM-LED_IEOPS-1463.svg[NVRAM attention and status LED location graphic AFF A1K]
+
[cols="1,4"]
|===
a|
...
+
image::../media/drw_A1K_PCM_remove_replace_IEOPS-1375.svg[Controller remove graphic AFF A1K]
+
[cols="1,4"]
|===
a|
