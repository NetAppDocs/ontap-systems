 ...
 ** If <lno-DARE> or <1Ono-DARE> is displayed in the command output, the system does not support NVE, go to link:../a1k/bootmedia-shutdown.adoc[Shut down the impaired controller].
 link:https://docs.netapp.com/us-en/bootmedia-shutdown.html[Shut down the impaired controller]
