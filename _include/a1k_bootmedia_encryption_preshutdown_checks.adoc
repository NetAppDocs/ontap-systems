 ...
 ** If <lno-DARE> or <1Ono-DARE> is displayed in the command output, the system does not support NVE, proceed to link:../a1k/bootmedia-shutdown.html[Shut down the impaired controller].
