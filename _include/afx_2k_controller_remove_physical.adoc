...
. Check the NVRAM status LED located in slot 4/5 and slot 6/7 of the system. There is also an NVRAM LED on the front panel of the controller module. Look for the NV icon:
+
