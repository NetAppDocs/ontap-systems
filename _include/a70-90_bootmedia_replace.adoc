...
**Ping engineering about this step. May not need remove controller since boot media is in system management module.**
...
+
 ...
 . If you have not already done so, close the air duct: **Ping engineering about this step. May not need to do this since boot media is in system management module.**
