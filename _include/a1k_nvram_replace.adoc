...
+
image::../media/drw_A1K_NVRAM12_remove_replace_IEOPS-1380.svg[Remove the NVRAM12 module and DIMMs AFF A1K]
+
[cols="1,4"]
|===
a|
...
. Rotate the cable management tray down by gently pulling the pins on the ends of the tray and rotating the tray down.
. Remove the target NVRAM module from the enclosure:
 .. Depress the cam button on the NVRAM module.
+
The cam button moves away from the enclosure.
 ...
 .. Rotate the cam latch as far as it will go.
  .. Remove the NVRAM module from the enclosure by hooking your finger into the cam lever opening and pulling the module out of the enclosure.
+
image::../media/drw_A1K_NVRAM12_remove_replace_IEOPS-1380.svg[Remove the NVRAM 12 module and DIMMs AFF A1K]
+
[cols="1,4"]
|===
a|
