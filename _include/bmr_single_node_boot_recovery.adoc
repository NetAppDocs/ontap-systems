...
. [[restore-key-manager]]  Restore the key manager using the appropriate procedure for your configuration:
+
// start tabbed area
+
[role="tabbed-block"]
...
. [[reenable-auto-giveback]]If automatic giveback was disabled, reenable it: 
+
