...
+
.. If either of the previous two commands returned results, collect the AutoSupport data from both controllers and contact NetApp Support for further assistance, otherwise go to the next step.
+
[source,cli]
----
