...
+
image::../media/drw_a5x_sys-mgmt_remove_ieops-1817.svg[Replace the System Management module]
...
+
image::../media/drw_a5x_sys-mgmt_replace_ieops-1373.svg[Boot media replace]
