...
+
image::../media/drw_a5x_psu_remove_replace_ieops-xxxx.svg[PSU remove]
...
+
image::../media/drw_a5x_fan_remove_replace_ieops-xxxx.svg[Remove fans]
+
[cols="1,4"]
...
+
image::../media/drw_a5x_remove_replace_nvmembat_ieops-xxxx.svg[Move the NV battery]
+
[cols="1,4"]
...
+
The DIMM locations for the AFF A5X are listed in the following table:
...
+
image::../media/drw_a5x_dimm_ieops-xxxx.svg[DIMM map]
+
[cols="1,4"]
...
image::../media/drw_a5x_io_remove_replace_ieops-xxxx.svg[Remove I/O module]
...
image::../media/drw_a5x_sys-mgmt_remove_ieops-xxxx.svg[Move the System Management module]
...
image::../media/drw_a5x_nvram12_remove_replace_ieops-xxxx.svg[Remove the NVRAM12 module and DIMMs]
...
include::../_include/a5x_controller_install_controller_replace.adoc[]