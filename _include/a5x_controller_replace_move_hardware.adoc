...
+
image::../media/drw_a5x_psu_remove_replace_ieops-1368.svg[PSU remove]
...
+
image::../media/drw_a5x_fan_remove_replace_ieops-1366.svg[Remove fans]
+
[cols="1,4"]
...
image::../media/drw_a5x_sys-mgmt_remove_ieops-1817.svg[Move the System Management module]
