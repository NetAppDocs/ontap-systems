...
** Your storage system must already be in a takeover state.
** The I/O module that failed must be a cluster/HA module and you must be replacing it with an equivalent card.
