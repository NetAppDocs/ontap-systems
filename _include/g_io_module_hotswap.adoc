...
. In admin privilege level, prepare the I/O module slot for removal, responding y when prompted whether to continue: 
+
...
+
::> system controller slot module insert -node _node1_ -slot _4_
+
Warning: IO_2X_100GBE_NVDA_NIC module in slot 4 of node node1 will be
