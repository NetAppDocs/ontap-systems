...
== Step 2: Replace the failed I/O module

Replace the failed cluster/HA module with an equivalent module:
...
Bring the replacement cluster/HA module online and verify it is online and recognized.
