...
image::../media/drw_a900_move-remove_NVRAM_module.png[Remove NVRAM module]
...
image::../media/drw_a900_remove_NVRAM_module_contents.png[Remove NVRAM module contents]
+
