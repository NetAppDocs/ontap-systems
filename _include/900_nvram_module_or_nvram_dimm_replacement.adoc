...
image::../media/drw_a900_move-remove_NVRAM_module.svg[Remove NVRAM module]
...
image::../media/drw_a900_remove_NVRAM_module_contents.svg[Remove NVRAM module contents]
+
