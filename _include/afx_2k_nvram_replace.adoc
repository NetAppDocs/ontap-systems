...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Remove the NVRAM12 module and DIMMs]
+
[cols="1,4"]
|===
a|
...
+
image::../media/drw_afx_2k_nvram_remove_replace_ieops-2881.svg[Remove the NVRAM 12 module and DIMMs]
+
[cols="1,4"]
|===
a|
...
+
NOTE: The Override system ID is only required for the NVRAM module replacement and not for the NVRAM DIMM replacement.
