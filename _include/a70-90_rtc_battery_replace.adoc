...
To replace the RTC battery, locate the ie, inside the controller and follow the specific sequence of steps.

. Locate the RTC battery under the air duct.
+
image::../media/drw_A70-90_RTC_bat_remove_replace_IEOPS-1371.svg[]
+
[cols="1,4"]
|===
a|
