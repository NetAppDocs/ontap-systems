...
+
image::../media/drw_A70-90_RTC_bat_remove_replace_IEOPS-1371.svg[Replace the RTC battery AFF A70-90]
+
[cols="1,4"]
|===
a|
...
_RTC date/time error. Reset date/time to default._
_RTC power failure error._
