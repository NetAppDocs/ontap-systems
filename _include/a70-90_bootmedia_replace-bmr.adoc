...
+
* For AC power supplies, unplug the power cords from the power supplies.
...
.. Rotate the cable management tray down by pulling the buttons on both sides of the cable management tray.
