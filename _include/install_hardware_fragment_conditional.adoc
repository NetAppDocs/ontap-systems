...
. Install the rail kits for your storage system and shelves using the instructions included with the kits.
...
. Install and secure the shelf. If your storage system did not come with any shelves, you can skip this step.
+
