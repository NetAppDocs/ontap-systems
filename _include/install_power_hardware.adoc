...
|===
a|
image::../media/icon_round_1.svg[Callout number 1,width=20] 
a|
Shelf end cap
a|
image::../media/icon_round_2.svg[[Callout number 2,width=20]
a|
Shelf faceplate 
a|
image::../media/icon_round_3.svg[[Callout number 3,width=20]
a|
Shelf ID number
a|
image::../media/icon_round_4.svg[[Callout number 4,width=20]
a|
Shelf ID button
