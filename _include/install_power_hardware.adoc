...
|===
a|
image::../media/icon_round_01.svg[Callout number 1,width=20] 
a|
Shelf end cap
a|
image::../media/icon_round_02.svg[[Callout number 2,width=20]
a|
Shelf faceplate 
a|
image::../media/icon_round_03.svg[[Callout number 3,width=20]
a|
Shelf ID number
a|
image::../media/icon_round_04.svg[[Callout number 4,width=20]
a|
Shelf ID button
