...
The procedure for replacing the RTC battery differs depending on whether your controller is a VER1 or VER2 model. Use the tabs below to select the appropriate instructions for your controller model.
