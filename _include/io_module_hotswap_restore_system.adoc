...
Even in 9.18.1GA and later, for any number of nodes in a cluster, the automatic take over happens? Or only happens in a two-node cluster? 
//Or is the 2-node cluster limitation and being in an automatic takeover state only applicable to 9.17.1 and 9.18.1RC; therefore, this section needs a tabbed option?
