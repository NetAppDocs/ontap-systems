...
+
image::../media/drw_ns224_a250_c250_f500f_1shelf_IEOPS-963.svg[Cabling for an AFF A250, C250 or FAS500f with one NS224 shelf and one set of PCIe card ports, width=452px]
