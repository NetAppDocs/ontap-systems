...
. Unplug the PSUs from the PSUs from the controller.

+
NOTE: .NOTE: If your system has DC power supplies, disconnect the power cable block from the PSU.
+
