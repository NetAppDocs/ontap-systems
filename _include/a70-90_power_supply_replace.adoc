...
+
image::../media/drw_A1K_PSU_remove_replace_IEOPS-1378.svg[Replace PSU AFF A70-90]
+
[cols="1,4"]
|===
a|
...
CAUTION: The PSU is short. Always use two hands to support it when removing it from the controller module so that it does not suddenly swing free from the controller module and injure you.
+
image::../media/drw_dcpsu_remove-replace-generic_IEOPS-788.svg[Remove a DC PSU AFF A70-90,width=500px]
+
[cols="1,4"]
|===
a|
