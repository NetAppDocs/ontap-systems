...
NOTE: After removing the DIMMs from the impaired controller, ensure that the DIMM socket retention tabs on all DIMM slots are fully returned to the locked position before closing the controller cover.
