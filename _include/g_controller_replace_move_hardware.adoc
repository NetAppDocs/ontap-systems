...
+
*Attention:* The NV LED blinks while destaging contents to the flash memory when you halt the storage system. After the destage is complete, the LED turns off.
+
