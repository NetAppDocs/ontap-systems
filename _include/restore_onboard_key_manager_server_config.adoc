...
IMPORTANT: If the following error message is seen post option 10, please reboot and repeat the option 10. If the issue persists post second option 10, please use the workaround in this article
...
. Once booted only with CFO aggregate execute the security key-manager onboard sync​​​​​​​ command.
