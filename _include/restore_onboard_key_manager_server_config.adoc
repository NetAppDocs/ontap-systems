...
* For ONTAP 9.7 and earlier, enter the hidden option `recover_onboard_keymanager`:
...
. Once booted only with CFO aggregate run the _security key-manager onboard sync​​​​​​​_ command: 
