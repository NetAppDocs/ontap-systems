...
+
image::../media/drw_A1K_NVRAM12_remove_replace_IEOPS-1380.svg[]
+
[cols="1,4"]
|===
a|
...
. Move NVDIMM into replacement module:
...
. Install the replacement module that you removed from the controller module.
