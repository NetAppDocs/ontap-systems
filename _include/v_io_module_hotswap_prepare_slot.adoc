...
//Jan 2026: For Vino, slot 4 cannot be used in examples because slots 4 and 5 hold the NVRAM modules.
...
. Label the cables to identify where they came from, and then unplug all cables from the target I/O module.
