 ...
 ** If your system has onboard keymanager, NSE or NVE configured, go to link:../a1k/bootmedia-encryption-restore.adoc[Post boot media replacement steps for OKM, NSE, and NVE].
