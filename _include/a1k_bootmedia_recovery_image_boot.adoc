...
.. On the impaired controller, press `Y` when prompted to use the restored configuration copy.
.. On the impaired controller, press `y` when prompted to use the restored configuration. 
.. On the impaired controller, press `y` when prompted to reboot the impaired controller. I
