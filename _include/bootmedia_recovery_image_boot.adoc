...
.. Set the impaired controller to advanced privilege level:
+
...
.. Press `Y` when prompted to reboot the impaired controller, then press `Ctrl-C` when you see the Boot Menu.
