...
+
The DIMM fits tightly in the slot, but you should be able to insert it easily. If not, realign the DIMM with the slot and reinsert it.
...
include::../_include/afx_controller_install_controller_replace.adoc[]
