...
// Weight will be more with 22 NVMe drives...later.
...
A DS460C shelf can weigh up to 260.4 lbs (118.1 kg). To lift the storage shelf, you might need up to five people or a hydraulic lift. Keep all components in the storage shelf (both front and rear) to prevent unbalancing the shelf weight.
...
// next applies only to fas50
ifdef::fas50[]
A DS460C shelf can weigh up to 260.4 lbs (118.1 kg). To lift the shelf, you might need up to five people or a hydraulic lift. Keep all components in the shelf (both front and rear) to prevent unbalancing the shelf weight.
