...
+
image::../media/drw_ns224_a900_2shelves.png[Cabling for an AFF/ASA A900 with two NS224 shelves and two IO modules]
...
+
image::../media/drw_ns224_a900_3shelves.png[Cabling for an AFF/ASA A900 with three NS224 shelves and four IO modules]
...
+
image::../media/drw_ns224_a900_4shelves.png[Cabling for an AFF/ASA A900 with four NS224 shelves and four IO modules]
