...
+
image::../media/drw_afx_2k_psu_remove_replace_ieops-2882.svg[Remove or replace PSU]
...
== Step 2: Remove the I/O cards, NVRAM12, NVRAM12-EX, and system management module
...
+
NOTE: Make sure that you keep track of which slot the I/O module was in.
...
+
image::../media/drw_nvram1_remove_only_ieops-2574.svg[Remove the NVRAM12 module]
+
[cols="1,4"]
|===
a|
...
. Remove the NVRAM12-EX module:
 .. Grab the handle on the module and depress the locking cam button.

 .. Pull the NVRAM12-EX module from the chassis while supporting the bottom of the module with your other hand.
+
...
a|
image:../media/icon_round_1.png[Callout number 1] |
NVRAM12-EX handle and cam button
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[System Management remove]
+
[cols="1,4"]
|===
a|
...
.. Rotate the locking latches into the locked position.
...
+ 
NOTE: Make sure to install the I/O modules in the same slots as they were in the impaired chassis.
...
.. If you have not already done so, reinstall the cable management device and reconnect the cables to the I/O cards and system management module.
+
...
. Install the NVRAM12-EX in the back of the chassis at the rear of the chassis:  
.. Align the end of the NVRAM12-EX module with the opening in the chassis, and then gently push the module all the way into the chassis.
.. Rotate the cam latch upward into the locked position.

. Install the PSUs:

.. Using both hands, support and align the edges of the PSU with the opening in the chassis.
.. Gently push the PSU into the chassis until the locking tab clicks into place.
+
