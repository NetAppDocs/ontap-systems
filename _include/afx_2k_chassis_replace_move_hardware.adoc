...
== Step 2: Remove the I/O cards, NVRAM12, NV12L, and system management module
...
. Remove the NV12L module:
 .. Grab the handle on the module and depress the locking cam button.

 .. Pull the NV12L module from the chassis while supporting the bottom of the module with your other hand.
+
image::../media/drw_afx_2k_nv12l_remove_replace_ieops-2879.svg[Remove the NV12L module]
+
[cols="1,4"]
|===
a|
image:../media/icon_round_1.png[Callout number 1] |
NV12L handle and cam button
