The NV12L module consists of the NVRAM12 hardware and field-replaceable DIMMs. You can replace a failed NV12L module or the DIMMs inside the NV12L module. 
...
== Step 2: Replace the NV12L module or NVRAM DIMM

Replace the NV12L module or NVRAM DIMMs using the appropriate following option.
...
.Option 1: Replace the NV12L module
--

To replace the NV12L module, locate it in slot 6/7 in the enclosure and follow the specific sequence of steps.
...
. Remove the impaired NV12L module from the enclosure:
...
+
 .. Remove the impaired NV12L module from the enclosure by hooking your finger into the cam lever opening and pulling the module out of the enclosure.
+
image::../media/[Remove the NV12L module and DIMMs]
+
[cols="1,4"]
|===
a|
...
. Set the NV12L module on a stable surface.
. Remove the DIMMs, one at a time, from the impaired NV12L module and install them in the replacement NV12L module.
. Install the replacement NV12L module into the enclosure:
...
To replace NVRAM DIMMs in the NV12L module, you must remove the NV12L module, and then replace the target DIMM.

. If you are not already grounded, properly ground yourself.
. Unplug the power supply cables from the PSUs.
. Rotate the cable management tray down by gently pulling the pins on the ends of the tray and rotating the tray down.
. Remove the target NV12L module from the enclosure.
+
image::../media/[Remove the NV12L module and DIMMs]
+
[cols="1,4"]
...
. Set the NV12L module on a stable surface.
. Locate the DIMM to be replaced inside the NV12L module.

+
NOTE: Consult the FRU map label on the side of the NV12L module to determine the locations of DIMM slots 1 and 2.
+
...
. Install the NV12L module into the enclosure:
...
== Step 4: Complete NV12L replacement

Perform the following steps to complete the NV12L replacement.
