The NVRAM12-EX module consists of the NVRAM12 hardware and field-replaceable DIMMs. You can replace a failed NVRAM12-EX module or the DIMMs inside the NVRAM12-EX module. 
...
Replace the NVRAM12-EX module, NVRAM DIMMs, or NVRAM battery using the appropriate following options.
