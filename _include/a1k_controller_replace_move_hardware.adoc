...
|===
a|
image::../media/icon_round_01.svg[Callout number 1,width=30x] 
a|
...
a|
image::../media/icon_round_02.svg[Callout number 2,width=30x]
a|
NV battery plug
a|
image::../media/icon_round_03.svg[Callout number 3,width=30x]
a|
NV battery pack
|===
