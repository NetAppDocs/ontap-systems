...
|===
a|
image:../media/legend_icon_01.svg[Callout number 1,width=width=30px] 
a|
Gray locking button
...
Move the Battery Backup unit (BBU) to the replacement controller.
...
BBU air duct cover
a|
image:../media/legend_icon_02.svg[Callout number 2,width=width=30px]
a|
BBU plug
a|
image:../media/legend_icon_03.svg[Callout number 3,width=width=30px]
a|
BBU pack
|===
...
. Grasp the battery and lift the battery out of the housing and controller module.
. Move the battery pack to the replacement controller module and then install it in the BBU air duct:
