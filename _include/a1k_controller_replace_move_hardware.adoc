...
. Open the BBU battery air duct cover and locate the BBU battery.
+
image::../media/drw_A1K_remove_replace_NVMEMBAT_IEOPS-1379.svg[AFF A1K BBU battery battery remove-replace]
+
[cols="1,4"]
|===
a|
