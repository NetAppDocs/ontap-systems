...
+
image::../media/drw_A1K_fan_remove_replace_IEOPS-1376.svg[]
+
[cols="10,90"]
|===
a|
...
== Step 3: Move the backup (NVRAM) battery

Move the backup battery 
...
== Step 5: Move the I/O modules


== Step 6: Install the controller module
