...
== Step 3: Move the Battery Backup Unit (NVDIMM battery)

Move the Battery Backup unit (NVDIMM battery) to the replacement controller.

. Open the NVDIMM battery air duct cover and locate the NVDIMM battery.
+
image::../media/drw_A1K_remove_replace_NVMEMBAT_IEOPS-1379.svg[AFF A1K NVDIMM battery battery remove-replace]
+
[cols="1,4"]
|===
a|
