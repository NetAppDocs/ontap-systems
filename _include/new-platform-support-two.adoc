...
AFF A-Series and AFF C-Series systems are compatible with the following ONTAP releases.
...
ASA r2 systems are compatible with the following ONTAP releases.
...
ASA systems are compatible with the following ONTAP releases.
...
FAS systems are compatible with the following ONTAP releases.
