 ...
 ** If <lno-DARE> or <1Ono-DARE> is displayed in the command output, the system does not support NVE, proceed to https://docs.netapp.com/us-en/ontap-systems/a70-90/bootmedia-shutdown.html[Shut down the impaired controller].
