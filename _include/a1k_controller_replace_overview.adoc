...
* In this procedure, the boot device, located in the System Management module, is moved with the System Management module from the impaired controller to the _replacement_ controller so that the _replacement_ controller will boot up in the same version of ONTAP as the impaired controller module.
