...
* In this procedure, you do not move the boot device to the replacement controller because the boot device is located in the System Management module, which is not part of the module.
