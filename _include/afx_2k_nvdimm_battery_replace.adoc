.About this task
This procedure applies to the replacement of a failed NV battery for the NVRAM module in slots 4 and 5 of the AFX 2K controller. For information on how to replace the NV battery for the NVRAM12-EX module in slots 6 and 7 of the AFX 2K controller, refer to link:nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery[Replace the NV battery for the NVRAM12-EX].
