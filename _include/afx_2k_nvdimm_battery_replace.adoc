.About this task
This procedure applies to the the replacement of a failed NV battery for the NVRAM module in slots 4 and 5 of the AFX 2K controller. For information on how to replace the NV battery for the NVRAM12-EX module in slots 6 and 7 of the AFX 2K controller, see <<afx-2k/nv12l-replace, Replace NVRAM12-EX - AFX 2K>>.
