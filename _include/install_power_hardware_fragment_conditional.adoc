...
+
// next bullet applies only to a20-30-50
ifdef::a20-30-50[]
* The shelf ID display on the front of the system chassis does not illuminate. The system's internal shelf ID is fixed at 00.
endif::a20-30-50[]
