...
.About this task
* A valid shelf ID is 01 through 99. For external shelves, you should number your first external shelf as 01 and your second external shelf as 02.
* Internal shelves are hard-coded to shelf ID 00.
...
+
image::../media/drw_a900_oie_change_ns224_shelf_id_ieops-836.svg[Change NSs224 shelf id]
+
...
After you've turned on your shelves and assigned them unique IDs, turn on the power to the storage controllers.
