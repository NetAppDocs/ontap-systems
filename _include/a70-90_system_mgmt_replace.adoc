...
. Align the edges of the replacement System Management module with the system opening and gently push it in until the cam handle engages and brgins to rotate upward.
