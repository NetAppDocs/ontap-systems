...
NOTE: The system management module is not a hot-swappable component. You must reseat drives, shut down the node, remove power from the controller, and pull the controller out of the chassis a few inches before replacing the System Management module.
