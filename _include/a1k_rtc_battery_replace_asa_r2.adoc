...
* Make sure all other components in the system are functioning properly; if not, you must contact contact https://support.netapp.com[NetApp support].
...
These messages are excpected and you can continue with this procedure.
 ...
 . Check the date and time on the healthy controller with the _cluster date show_ command.
