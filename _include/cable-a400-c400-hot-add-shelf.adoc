...
+
image::../media/drw_ns224_a400_1shelf.png[Cabling for an AFF A400 with one NS224 shelf and one set of onboard ports]
...
+
image::../media/drw_ns224_a400_2shelves_IEOPS-983.svg[Cabling for an AFF A400 with two NS224 shelves and one set of onboard ports and one set of ports on PCIe cards, width=452px]
...
The following illustration shows cabling for one hot-added shelf using one set of RoCE-capable ports on each controller:
+
image::../media/drw_ns224_c400_1shelf_IEOPS-985.svg[Cabling for an AFF C400 with one NS224 shelf and one set of PCIe card ports, width=452px]
...
The following illustration shows cabling for two hot-added shelves:
+
image::../media/drw_ns224_c400_2shelves_IEOPS-984.svg[Cabling for an AFF C400 with two NS224 shelves and two sets of PCIe card ports, width=452px]
