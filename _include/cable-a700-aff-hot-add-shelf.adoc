...
* You must have reviewed the link:hot-add-aff-requirements.html[hot-add requirements and best practices]. 

* You must have completed the applicable procedures in link:hot-add-aff-prepare.html[Prepare to hot-add a shelf]. 

* You must have installed the shelves, powered them on, and set the shelf IDs as described in link:hot-add-aff-install.html[Install a shelf for a hot-add].
