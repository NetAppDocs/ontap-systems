...
+
image::../media/drw_A70-90_remove_replace_NVMEMBAT_IEOPS-1369.svg[Move or replace the NV battery]
+
[cols="1,4"]
|===
a|
...
image::../media/drw_A70_90_IO_remove_replace_IEOPS-1532.svg[Remove-replace and I/O module]
...
.. Rotate the cam lever down until it is in a horizontal position.
+
The I/O module disengages from the chassis and moves about 1/2 inch out of the I/O slot.

.. Remove the I/O module from the chassis by pulling on the cam lever on the side of the module face.
.. Move the I/O module to the replacement controller module and insert it into the same slot in the replacement controller module.
.. Gently push the I/O module into the slot until the can latch engages.
.. Rotate the can lever upward until it locks into place.  
...
+
. Move the carrier contaning the I/O modules in slots 6 and 7 to the replacement controller module:
