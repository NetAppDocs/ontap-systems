...
== Step 1: Boot the controllers and give back the nodes 
...
Once the controller has given back the storage, you should check the overall health with Active IQ Config Advisor.
