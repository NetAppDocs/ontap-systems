...
!!!!!HEY, in the above step, the console cable was already connected to the replacement controller and laptop in topic Replace the controller, step 9 install the controller.
+
