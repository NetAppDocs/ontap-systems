...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[width=500px,Remove controller module]
+
[cols="10,90"]
|===
a|
...
image::../media/drw_c400_rtc_batt_IEOPS-1239.svg[width=550px,Remove RTC battery]
