...
. Remove the failed fan by firmly grasping the sides at the blue touch points, and then lift it vertically to disconnect it from its socket.
+
...
Pull the fan straight up and out its slot.
|===
