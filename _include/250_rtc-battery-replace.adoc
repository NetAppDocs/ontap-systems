...
+
image::../media/drw_a250_pcm_remove_install.png[Open the latching mechanism]
+
...
+
image::../media/drw_a250_open_controller_module_cover.png[Open the controller module cover]
+
...
+
image::../media/drw_a250_remove_airduct_cover.png[Lift out the air duct cover]
...
+
image::../media/drw_a250_remove_rtc_batt.png[Remove RTC battery]
+
...
+
image::../media/drw_a250_install_rtc_batt.png[Install the RTC battery]
+
|===
a|
image:../media/legend_icon_01.png[Callout number 1]|
