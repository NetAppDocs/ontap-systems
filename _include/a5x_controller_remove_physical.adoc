...
+
image::../media/drw_a5x_nvram-led_ieops-xxxx.svg[NVRAM attention and status LED location graphic]
+
...
+
image::../media/drw_a5x_pcm_remove_replace_ieops-xxxx.svg[Controller remove graphic]
+
[cols="1,4"]
|===
a|
