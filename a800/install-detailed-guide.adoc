...
---
= Install your AFF A800 system using detailed step-by-step instructions
:icons: font
:imagesdir: ../media/

[.lead]
Install your AFF A800 storage system using these detailed step-by-step instructions, from preparing the site to bringing up the ONTAP cluster.
