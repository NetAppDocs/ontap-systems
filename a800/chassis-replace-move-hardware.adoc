...
Replace the chassis in your AFF A70 or AFF A90 system when a hardware failure requires it. The replacement process involves removing the controllers, moving the drives to the replacement chassis, removing the impaired chassis, installing the replacement chassis, and reinstalling the chassis components. 
...
After you have replaced the impaired chassis and reinstalled the components, you need to link:chassis-replace-complete-system-restore-rma.html[complete the chassis replacement]
