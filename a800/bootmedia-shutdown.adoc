...
[.lead]
Shut down the impaired controller in your AFF A800 storage system to prevent data loss and maintain system stability during the manual boot recovery process.
