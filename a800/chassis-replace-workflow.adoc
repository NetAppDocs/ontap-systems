...
summary: Get started with replacing the chassis of your AFF A800 storage system by reviewing the replacement requirements, shutting down the controllers, replacing the chassis, and verifying system operations.
---
= Chassis replacement workflow - AFF A800
:icons: font
:imagesdir: ../media/

[.lead]
Get started with replacing the chassis of your AFF A800 storage system by reviewing the replacement requirements, shutting down the controllers, replacing the chassis, and verifying system operations. 
