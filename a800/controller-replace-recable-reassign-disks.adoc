...
[.lead]
Return control of storage resources to the replacement controller so your AFF A800 system can resume normal operation. The give back procedure varies based on the encryption type used by your system: no encryption or Onboard Key Manager (OKM) encryption.
