...
summary: Get started with replacing the controller in your AFF A800 storage system by shutting down the impaired controller, removing and replacing the controller, reconfiguring the system settings, and verifying system operations.
---
= AFF A800 controller replacement workflow
:icons: font
:imagesdir: ../media/

[.lead]
Replace the controller in your AFF A800 storage system by shutting down the impaired controller, removing and replacing the controller, restoring the system configuration, and returning control of storage resources to the replacement controller. 
