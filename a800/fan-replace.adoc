...
To replace a fan in the AFF A800, remove the failed fan module and replace it with a new fan module. The replacement process involves shutting down the impaired controller, removing it, replacing the fan module, reinstalling the controller, and then returning the failed part to NetApp.
