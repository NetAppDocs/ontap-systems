...
---
= Replace the NVDIMM battery in your AFF A800 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the NVDIMM battery in your AFF A800 system when it begins to lose charge or fails, because it preserves critical system data during power outages. The replacement process involves removing the controller module, replacing the battery, and reinstalling the controller module.
