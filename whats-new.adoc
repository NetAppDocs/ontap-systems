...
=== ASA r2 systems
The new ASA r2 hardware systems (ASA A1K, ASA A70, and ASA A90) systems deliver a unified hardware and software solution that creates a simplified experience specific to the needs of SAN-only customers. 
