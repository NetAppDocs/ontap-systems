...
I/O module hot-swap procedures are now available for multiple platform families, allowing you to replace I/O modules without shutting down the system in certain configurations. The hot-swap capability is supported for HA pairs running ONTAP 9.17.1 or later, and for systems running ONTAP 9.18.1 GA or later with specific requirements.

Hot-swap procedures have been added for the following systems:

* AFF A-Series: A1K, A20, A30, A50, A70, and A90
* ASA r2 systems: A1K, A20, A30, A50, A70, and A90  
* AFF C-Series: C80
* FAS: FAS70 and FAS90
