...
* link:https://docs.netapp.com/us-en/ontap-systems-switches/cluster/index.html[Cluster switches^]
* link:https://docs.netapp.com/us-en/ontap-systems-switches/storage/index.html[Storage switches^]
...
[role="quick-margin-list"]
* link:aff-aseries/index.html[AFF A-Series systems]
* link:aff-cseries/index.html[AFF C-Series systems]
