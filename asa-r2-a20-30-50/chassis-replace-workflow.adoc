...
[.lead]
Get started with replacing the chassis in your ASA A20, ASA A30, or ASA A50 storage system by reviewing the replacement requirements, shutting down the controllers, removing and replacing the chassis, and verifying system operations.
