...
summary: Replace an AC or DC power supply unit in your ASA A20, ASA A30, or ASA A50 storage system when it fails or becomes faulty, ensuring that your system continues to receive the required power for stable operation.
---
= Hot-swap a power supply unit in your ASA A20, ASA A30, or ASA A50 system
:icons: font
:imagesdir: ../media/
