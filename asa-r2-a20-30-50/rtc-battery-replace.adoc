...
+
. On the impaired controller, at the LOADER prompt, check the time and date: `cluster date show`

.. If necessary, modify the date: `set date _mm/dd/yyyy_`

.. If necessary, set the time, in GMT: `set time hh:mm:ss`
