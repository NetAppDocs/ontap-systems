...
After you’ve the reviewed the requirements to replace your ASA A20, ASA A30, or ASA A50 controller, you need to link:controller-replace-shutdown.html[shut down the impaired controller].
