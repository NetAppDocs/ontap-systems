---
permalink: asa-r2-a20-30-50/specifications.html
sidebar: sidebar
keywords: ASA A50 specifications, ASA A50 specs, NetApp ASA A50, ASA A50 hardware
summary: Key specifications for the ASA A50 storage system
---
...
[.lead]
The following are select specifications for the ASA A50. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA A50 specifications. This page is reflective of a single high availability pair. 
