...
[.lead]
You might need to perform maintenance procedures on your hardware. Procedures specific to maintaining your ASA A20, ASA A30, and ASA A50 system components are in this section.

The procedures in this section assume that the ASA A20, ASA A30, or ASA A50 storage systems have already been deployed as storage nodes in the ONTAP environment.
