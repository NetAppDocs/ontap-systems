...
summary: "Replace the real-time clock battery in your AFX 1K storage system to ensure that services and applications relying on accurate time synchronization remain operational."
---
= Replace the real-time clock battery in your AFX 1K storage system
:icons: font
:imagesdir: ../media/
