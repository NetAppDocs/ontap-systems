---
permalink: asa-r2/overview.html
sidebar: sidebar
summary: Key specifications for the ASA-R2 platform group
---
= Key specifications for ASA-R2 platform group
:icons: font
:imagesdir: ../media/

[.lead]
The following are select specifications for the ASA-R2 platform group. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of specifications. This page is reflective of a single high availability pair.
...
| NAS |  |  | 
| SAN | 6 | 11.0 PB / 9.8 PiB | 1536 GB
| HA Pair |  | 1.8 PB / 1.6 PiB | 256.0000
|===
