...
---
= Install and setup the ASA r2 systems
:icons: font
:imagesdir: ../media/

[.lead]
Go to the https://docs.netapp.com/us-en/asa-r2/install-setup/install-setup-workflow.html[ASA r2 install and setup instructions^] to learn how to install and setup your system.
