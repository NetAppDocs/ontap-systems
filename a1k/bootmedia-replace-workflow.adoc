...
[.lead]
If your boot media fails and your system cannot boot, you can manually recover your system using a replacement boot media and a USB drive containing a recovery image. The boot media replacement workflow guides you through preparing for and performing a manual boot media recovery, including replacing the failed media, restoring the ONTAP image, and reapplying encryption settings if necessary.
