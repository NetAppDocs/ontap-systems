...
a| The boot media stores a primary and secondary set of ONTAP image files that the system uses to boot the image from the partner node and automatically run the appropriate boot menu option to install the boot image on your replacement boot media.
