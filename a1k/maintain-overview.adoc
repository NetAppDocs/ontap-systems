...
---
= Learn about maintaining your AFF A1K storage system
:icons: font
:imagesdir: ../media/
...
a| The chassis houses the fans, controller, power supplies, NVRAM, system management module, I/O cards, and blanking modules.
