...
Cable your controllers to the shelf or shelves. The following examples shows how to cable your controllers to one shelf and to two shelves. You can connect your controllers to a maximum of four shelves.
...
image:../media/drw_a1k_2shelf_cabling_a_ieops-1705.svg[]
image:../media/drw_a1k_2shelf_cabling_b_ieops-1706.svg[]
