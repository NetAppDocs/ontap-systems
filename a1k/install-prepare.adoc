...
. Obtain a 19-inch (48.3-cm) cabinet or rack to fit the AFF A1K controllers (two chassis) -- ask marty/doug and the drive shelf of the following size (without cables). 
+
