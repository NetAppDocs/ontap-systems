...
. Confirm that your location provides the correct voltage of AC or DC power for your platform.

+
Check https://hwu.netapp.com[NetApp Hardware Universe^] for power requirements specific to your system configuration.

. Obtain a 19-inch (48.3-cm) cabinet or rack to fit your platform and shelf. See https://hwu.netapp.com[NetApp Hardware Universe^] for size requirements.
+
