...
summary: Replace a failed or faulty fan module in your AFF A1K system to maintain proper cooling and prevent system performance issues. This procedure includes identifying the faulty fan using console error messages and LED indicators, removing the bezel, swapping the fan module, and returning the failed part to NetApp.
---
