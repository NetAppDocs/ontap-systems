...
Cable your controllers the drive shelves. The following examples shows how to cable your controllers to one drive shelf and two drive shelves. You can connect your controllers to a maximum of four drive shelves.
