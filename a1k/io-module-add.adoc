...
summary: Add an I/O module to your AFF A1K system to enhance network connectivity and expand your system's ability to handle data traffic. 
---
= Add an I/O module in your AFF A1K system to enhance network connectivity
:icons: font
:imagesdir: ../media/
