...
.Before you begin
Make sure your laptop or console is cabled and configured and the controllers are powered on. See link:power-hardware.html#step-2-power-on-the-controllers[Power on the controllers] for instructions.
