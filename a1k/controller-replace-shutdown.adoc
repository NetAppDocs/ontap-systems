...
summary: Shut down the controller in your AFF A1K storage system to prevent data loss and ensure system stability when replacing the controller.
---
= Shut down the impaired controller in your AFF A1K system before replacement
:icons: font
:imagesdir: ../media/
