---
permalink: a1k/install-detailed-guide.html
sidebar: sidebar
keywords: aff a1k, detailed installation
summary: This section gives detailed step-by-step instructions for installing an AFF A1K system.
---
= Detailed steps - AFF A1K
:icons: font
:imagesdir: ../media/

[.lead]
This section gives detailed step-by-step instructions for installing an AFF A1K system.

== Step 1: Prepare for installation

To install your AFF A1K system, you need to create an account and register the system. You also need to inventory the appropriate number and type of cables for your system and collect specific network information.
...
+
image::../media/drw_client_mgmt_subnet_affa1k.png[]
