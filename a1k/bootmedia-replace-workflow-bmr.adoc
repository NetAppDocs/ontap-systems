...
[.lead]
In an AFF A1K storage system, boot media automatic recovery uses the partner node's boot image to reinstall ONTAP on the replacement boot media. The system automatically selects the appropriate boot menu option to complete the recovery.
