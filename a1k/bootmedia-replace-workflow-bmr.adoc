...
[.lead]
Boot media automatic recovery for your AFF A1K storage system uses the boot image from the partner node and automatically runs the appropriate boot menu option to install the boot image on your replacement boot media.
