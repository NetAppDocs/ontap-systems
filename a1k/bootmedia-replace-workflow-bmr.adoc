...
[.lead]
The boot media automatic recovery process automatically identifies and selects the appropriate boot menu option and uses the partner node's boot image to reinstall ONTAP on the AFF A1K system's replacement boot media.
