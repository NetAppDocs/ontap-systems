...
---
= Key specifications for an AFF A1K system
:icons: font
:imagesdir: ../media/

[.lead]
These are select specifications for the AFF A1K storage system in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] for the complete specifications for this storage system.
...
* Memory: 2048.0000 GB
* Form Factor: 2U chassis with 1 HA controller 
