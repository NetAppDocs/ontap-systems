...
[.lead]
The following are select specifications for the AFF A1K storage system in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] for the complete specifications for this storage system.
