...
[.lead]
To restore your system to full operation, you must verify the LIfs, check cluster health,  and return the failed part to NetApp, as described in the RMA instructions shipped with the kit.
