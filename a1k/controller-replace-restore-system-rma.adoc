...
[.lead]
To restore your system to full operation, you must install licenses for the new controller, check cluster health,  and return the failed part to NetApp, as described in the RMA instructions shipped with the kit.


== Step 1: Verify LIFs and and check cluster health

include::../_include/check_lifs_cluter_health.adoc[]
