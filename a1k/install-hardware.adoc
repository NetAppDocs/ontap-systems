...
* SuperRail kit for universal use in third-party cabinets (link to superrail topic)
* NetApp-specific rail kits designed for the NetApp 1280mm cabinet (link to topic)
