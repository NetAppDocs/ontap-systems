...
== Step 3: Install the storage system and drive shelf
If your cabinet or rack was delivered empty, use these steps to install your storage system and NS224 drive shelf. Skip this step if your cabinet or rack is pre-populated.
