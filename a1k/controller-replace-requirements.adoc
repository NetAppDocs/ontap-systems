...
After you’ve the reviewed the requirements to replace your AFF A1K controller, you need to link:controller-replace-shutdown.html[shut down the impaired controller].
