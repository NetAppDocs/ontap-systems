...
summary: "Install an ASA C250 storage system using detailed, step-by-step instructions that cover racking, cabling, and initial system bring-up."
---
= Install an ASA C250 storage system using detailed steps
:icons: font
:imagesdir: ../media/

[.lead]
Install an ASA C250 storage system using detailed, step-by-step instructions that cover racking, cabling, and initial system bring-up.
