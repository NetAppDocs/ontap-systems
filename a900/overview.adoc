...
[.lead]
The following are a selection of key specifications for AFF A70 in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A70 specifications.
