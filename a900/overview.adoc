...
---
= Key specifications for an AFF A900 system
:icons: font
:imagesdir: ../media/

[.lead]
AFF A900 storage systems in a single high-availability pair offer these key specifications. Visit https://hwu.netapp.com[NetApp Hardware Universe^] for the complete specifications for this storage system.
