...
a|
image::../media/oie_cable_sfp_gbe_copper.svg[Gbe copper SFP]
a|
Network cable
a|
32 Gb FC (SFP+ Op)
...
a|
image::../media/oie_cable100_gbe_qsfp28.svg[Gbe copper SFP]
a|
...
a|
image::../media/oie_cable_fiber_lc_connector.svg[LC fiber connector]
a|
FC optical network
a|
...
a|
image::../media/oie_cable_rj45.svg[RJ-45 cable connector]
a|
...
Not applicable
a|
image::../media/oie_cable_micro_usb.svg[Micro USB connector]
a|
...
Not applicable
a|
image::../media/oie_cable_power.svg[Power cable connector]
a|
...
+
image::../media/drw_9500_cable_management_arms.svg[Install cable management arm]
...
a|
image::../media/oie_legend_icon_1_lg.png[Callout icon one]
a|
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 Gb connector]
a|
image::../media/oie_legend_icon_2_lp.png[Callout icon two]
a|
...
a|
image::../media/oie_legend_icon_3_o.png[Callout icon three]
a|
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 GBe cable connector]
a|
image:../media/oie_legend_icon_4_dr.png[Callout icon four]
a|
...
image:../media/oie_cable_sfp_gbe_copper.svg[Gbe copper SFP]
a|
image::../media/oie_legend_icon_5_lp.png[Callout icon five]
a|
...
image:../media/oie_cable_power.svg[Power cable]
...
+
image:../media/drw_a900_switched_network_cabling_IEOPS-934.svg[Switched network cabling]
...
image:../media/oie_cable100_gbe_qsfp28.svg[100 Gbe cable]
a|
image:../media/oie_legend_icon_2_lo.png[Callout icon two]
a|
Cable controller management (wrench) ports.

image::../media/oie_cable_rj45.svg[RJ45 cables]
a|
image::../media/oie_legend_icon_3_o.png[Callout icon three]
a|
...
image::../media/oie_cable_pull_tab_down.svg[cable pull tab direction]
...
+
image::../media/drw_a900_NS224_one shelf_cabling_IEOPS-937.svg[Single shelf cabling]
+
...
|Step|Perform on each controller
a|
image::../media/oie_legend_icon_1_mb.png[Callout number one]
a|
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 Gbe QSFP connector]

100 GbE cable
a|
image::../media/oie_legend_icon_2_lo.png[Callout number two]
a|
...
+
image::../media/drw_a900_NS224_line_art_two shelf_cabling_IEOPS-1147.svg[Two shelf cabling]
+
image::../media/drw_a900_NS224_two_shelf_cabling_IEOPS-938.svg[Cabling two NS224 shelves]
+
...
image::../media/oie_legend_icon_1_mb.png[Callout icon one]
a|
...
image::../media/drw_a900_oie_change_ns224_shelf_ID_ieops-836.svg[Changing shelf ID]
...
Shelf end cap
a|
image::../media/legend_icon_02.png[Callout icon two]
a|
Shelf faceplate 
a|
image::../media/legend_icon_03.png[Callout icon three]
a|
Shelf ID LED
a|
image::../media/legend_icon_04.png[Callout icon four]
a|
...
+
image::../media/drw_a900_power-on_IEOPS-941.svg[Power switch]
+
...
+
image::../media/dwr_laptop_to_switch_only.svg[Laptop to switch connection]
+

. Select an ONTAP icon listed to discover:
+
image::../media/drw_autodiscovery_controler_select.svg[Autodiscovery]
 .. Open File Explorer.
