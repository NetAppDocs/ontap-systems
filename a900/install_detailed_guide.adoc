...
a|
image::../media/oie_cable100_gbe_qsfp28.png[Gbe copper SFP]
a|
...
Not applicable
a|
image::../media/oie_cable_power.png[Power cable connector]
a|
...
image::../media/drw_a900_controller_in _chassis_ID_IEOPS-856.svg[Typical cluster configuration]
...
a|
image::../media/icon_square_1_green.png[Callout icon one]
a|
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb connector]
a|
image::../media/icon_square_2_purple.png[Callout icon two]
a|
...
a|
image::../media/icon_square_3_orange.png[Callout icon three]
a|
...
image::../media/oie_cable100_gbe_qsfp28.png[100 GBe cable connector]
a|
image:../media/icon_square_4_red.png[Callout icon four]
a|
...
image:../media/oie_cable100_gbe_qsfp28.png[100 Gbe cable]
a|
image:../media/icon_square_2_purple.png[Callout icon two]
a|
Cable controller management (wrench) ports.
...
100 GbE cable
a|
image::../media/icon_square_2_yellow.png[Callout number two]
a|
...
100 GbE cable
a|
image::../media/icon_square_2_yellow.png[Callout icon two]
a|
