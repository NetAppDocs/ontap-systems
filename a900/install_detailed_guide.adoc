...
+
image:drw_9500_lifting_icon.svg[Weight lifting caution label]

. Attach cable management devices (as shown).
+
image:drw_9500_cable_management_arms.svg[Install cable management arm]
...
|Step|Perform on each controller
a|
image:oie_legend_icon_1_mb.svg[Callout number one]
a|
...
image:oie_cable100_gbe_qsfp28.svg[100 Gbe QSFP connector]

100 GbE cable
a|
image:oie_legend_icon_2_lo.svg[Callout number two]
a|
...
|===
a|
image:legend_icon_01.svg[Callout icon one] 
a|
Shelf end cap
a|
image:legend_icon_02.svg[Callout icon two]
a|
Shelf faceplate 
a|
image:legend_icon_03.svg[Callout icon three]
a|
Shelf ID LED
a|
image:legend_icon_04.svg[Callout icon four]
a|
