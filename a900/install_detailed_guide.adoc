...
|Step|Perform on each controller
a|
image::../media/oie_icon_round_1_mb.png[Callout number one]
a|
...
image::../media/oie_icon_round_1_mb.png[Callout icon 1]
a|
...
Shelf end cap
a|
image::../media/icon_round_02.png[Callout icon 2]
a|
Shelf faceplate 
a|
image::../media/icon_round_03.png[Callout icon 3]
a|
Shelf ID LED
a|
image::../media/icon_round_04.png[Callout icon 4]
a|
