...
a|
image:oie_cable_sfp_gbe_copper.svg[width=85px]
a|
Network cable
a|
32 Gb FC (SFP+ Op)
...
a|
image:oie_cable100_gbe_qsfp28.svg[width=85px]
a|
...
a|
image:oie_cable_rj45.svg[width=85px]
a|
...
image:drw_a900_controller_in _chassis_ID_IEOPS-856.svg[Typical cluster configuration]
...
a|
image:oie_legend_icon_1_lg.svg[width=30px]
a|
...
image:oie_cable100_gbe_qsfp28.svg[width=85px]
a|
image:oie_legend_icon_2_lp.svg[width=30px]
a|
...
a|
image:oie_legend_icon_3_o.svg[width=30px]
a|
...
image:oie_cable100_gbe_qsfp28.svg[width=85px]
a|
image:oie_legend_icon_4_dr.svg[width=30px]
a|
