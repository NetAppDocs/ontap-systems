...
+
image::../media/drw_ssn_label.svg[width=170px,System serial number label]
...
+
image::../media/drw_9500_lifting_icon.svg[width=340px,Weight lifting caution label]

. Attach cable management devices (as shown).
+
image::../media/drw_9500_cable_management_arms.svg[width=340px,Install cable management arm]
...
image::../media/drw_a900_controller_in _chassis_ID_IEOPS-856.svg[width=500px,Typical cluster configuration]
...
image::../media/oie_cable_pull_tab_up.svg[width=200px,cable pull tab direction]
...
+
image::../media/drw_a900_tnsc_network_cabling_IEOPS-933.svg[width=500px,Two-node switchless network cabling]
+
