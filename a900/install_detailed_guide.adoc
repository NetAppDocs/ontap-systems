...
a|
image::../media/oie_legend_icon_1_lg.svg[Callout icon one]
a|
...
a|
image::../media/oie_legend_icon_2_lp.svg[Callout icon two]
a|
...
image:oie_cable_sfp_gbe_copper.svg[GBe copper SFP]
...
a|
image:../media/oie_legend_icon_4_dr.svg[Callout icon four]
a|
...
image:../media/oie_cable100_gbe_qsfp28.svg[100 Gbe cable connector]
a|
image:../media/oie_legend_icon_2_lo.svg[Callout icon two]
a|
Cable controller management (wrench) ports.
...
|Step|Perform on each controller
a|
image::../media/oie_legend_icon_1_mb.svg[Callout number one]
a|
...
100 GbE cable
a|
image::../media/oie_legend_icon_2_lo.svg[Callout number two]
a|
...
image::../media/oie_legend_icon_1_mb.svg[Callout icon one]
a|
...
+
image::../media/drw_A900_cable_console_switch_controller_IEOPS-953.svg[Consol cable connection]
