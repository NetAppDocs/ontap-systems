...
summary: Before replacing the boot media in your AFF A900 system, verify that you meet the necessary requirements for a successful replacement. This includes making sure you have a USB flash drive with the appropriate amount of storage and verifying that you have the correct replacement boot device.
---
= Review requirements for manual boot media recovery in your AFF A900 system
:icons: font
:imagesdir: ../media/
...
After you've reviewed the requirements to replace the boot media, link:bootmedia-encryption-preshutdown-checks.html[check encryption key support and status on the boot media].
