...
---
= Shut down the impaired controller in your AFF A900 system during the manual boot recovery process
:icons: font
:imagesdir: ../media/

[.lead]
Shut down the impaired controller in your AFF A900 storage system to prevent data loss and maintain system stability during the manual boot recovery process.
