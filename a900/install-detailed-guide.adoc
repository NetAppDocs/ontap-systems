...
---
= Install your AFF A900 system using detailed step-by-step instructions
:icons: font
:imagesdir: ../media/

[.lead]
Install your AFF A900 storage system using these detailed step-by-step instructions, from preparing the site to bringing up the ONTAP cluster.
...
|Step|Perform on each controller
a|
image::../media/icon_square_1_blue.png[Callout number one]
a|
...
+
The NS224 shelves are pre-set to shelf ID 00 and 01. If you want to change the shelf IDs, you must create a tool to insert into the hole where the button is located. See link:../ns224/change-shelf-id.html[Change a shelf ID - NS224 shelves] for detailed instructions.
+
...
NOTE: Initial booting might take up to eight minutes.
...
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[Select an ONTAP icon]
 ...
 .. Open File Explorer.
.. Select *Network* in the left pane and right-click, then select *refresh*.
...
====
// 2024-09-30 ontap-systems-internal/issues/902