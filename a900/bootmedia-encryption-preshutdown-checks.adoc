...
[.lead]
To ensure data security on your AFF A900 storage system, you need to verify the encryption key support and status on your boot media. Check if your ONTAP version supports NetApp Volume Encryption (NVE). Before you shut down the controller, check if the key manager is active. 
