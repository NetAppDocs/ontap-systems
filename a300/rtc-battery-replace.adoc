...
summary: "Replace the real-time clock battery in your AFF A300 controller module to ensure that services and applications that depend on accurate time synchronization continue to function."
---
= Replace the real-time clock battery in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the real-time clock (RTC) battery in your AFF A300 system to ensure that services and applications that depend on accurate time synchronization continue to function.
...
+
image::../media/drw_rxl_rtc_battery.png[Remove or replace RTC battery]
