...
---
= Hot-swap a fan in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Hot-swap a fan module in your AFF A300 system without interrupting service to maintain proper airflow and system cooling.
