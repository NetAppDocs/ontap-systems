...
summary: "The procedure for booting the impaired controller from the recovery image depends on whether the system is in a two-node MetroCluster configuration. The AFF A300 system supports only manual boot media recovery procedures."
---
= Boot the recovery image on your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
The procedure for booting the impaired controller from the recovery image depends on whether the system is in a two-controller MetroCluster configuration. The AFF A300 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported.
