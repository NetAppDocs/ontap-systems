...
---
= Replace the NVMEM battery in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the NVMEM battery in your AFF A300 system by removing the controller module, opening it, replacing the battery, and reinstalling the controller module.
