...
---
= Restore and verify the controller configuration in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Restore and verify the controller configuration in your AFF A300 system after completing the hardware replacement and booting to Maintenance mode.
