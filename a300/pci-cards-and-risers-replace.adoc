...
---
= Replace a PCIe card in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace a PCIe card in your AFF A300 system by disconnecting cables, removing the card, installing the replacement, and recabling.
