...
---
= Review requirements before replacing the controller in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Before replacing the controller in your AFF A300 system, review the prerequisites for the replacement procedure and select the correct one for your version of ONTAP.
