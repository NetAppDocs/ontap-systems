...
---
= Hot-swap a power supply in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Hot-swap a power supply in your AFF A300 system by turning off, disconnecting, and removing the failed unit, then installing and reconnecting the replacement.
