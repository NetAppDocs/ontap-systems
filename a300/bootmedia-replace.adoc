...
summary: "You must locate the boot media in the controller and follow the directions to replace it. The AFF A300 system supports only manual boot media recovery procedures."
---
= Replace the boot media in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
To replace the boot media, you must remove the impaired controller module, install the replacement boot media, and transfer the boot image to a USB flash drive. The AFF A300 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported.
