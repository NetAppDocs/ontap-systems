...
summary: "Replace the controller in your AFF A300 system by removing the impaired controller, moving FRU components to the replacement module, installing it in the chassis, and booting to Maintenance mode."
---
= Replace the controller in an AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the controller in your AFF A300 system by removing the impaired controller, moving FRU components to the replacement module, installing it in the chassis, and booting to Maintenance mode.
