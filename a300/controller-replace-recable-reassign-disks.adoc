...
---
= Recable the system and reassign disks in your AFF A300 system
:icons: font
:imagesdir: ../media/

[.lead]
Complete the controller replacement for your AFF A300 system by recabling the storage and confirming disk reassignment.
