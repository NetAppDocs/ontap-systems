...
---
= Key specifications for an AFF A250 system
:icons: font
:imagesdir: ../media/

[.lead]
Review select specifications for the AFF A250 storage system, reflective of a single high-availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A250 specifications. 
