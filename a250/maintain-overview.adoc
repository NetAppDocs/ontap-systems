...
---
= Learn about maintaining your AFF A250 storage system
:icons: font
:imagesdir: ../media/

[.lead]
Maintain the hardware of your AFF A250 storage system to support long-term reliability and optimal performance. Perform regular maintenance tasks such as replacing faulty components, as this helps prevent downtime and data loss. 
...
a| link:mezzanine-replace.html[Mezzanine card]
...
a| The NVMEM battery is responsible for preserving cached data if the AC power fails.
