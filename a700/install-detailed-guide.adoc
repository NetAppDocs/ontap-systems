...
---
= Install your AFF A700 storage system using detailed steps
:icons: font
:imagesdir: ../media/

[.lead]
Install your AFF A700 storage system using detailed step-by-step instructions, from racking and cabling to initial system bring-up.
...
+
image::../media/drw_9000_lifting_icon.png[Lifting weight cautions]
+
...
+
image::../media/drw_9000_cable_management_arms.png[Attaching cable management devices]
...
+
image::../media/drw_9000_TNSC_composite_cabling.png[Two node switchless cluster composite cabling]
...
+
image:../media/drw_9000_switched_cluster_cabling.png[Switched cluster composite cabling]
