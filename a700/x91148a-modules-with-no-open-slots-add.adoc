...
---
= Add an X91148A storage module to your AFF A700 system when all slots are occupied
:icons: font
:imagesdir: ../media/

[.lead]
Add an X91148A storage module to your AFF A700 system when all slots are occupied by replacing an existing module.
