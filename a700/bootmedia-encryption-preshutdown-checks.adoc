...
[.lead]
To ensure data security on your storage system, you need to verify the encryption key support and status on your boot media. The AFF A700 system and the FAS9000 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported.
