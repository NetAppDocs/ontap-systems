...
---
= Shut down the impaired controller in your AFF A700 system before replacement
:icons: font
:imagesdir: ../media/

[.lead]
Shut down the impaired controller in your AFF A700 system before replacement using the appropriate procedure for your configuration.
