...
summary: "You must locate the boot media in the controller module, and then follow the directions to replace it. The AFF C190 system supports only manual boot media recovery procedures."
---
...
[.lead]
To replace the boot media, you must remove the impaired controller module, install the replacement boot media, and transfer the boot image to a USB flash drive. The AFF C190 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported.
