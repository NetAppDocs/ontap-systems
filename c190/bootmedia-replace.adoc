...
summary: "Replace the failed boot media on an AFF C190 controller module. TThe AFF C190 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported."
---
