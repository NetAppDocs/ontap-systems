...
summary: "Replace the failed boot media on an AFF C190 controller module. The AFF C190 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported."
---
= Replace the boot media in your AFF C190 system
:icons: font
:imagesdir: ../media/
