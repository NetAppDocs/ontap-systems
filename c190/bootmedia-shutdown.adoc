...
summary: "Shut down the impaired controller on an AFF C190 system after completing encryption checks. The AFF C190 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported."
---
