...
summary: "Verify encryption key support and status before shutting down the impaired controller on an AFF C190 system. The AFF C190 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported."
---
= Check encryption support on the boot media in an AFF C190 system
:icons: font
:imagesdir: ../media/
