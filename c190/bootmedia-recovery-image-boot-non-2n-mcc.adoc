...
summary: "Boot the ONTAP recovery image from the USB drive on an AFF C190 system to restore the boot media. The AFF C190 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported."
---
= Boot the recovery image on your AFF C190 system
:icons: font
:imagesdir: ../media/
