---
permalink: fas8300/specifications.html
sidebar: sidebar
keywords: FAS8300 specifications, FAS8300 specs, NetApp FAS8300, FAS8300 hardware
summary: Key specifications for the FAS8300 storage system
---
...
[.lead]
The following are select specifications for the FAS8300. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of FAS8300 specifications. This page is reflective of a single high availability pair. 
