...
---
= Replace a PCIe or mezzanine card in your FAS8300 or FAS8700 system
:icons: font
:imagesdir: ../media/
...
The riser raises up slightly from the controller module.
 ...
 .. Lift the riser straight up and set it aside on a stable, flat surface.
...
. Install the replacement PCIe card in the riser by aligning the card with the socket, pressing the card into the socket, and then closing the side panel on the riser, if present.
+
