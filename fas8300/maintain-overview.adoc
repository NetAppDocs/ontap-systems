...
summary: Maintain the hardware of your FAS8300 or FAS8700 storage system to ensure long-term reliability and optimal performance. Perform regular maintenance tasks such as replacing faulty components, as this helps prevent downtime and data loss.
---
= Learn about maintaining your FAS8300 or FAS8700 storage system
:icons: font
:imagesdir: ../media/

[.lead]
Maintain the hardware of your FAS8300 or FAS8700 storage system to ensure long-term reliability and optimal performance. Perform regular maintenance tasks such as replacing faulty components, as this helps prevent downtime and data loss.
...
a| An NVDIMM battery is responsible for maintaining power to the NVDIMM module.
