...
---
= Hot-swap a fan module in a FAS8300 or FAS8700 system
:icons: font
:imagesdir: ../media/

[.lead]
You can hot-swap a fan module in your FAS8300 or FAS8700 system without interrupting service. To avoid overheating, you must replace the fan module within two minutes of removing it from the chassis.
