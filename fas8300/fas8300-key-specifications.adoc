...
---
= Key specifications for a FAS8300 system
:icons: font
:imagesdir: ../media/

[.lead]
Review select specifications for the FAS8300 storage system in a single high-availability (HA) pair, and visit NetApp Hardware Universe (HWU) for the complete specifications for this system.
