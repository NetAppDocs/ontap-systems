...
---
= Replace the boot media in your FAS8300 or FAS8700 system using the manual boot recovery process
:icons: font
:imagesdir: ../media/
...
Although the contents of the boot media are encrypted, it is a best practice to erase the contents of the boot media before replacing it. For more information, see the https://mysupport.netapp.com/info/web/ECMP1132988.html[Statement of Volatility] for your system on the NetApp Support Site.
...
. Open the air duct:
+
image::../media/drw_A400_open-air-duct.png[Opening the air duct]
+
