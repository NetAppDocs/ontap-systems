...
---
= Install a FAS8300 or FAS8700 system using detailed step-by-step instructions
:icons: font
:imagesdir: ../media/

[.lead]
These detailed, step-by-step instructions guide you through installing your FAS8300 or FAS8700 system, from racking and cabling to initial setup. Use these steps if you want more in-depth installation guidance than the quick steps provide.
...
a|
16 Gb FC or 25 GbE cables for mezzanine cards (order-dependent)
a|
...
NOTE: If the port labels on the card are not visible, check the card installation orientation (the PCIe connector socket is on the left side of the card slot in the A400 and FAS8300/8700), and then look for the card, by part number, in the https://hwu.netapp.com[NetApp Hardware Universe^] for a graphic of the bezel that shows the port labels. The card part number can be found using the `sysconfig -a` command or on the system packing list.
...
+
image::../media/drw_fas8300_TNSC_network_cabling.png[Two-node switchless cluster cabling diagram]
...
+
image::../media/drw_fas8300_switched_network_cabling.png[Switched cluster network cabling diagram]
...
+
image::../media/drw_fas8300_three-ds224c_shelves.png[Three DS224C shelf cabling diagram]
...
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[Select an ONTAP icon]
 ...
 .. Open File Explorer.
.. Select *Network* in the left pane, right-click *Network*, and then select *Refresh*.
..  Double-click either ONTAP icon and accept any certificates displayed on your screen.
+
NOTE: In this example, XXXXX represents the system serial number for the target node.
+
