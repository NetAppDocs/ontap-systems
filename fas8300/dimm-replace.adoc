...
summary: "You must replace the DIMM in the controller when your storage system encounters errors such as excessive correctable ECC memory errors or uncorrectable ECC errors, typically caused by a single DIMM failure preventing the storage system from booting ONTAP."
---
...
[.lead]
You must replace the DIMM in the controller when your storage system encounters errors such as excessive correctable ECC memory errors based on Health Monitor alerts, or uncorrectable ECC errors. These errors are typically caused by a single DIMM failure that prevents the storage system from booting ONTAP.
