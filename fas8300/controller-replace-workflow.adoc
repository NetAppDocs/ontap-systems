...
summary: Replace the controller in your FAS8300 or FAS8700 storage system by shutting down the impaired controller, removing and replacing the controller, restoring the system configuration, and returning control of storage resources to the replacement controller.
---
= Controller replacement workflow - FAS8300 and FAS8700
:icons: font
:imagesdir: ../media/

[.lead]
Replace the controller in your FAS8300 or FAS8700 storage system by shutting down the impaired controller, removing and replacing the controller, restoring the system configuration, and returning control of storage resources to the replacement controller. 
