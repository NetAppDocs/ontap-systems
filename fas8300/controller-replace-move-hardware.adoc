...
image::../media/drw_8300_empty_riser_remove.png[Remove the empty riser]
...
image::../media/drw_A400_Replace-mezz-card.png[Remove the mezzanine card]
...
image::../media/drw_A400_Replace-flashcache.png[Remove and replace the caching module]
