...
image::../media/drw_A400_nvdimm-batt.png[Removing the NVDIMM battery]
...
image::../media/drw_A400_Replace-boot_media.png[Removing the boot media]
...
image::../media/drw_A400_Replace-PCIe-cards.png[Removing the PCIe cards]
...
image::../media/drw_A400_Replace-mezz-card.png[Removing the mezzanine card]
