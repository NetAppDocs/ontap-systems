...
---
= Replace the chassis in your FAS8300 or FAS8700 system
:icons: font
:imagesdir: ../media/
...
. If you are not already grounded, properly ground yourself.
. With two people, install the replacement chassis into the equipment rack or system cabinet by guiding the chassis onto the rack rails in a system cabinet or equipment rack.
...
For HA pairs with two controller modules in the same chassis, install the controller modules in the correct sequence. Each controller attempts to reboot as soon as it is fully seated in the chassis.
