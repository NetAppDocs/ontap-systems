...
summary: "To replace a PCIe card, you must remove the controller module from the system, open the side panel, remove the failed card, install the replacement card, and then reinstall the controller module."
---
= Replace a PCIe card in your FAS8200 system
:icons: font
:imagesdir: ../media/

[.lead]
To replace a PCIe card, you must remove the controller module from the system, open the side panel, remove the failed card, install the replacement card, and then reinstall the controller module.
