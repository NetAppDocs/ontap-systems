...
summary: "After replacing the controller, recable the system and confirm that disk ownership is reassigned so your FAS8200 system can resume normal operations."
---
= Give back the controller in your FAS8200 system to resume normal operations
:icons: font
:imagesdir: ../media/

[.lead]
After replacing the controller, recable the system and confirm that disk ownership is reassigned so your FAS8200 system can resume normal operations.
