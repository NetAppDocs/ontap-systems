...
summary: "You must replace the caching module in the controller module when your system registers a single AutoSupport message that the module has gone offline. Failure to do so results in performance degradation."
---

= Replace the caching module in your FAS8200 system
:icons: font
:imagesdir: ../media/
...
* All other components in the storage system must be functioning properly; if they are not, contact technical support.
...
+
image::../media/drw_rxl_fcache.png[Caching module remove or replace]
