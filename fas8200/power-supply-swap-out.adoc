...
summary: "Swapping out a power supply unit involves turning off, disconnecting, and removing the old power supply and installing, connecting, and turning on the replacement power supply."
---
= Hot-swap a power supply unit in a FAS8200 system
:icons: font
:imagesdir: ../media/

[.lead]
Swapping out a power supply unit involves turning off, disconnecting, and removing the old power supply and installing, connecting, and turning on the replacement power supply.
