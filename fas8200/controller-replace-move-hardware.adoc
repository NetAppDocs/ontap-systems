...
---
= Replace the controller in your FAS8200 system
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_rxl_boot_media.png[Removing the boot media]
...
+
The DIMM fits tightly in the slot, but it should go in easily. If it doesn't, realign the DIMM with the slot and reinsert it.
+
...
+
image::../media/drw_rxl_fcache.png[Remove and replace the caching module]
+
...
a|
 ...
 .. With the cam handle in the open position, firmly push the controller module in until it meets the midplane and is fully seated, and then close the cam handle to the locked position. Tighten the thumbscrew on the cam handle on the back of the controller module.
+
