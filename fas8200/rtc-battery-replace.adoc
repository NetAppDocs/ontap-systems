...
summary: "You replace the real-time clock battery in the controller module so that your services and applications that depend on accurate time synchronization continue to function."
---
