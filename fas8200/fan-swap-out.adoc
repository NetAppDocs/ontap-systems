...
summary: "Hot-swap a failed fan module in your FAS8200 system without interrupting service. Complete the replacement within two minutes to avoid overheating the controller."
---
= Hot-swap a fan module in a FAS8200 system
:icons: font
:imagesdir: ../media/

[.lead]
Hot-swap a failed fan module in your FAS8200 system without interrupting service. Complete the replacement within two minutes to avoid overheating the controller.
