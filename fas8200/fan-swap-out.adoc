...
summary: "Swap out a fan module in your FAS8200 system without interrupting service by following a specific sequence of steps; complete the replacement within two minutes to avoid overheating the controller."
---
= Hot-swap a fan in your FAS8200 system
:icons: font
:imagesdir: ../media/

[.lead]
Swap out a fan module in your FAS8200 system without interrupting service by following a specific sequence of steps; complete the replacement within two minutes to avoid overheating the controller.
...
. Pull the fan module straight out from the chassis. Support it with your free hand so it doesn't swing out of the chassis.
+
...
. Swing the cam handle up to its closed position until the cam handle release latch clicks into the locked position.
+
