...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png[Five]link:bootmedia-recovery-image-boot_asa_r2.html[Boot the recovery image]
[role="quick-margin-para"]
