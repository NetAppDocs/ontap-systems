...
summary: Get started with replacing the boot media in your ASA A70 and ASA A90 storage system by reviewing the replacement requirements, shutting down the controller, replacing the boot media, restoring the image on the boot media, and verifying the system functionality.
---
= Boot media replacement workflow for an ASA A70 or ASA A90 system using the automated boot recovery process
:icons: font
:imagesdir: ../media/
