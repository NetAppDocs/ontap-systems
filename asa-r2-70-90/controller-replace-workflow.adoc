...
.Before you begin
To replace the controller module, you must meet certain requirements. Review the link:controller-replace-requirements.html[Controller replacement requirements].
