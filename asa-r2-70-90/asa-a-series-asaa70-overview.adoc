---
permalink: asa-r2-70-90/specifications.html
sidebar: sidebar
keywords: ASA A70 specifications, ASA A70 specs, NetApp ASA A70, ASA A70 hardware
summary: Key specifications for the ASA A70 storage system
---
...
[.lead]
The following are select specifications for the ASA A70. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA A70 specifications. This page is reflective of a single high availability pair. 
