...
sidebar: sidebar
keywords: ASA A90 specifications, ASA A90 specs, NetApp ASA A90, ASA A90 hardware
summary: Key specifications for the ASA A90 storage system
---
...
[.lead]
The following are select specifications for the ASA A90. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA A90 specifications. This page is reflective of a single high availability pair. 
