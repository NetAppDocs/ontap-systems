...
[.lead]
Verify that the logical interfaces (LIFs) are reporting to their home port, perform a cluster health check, and then return the failed part to NetApp to complete the final step in the ASA A70 and ASA A90 controller replacement procedure.
