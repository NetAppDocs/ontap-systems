...
---
= Boot media replacement workflow - ASA r2 A70 and A90
:icons: font
:imagesdir: ../media/
...
.Before you begin
To replace the boot media, your must meet certain requirements. Review the link:bootmedia-replace-requirements.html[Boot media requirements].
