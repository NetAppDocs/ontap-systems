...
---
= Learn about maintaining your AFX 2K storage system
:icons: font
:imagesdir: ../media/
...
a| The NVRAM12-EX is the second NVRAM (Non-Volatile Random Access Memory) module for the AFX 2K controller. The NVRAM12-EX module lets the controller protect and save in-flight data if the system loses power. 
