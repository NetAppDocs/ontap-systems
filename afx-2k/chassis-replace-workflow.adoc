...
summary: Get started with replacing the chassis of your afx 2k storage system by reviewing the replacement requirements, shutting down the controller, replacing the chassis, and verifying system operations.
---
= Chassis replacement workflow - afx 2k
:icons: font
:imagesdir: ../media/

[.lead]
Get started with replacing the chassis of your afx 2k storage system by reviewing the replacement requirements, shutting down the controller, replacing the chassis, and verifying system operations. 
