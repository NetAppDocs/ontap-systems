...
---
= Replace the System Management module in your AFX 2K storage system
:icons: font
:imagesdir: ../media/
...
include::../_include/afx_2k_system_mgmt_replace.adoc[]

== Step 3: Reboot the controller module

include::../_include/afx_2k_system_mgmt_reboot.adoc[]
