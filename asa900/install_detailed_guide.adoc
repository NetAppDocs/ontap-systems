...
image:../media/oie_cable100_gbe_qsfp28.svg[100 Gb cable]
a|
image:../media/square_icon_4_red.png[Callout icon 4]
a|
...
|Step|Perform on each controller
a|
image:../media/square_icon_1_green.png[
a|
Cable cluster
...
100 GbE cable
a|
image:../media/square_icon_2_yellow.png[Callout icon 1]
a|
...
100 GbE cable
a|
image:../media/square_icon_2_yellow.png[width=30px]
a|
