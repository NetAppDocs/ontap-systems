...
|Step|Perform on each controller
a|
image:../media/oie_icon_round_1_mb.svg[Callout icon 1]
a|
...
Shelf ID LED
a|
image:../media/icon_round_04.svg[width=20]
a|
...
+
image:[Callout icon 1] drw_a900_power-on_IEOPS-941.svg[width=500px]
+
