...
summary: After installing the new boot media device in your  ASA A900 system, you can start the automated boot media recovery process to restore the configuration from the partner node. 
---
= Restore the boot image on your ASA A900 system using the automated boot recovery process
:icons: font
:imagesdir: ../media/
