...
---
= Install your AFF A150 system using detailed step-by-step instructions
:icons: font
:imagesdir: ../media/

[.lead]
Install your AFF A150 storage system using these detailed step-by-step instructions, from preparing the site to bringing up the ONTAP cluster.
...
You install your system in a four-post rack or NetApp system cabinet, as applicable.
...
a|
image::../media/icon_square_2_orange.png[Callout number 2]
a|
Controllers to host data network switches
a|
image::../media/icon_square_3_purple.png[Callout number 3]
a|
...
Use the Cat 6 RJ45 cable to cable the e0c through e0f ports to your host network, as shown in the following illustration.
+
...
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[Select an ONTAP icon]
 ...
 .. Open File Explorer.
.. Select *Network* in the left pane, right-click, and select *refresh*.
