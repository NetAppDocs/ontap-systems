...
---
= Key specifications for an AFF A150 system
:icons: font
:imagesdir: ../media/

[.lead]
Review select specifications for the AFF A150 storage system, which reflect a single high-availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A150 specifications. 
...
* Depth: 19.0” (24.1” with cable management bracket)
* Operating Temp/Altitude/Humidity: 5°C to 45°C (41°F to 113°F) at up to 3048m (10000 ft) elevation;8% to 90% relative humidity, noncondensing
...
* Acoustic Noise: Declared sound power (LwAd): 6.9; Sound pressure (LpAm) (bystander positions): 51.0 dB
