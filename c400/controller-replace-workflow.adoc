...
summary: Replace the controller in your AFF C400 storage system by shutting down the impaired controller, removing and replacing the controller, restoring the system configuration, and returning control of storage resources to the replacement controller.
---
= Controller replacement workflow - AFF C400
:icons: font
:imagesdir: ../media/

[.lead]
Replace the controller in your AFF C400 storage system by shutting down the impaired controller, removing and replacing the controller, restoring the system configuration, and returning control of storage resources to the replacement controller. 
