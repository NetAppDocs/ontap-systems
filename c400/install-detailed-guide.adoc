...
---
= Install and set up an AFF C400 system using detailed step-by-step instructions
:icons: font
:imagesdir: ../media/

[.lead]
Install and set up your AFF C400 storage system using the detailed guide, which provides step-by-step instructions from racking and cabling to initial system bring-up.
