...
---
= Install an AFF C400 system using detailed instructions
:icons: font
:imagesdir: ../media/

[.lead]
Install and set up your AFF C400 storage system using step-by-step instructions from racking and cabling to initial system bring-up.
