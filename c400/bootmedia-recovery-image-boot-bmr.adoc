...
summary: After installing the new boot media device in your AFF C400 system, you can start the automated boot media recovery process to restore the configuration from the partner node.
---
= Restore the boot image on your AFF C400 storage system using the automated boot recovery process
:icons: font
:imagesdir: ../media/
