...
[.lead]
The following are select specifications for the ASA A400 storage system in a single high availability pair. Visit NetApp Hardware Universe (HWU) for the complete specifications for this storage system.
