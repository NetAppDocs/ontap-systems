...
summary: Key specifications for the ASA A400 storage system
---
...
[.lead]
The following are select specifications for the ASA A400. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA A400 specifications. This page is reflective of a single high availability pair. 
