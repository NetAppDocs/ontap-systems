...
summary: Shut down the controller in your ASA A400 storage system to prevent data loss and maintain system stability during the manual boot media recovery process.
---
...
[.lead]
Shut down the controller in your ASA A400 storage system to prevent data loss and maintain system stability during the manual boot media recovery process.
