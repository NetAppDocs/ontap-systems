...
summary: Get started with replacing the boot media in your ASA A400 storage system by reviewing the replacement requirements, shutting down the controller, replacing the boot media, restoring the image on the boot media, and verifying the system functionality.
---
= Boot media replacement workflow for an ASA A400 system using the automated boot recovery process
:icons: font
:imagesdir: ../media/
