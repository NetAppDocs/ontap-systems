...
[.lead]
The following are a selection of key specifications for an ASA A800 system in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA A800 specifications.
