...
---
= Choose how to install your ASA A800 storage system
:icons: font
:imagesdir: ../media/

[.lead]
Choose your preferred format for installing your ASA A800 storage system: detailed step-by-step instructions, quick graphic guide, or video instructions.

* link:../asa800/install-quick-guide.html[Quick steps]
+
A printable PDF of step-by-step instructions with live links to additional content.

* link:../asa800/install-videos.html[Video steps]
+
Video step-by-step instructions.

* link:../asa800/install-detailed-guide.html[Detailed steps]
+
