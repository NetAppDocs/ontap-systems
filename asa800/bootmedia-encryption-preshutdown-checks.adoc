...
---
= Check encryption support on your boot media in your ASA A800 system
:icons: font
:imagesdir: ../media/

[.lead]
To ensure data security on your ASA A800 storage system, you need to verify the encryption key support and status on your boot media. Check if your ONTAP version supports NetApp Volume Encryption (NVE), and before you shut down the controller check if the key manager is active. 
