...
---
= Restore encryption on the boot media in your ASA A800 system after the manual boot recovery process
:icons: font
:imagesdir: ../media/

[.lead]
Restore encryption on the replacement boot media in your ASA A800 system to ensure continued data protection. The replacement process involves verifying key availability, reapplying encryption settings, and confirming secure access to your data.
