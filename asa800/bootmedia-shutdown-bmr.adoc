...
summary: Shut down the impaired controller in your ASA A800 storage system to prevent data loss and ensure system stability when replacing the boot media.
---
