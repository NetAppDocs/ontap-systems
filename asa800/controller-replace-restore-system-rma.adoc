...
summary: "To restore your system to full operation, you must restore the NetApp Storage Encryption configuration as needed, install licenses for the new controller, and return the failed part to NetApp."
---
= Complete the controller replacement for your ASA A800 system
:icons: font
:imagesdir: ../media/
