...
summary: "This page gives detailed step-by-step instructions for installing your FAS2700 system."
---
= Install your FAS2700 system using detailed instructions
:icons: font
:imagesdir: ../media/

[.lead]
Follow detailed, step-by-step instructions for installing your FAS2700 system, from preparing for installation through initial configuration.
...
a|
image:../media/icon_square_2_orange.png[Step 2]
a|
...
image:../media/drw_c190_u_mgmt_cabling.png[Management port cabling]
a|
 ...
 ** e0a to e0a
 ** e0b to e0b
image:../media/drw_c190_e_tnsc_clust_cbling.png[Cluster interconnections between the ports on the back of the controllers]
a|
image:../media/icon_square_2_orange.png[Step 2]
a|
...
a|
image:../media/icon_square_3_tourquoise.png[Step 3]
a|
...
+
drw_autodiscovery_controler_select_ieops-1849.svg[Select an ONTAP icon]
