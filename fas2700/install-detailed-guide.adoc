...
If you have more than one drive shelf stack, see the https://docs.netapp.com/us-en/ontap/sas3/index.html[Installing and cabling^] for your drive shelf type.
