...
---
= Hot-swap a power supply unit in your FAS500f system
:icons: font
:imagesdir: ../media/
...
. Rotate the cam handle to pull the power supply out of the controller module while pressing the locking tab.
+
[CAUTION]
====
...
+
The power supplies engage with the internal connector and lock in place only one way.
+
