...
[.lead]
The following are select specifications for the FAS500f. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of FAS500f specifications. This page is reflective of a single high availability pair. 
