...
---
= Replace the NVMEM battery in your FAS500f system
:icons: font
:imagesdir: ../media/
...
After you replace the component in the controller module, you must reinstall the controller module into the chassis, and then boot it.
