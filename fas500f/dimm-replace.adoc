...
---
= Replace a DIMM in your FAS500f system to fix memory errors
:icons: font
:imagesdir: ../media/

[.lead]
You must replace a DIMM in the controller when your storage system encounters errors such as excessive CECC (Correctable Error Correction Codes) errors based on Health Monitor alerts, or uncorrectable ECC errors. These errors are typically caused by a single DIMM failure that prevents the storage system from booting ONTAP.
