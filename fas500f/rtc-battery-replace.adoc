...
---
= Replace the real-time clock battery in your FAS500f system
:icons: font
:imagesdir: ../media/
...
* All other components in the system must be functioning properly. If they are not, contact technical support.
...
+
image::../media/drw_a250_remove_rtc_batt.png[How to remove the RTC battery]
+
|===
a|
image:../media/icon_round_1.png[Callout number 1]|
...
+
image::../media/drw_a250_install_rtc_batt.png[Installing the RTC battery]
+
|===
a|
image:../media/icon_round_1.png[Callout number 1]|
Slide the battery under the tab of the battery housing with positive polarity face up.
a|
image:../media/icon_round_2.png[Callout number 2]
a|
...
. Insert the controller module into the chassis:
 .. Verify the latching mechanism arms are locked in the fully extended position.
