...
---
= Install a FAS500f system using detailed step-by-step instructions
:icons: font
:imagesdir: ../media/
...
a|
Cable the cluster interconnect ports to each other with the 25 GbE cluster interconnect cable
...
a|
Cable controller A to the shelf:    image:../media/drw_affa250_1shelf_cabling_a.png[Controller A cabling]
a|
image:../media/icon_square_2_yellow.png[Callout number 2]
a|
Cable controller B to the shelf:    image:../media/drw_affa250_1shelf_cabling_b.png[Controller B cabling]
