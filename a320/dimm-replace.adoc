...
summary: Replace a DIMM in your AFF A320 controller module when the system registers an increasing number of correctable error correction codes or uncorrectable ECC errors. Failure to replace a faulty DIMM can cause a system panic.
---
= Replace a DIMM in your AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace a DIMM in your AFF A320 system when the storage system encounters excessive correctable ECC errors or an uncorrectable ECC error, which is typically caused by a single DIMM failure.
...
Air duct
a|
image:../media/icon_round_2.png[Callout number 2] a|
