...
[.lead]
Replace an NVDIMM in your AFF A320 system when the system registers excessive correctable ECC errors or an uncorrectable ECC error, which is typically caused by a single NVDIMM failure.
