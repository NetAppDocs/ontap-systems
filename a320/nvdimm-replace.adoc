...
summary: Replace the NVDIMM in your AFF A320 controller module when the system registers that the flash lifetime is almost at an end or that the identified NVDIMM is not healthy. Failure to replace a faulty NVDIMM can cause a system panic.
---
= Replace an NVDIMM in your AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace an NVDIMM in your AFF A320 system when the system registers that the flash lifetime is almost at an end or that the identified NVDIMM is not healthy. Failure to replace a faulty NVDIMM can cause a system panic.
...
+
image::../media/drw_a320_controller_remove_animated_gif.png[Remove the controller]
+
