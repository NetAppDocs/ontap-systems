...
---
= Replace the chassis in your AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the chassis in your AFF A320 system by moving the fans, hard drives, and controller modules from the impaired chassis to the replacement chassis.
