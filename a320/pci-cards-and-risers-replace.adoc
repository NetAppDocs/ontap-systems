...
---
= Replace a PCIe card in your AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace a PCIe card in your AFF A320 system by disconnecting cables and SFP/QSFP modules, removing the riser, replacing the card, and recabling.
...
image::../media/drw_a320_pci_card_replace_animated_gif.png[Replace a PCI card]
...
+
image::../media/drw_a320_controller_install_animated_gif.png[Install the controller]
+
