...
summary: Replace the real-time clock battery in your AFF A320 controller module to ensure that services and applications that depend on accurate time synchronization continue to function.
---
= Replace the real-time clock battery in your AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the real-time clock (RTC) battery in your AFF A320 system to ensure that services and applications that depend on accurate time synchronization continue to function.
...
+
image::../media/drw_a320_controller_cable_unplug_animated_gif.png[Remove the cable management device]
+
