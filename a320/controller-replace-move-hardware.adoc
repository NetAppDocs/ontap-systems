...
summary: "Replace the controller in your AFF A320 system by removing the impaired controller, moving FRU components to the replacement module, installing it in the chassis, and booting to Maintenance mode."
---
= Replace the controller in an AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the controller in your AFF A320 system by removing the impaired controller, moving FRU components to the replacement module, installing it in the chassis, and booting to Maintenance mode.
...
image::../media/drw_a320_nvbat_move_animated_gif.png[Move the NV battery]
...
image::../media/drw_a320_boot_media_move_animated_gif.png[Move the boot media]
...
image::../media/drw_a320_dimm_move_animated_gif.png[Move a DIMM animation]

. Locate the DIMMs on your controller module.
+
image::../media/drw_a320_dimm_map.png[DIMM map]
+
|===
a|
...
image::../media/drw_a320_pci_riser_move_animated_gif.png[Move the PCI riser]
...
image::../media/drw_a320_controller_install_animated_gif.png[Installing the controller]
