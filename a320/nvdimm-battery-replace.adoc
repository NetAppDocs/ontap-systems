...
---
= Replace the NVDIMM battery in your AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the NVDIMM battery in your AFF A320 system by removing the controller module, replacing the battery, and reinstalling the controller module.
...
image::../media/drw_a320_nvbat_move_animated_gif.png[Replace the NV Battery]
