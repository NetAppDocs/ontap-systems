...
---
= Install your AFF A320 storage system using detailed steps
:icons: font
:imagesdir: ../media/

[.lead]
Install your AFF A320 storage system using detailed step-by-step instructions, from racking and cabling to initial system bring-up.
...
a|
image:../media/oie_cable_etherned_mpo.png[Ethernet cable - MPO]
a|
...
+
image::../media/drw_a320_weight_label.png[System lift weight caution]  

. Attach cable management devices (as shown).
+
image::../media/drw_a320_cable_management_arms.png[Remove or install the cable management arms]
...
+
image::../media/drw_a320_tnsc_network_cabling_composite_animated_gif.png[Two-node switchless cluster cabling composite]
+
...
a|
image:../media/icon_square_1_green.png[Step 1]
a|
Cable the cluster/HA ports to each other with the 100 GbE (QSFP28) cable:

** e0a to e0a
** e0d to e0d
image:../media/drw_a320_tnsc_cluster_ha_connection_step1a.png[Two-node switchless cluster connect the cluster-HA connections]

a|
image:../media/icon_square_2_yellow.png[Step 2]
a|
...
** e0g and e0h
image:../media/drw_a320_onboard_data_connection_step2.png[Connect onboard data network connections]
...
image::../media/drw_a320_nic_connections_step3.png[Two-node switchless cluster connect the NICs]
a|
image:../media/icon_square_4_red.png[Step 4]
a|
Cable the e0M ports to the management network switches with the RJ45 cables.

image:../media/drw_a320_management_port_connection_step4.png[Connect the Management port]
a|
...
. You can used the illustration or the step-by step instructions to complete the cabling between the controllers and to the switches:
+
image::../media/drw_a320_switched_network_cabling_composite_animated_GIF.png[Switched cluster cabling composite]
+
...
image:../media/drw_a320_switched_cluster_ha_connection_step1b.png[Switched cluster cluster-HA connections]
 ...
 ** e0g and e0h
image:../media/drw_a320_onboard_data_connection_step2.png[Switched cluster onboard network connections]
...
image:../media/drw_a320_management_port_connection_step4.png[Switched cluster managment network connections]
a|
image:../media/oie_legend_icon_attn_symbol.png[Attention symbol]
a|
DO NOT plug in the power cords at this point.
...
+
image::../media/drw_a320_single_shelf_connections_animated_gif.png[Single drive shelf cabling composite]
+
...
a|
Cable controller A to the shelf    image:../media/drw_a320_storage_cabling_controller_a_single_shelf.png[Cable controller A to the shelf]
a|
image:../media/icon_square_2_yellow.png[Callout number 2]
a|
Cable controller B to the shelf:    image:../media/drw_a320_storage_cabling_controller_b_single_shelf.png[Connect controller B to a single shelf]
|===
...
+
image::../media/drw_a320_2_shevles_cabling_animated_gif.png[Cable two shelves animation]
+
...
image:../media/icon_square_1_blue.png[Callout number 1]
a|
Cable controller A to the shelves:    image:../media/drw_a320_2_shelves_cabling_controller_a.png[Cable two shelves to Controller A]
a|
image:../media/icon_square_2_yellow.png[Callout number 2]
a|
Cable controller B to the shelves:    image:../media/drw_a320_2_shelves_cabling_controller_b.png[Cable teo shelces to Controller b]
|===
...
+
image::../media/drw_a320_laptop_to_switch_and_controller.png[Cable laptop to the management subnet switch]
