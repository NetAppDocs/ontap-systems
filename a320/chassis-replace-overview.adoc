...
---
= Review the requirements for replacing a chassis in an AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Before replacing the chassis in your AFF A320 system, review the requirements for a successful replacement. The procedure moves all fans and controller modules from the impaired chassis to the replacement chassis and is disruptive.
