...
= Recable the system and reassign disks in your AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Complete the controller replacement for your AFF A320 system by recabling the storage and confirming disk reassignment.
