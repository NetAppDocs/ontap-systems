...
summary: Replace a power supply in your AFF A320 system by disconnecting the target PSU from the power source, unplugging the power cable, removing the old PSU, installing the replacement PSU, and then reconnecting the replacement PSU to the power source.
---
= Hot-swap a power supply in your AFF A320 system
:icons: font
:imagesdir: ../media/

[.lead]
Hot-swap a power supply in your AFF A320 system by disconnecting, removing, and replacing the failed unit, then reconnecting it to restore power.
...
image::../media/drw_a320_psu_replace_animated_gif.png[Replace a PSU]
