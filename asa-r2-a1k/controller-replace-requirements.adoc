...
---
= Review requirements before replacing the controller in your ASA A1K system
:icons: font
:imagesdir: ../media/
...
After you’ve reviewed the requirements to replace your ASA A1K controller, you need to link:controller-replace-shutdown-nomcc.html[shut down the controllers].