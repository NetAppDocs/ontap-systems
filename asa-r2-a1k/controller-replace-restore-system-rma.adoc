...
summary: To complete the controller replacement for your ASA A1K system, first restore the NetApp Storage Encryption configuration if necessary. Next, confirm that the logical interfaces are reporting to their home ports and perform a cluster health check. Finally, return the failed part to NetApp.
---
= Complete the controller replacement for your ASA A1K system
:icons: font
:imagesdir: ../media/
