---
permalink: a5x/index.html
sidebar: sidebar
keywords: aff a5x maintenance, maintenance, repairing a5x, replace a5x components
summary: Maintain the AFF A5X hardware
---
= Maintain AFF A5X hardware
:icons: font
:imagesdir: ../media/
