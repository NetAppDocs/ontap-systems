---
permalink: a30-60/io-module-hotswap.html
sidebar: sidebar
keywords: aff c30, aff c60, hotswap a cluster ha card
summary: The cluster and HA I/O module supports interconnects for clustering and high-availability. You can hot-swap the module in your AFF C30 or AFF C60 storage system when the module fails.
---
...
[.lead]
The cluster and HA I/O module supports interconnects for clustering and high-availability. You can hot-swap the module in your AFF C30 or AFF C60 storage system when the module fails.
