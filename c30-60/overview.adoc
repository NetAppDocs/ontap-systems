...
[.lead]
These are select specifications for the AFF C30 and AFF C60 storage systems in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] for the complete specifications for these storage systems.
