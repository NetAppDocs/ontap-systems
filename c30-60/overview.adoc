...
summary: Key specifications for the C30-60 platform group
---
= Key specifications for C30-60 platform group
:icons: font
:imagesdir: ../media/

[.lead]
The following are select specifications for the C30-60 platform group. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of specifications. This page is reflective of a single high availability pair.

== AFF C60

=== Key specifications for AFF C60

Platform Configuration: AFF C60 Single Chassis HA Pair
...
| HA Pair |  | 7.4 PB / 6.5 PiB | 128.0000
|===
