...
summary: Shut down the impaired controller in your AFF C30 or AFF C60 storage system to prevent data loss and maintain system stability during the automated boot media recovery process.
---
