...
summary: Add an I/O module to your AFF C30 or AFF C60 system to enhance network connectivity and expand your system’s ability to handle data traffic.
---
...
[.lead]
Add an I/O module to your AFF C30 or AFF C60 system to enhance network connectivity and expand your system’s ability to handle data traffic.
