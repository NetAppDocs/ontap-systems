...
---
= Key specifications for an AFF C30 system
:icons: font
:imagesdir: ../media/

[.lead]
These are select specifications for the AFF C30 storage system in a single high availability pair. Visit NetApp Hardware Universe (HWU) for the complete specifications for this storage system.
