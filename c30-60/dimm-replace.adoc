...
* All other components in the storage system must be working correctly. If they are not, contact https://mysupport.netapp.com/site/global/dashboard[NetApp Support] before continuing.
...
To replace a DIMM, locate the faulty DIMM inside the controller.
