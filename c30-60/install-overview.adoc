...
[.lead]
To install and set up your AFF C30 or AFF C60 storage system, you must review the installation requirements and considerations, prepare your site, install and cable the hardware components, power on the storage system, and set up the ONTAP cluster.
