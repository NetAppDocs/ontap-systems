...
---
= AFF C30 and AFF C60 installation and configuration workflow
:icons: font
:imagesdir: ../media/
...
Your storage system must meet the installation requirements before you install it.
...
[role="quick-margin-para"]
To prepare for installation, get the site ready, check environmental and electrical requirements, and confirm there’s enough rack space. Then, unpack the equipment, compare contents to the packing slip, and register the hardware to access support benefits.
