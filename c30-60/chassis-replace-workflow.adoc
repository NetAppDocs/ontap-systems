...
---
= AFF C30 and AFF C60 chassis replacement workflow
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Replacing the chassis includes moving the drives, any drive blanks, controllers (with the power supplies), and the bezel from the impaired chassis to the new chassis. It also includes swapping out the impaired chassis with a new chassis of the same model.
