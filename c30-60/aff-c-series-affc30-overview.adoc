...
sidebar: sidebar
keywords: AFF C30 specifications, AFF C30 specs, NetApp AFF C30, AFF C30 hardware
summary: Key specifications for the AFF C30 storage system
---
...
[.lead]
The following are select specifications for the AFF C30. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF C30 specifications. This page is reflective of a single high availability pair. 
