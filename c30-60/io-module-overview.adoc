...
You can replace a failed I/O module in your storage system with the same type of I/O module or with a different type. You can hot-swap a cluster and HA I/O module when your storage system meets specific requirements. You can also add an I/O module to a storage system with available slots.
...
+
Hot-swapping certain I/O modules for an equivalent module can restore the storage system to its optimal operating state. Hot-swapping is done without having to perform a manual takeover.
+
