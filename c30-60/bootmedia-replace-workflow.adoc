...
---
= Boot media replacement workflow for an AFF C30 or AFF C60 system using the manual boot recovery process
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Remove the failed boot media from the controller and install the replacement boot media, and then transfer an ONTAP image using a USB flash drive.
