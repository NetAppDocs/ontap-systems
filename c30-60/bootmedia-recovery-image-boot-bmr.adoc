...
summary: After installing the new boot media device in your AFF C30 and AFF C80 storage system, you can start the automated boot media recovery process to restore the configuration from the partner node.  
---
