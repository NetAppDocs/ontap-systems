...
summary: Replace a fan module in your AFF C30 or AFF C60 storage system when a fan fails or is not operating efficiently, as this can affect system cooling and overall performance. The replacement process involves shutting down the controller, removing the controller, replacing the fan, reinstalling the controller, and returning the failed part to NetApp.
---
= Replace a fan module in your AFF C30 or AFF C60 storage system
:icons: font
:imagesdir: ../media/
