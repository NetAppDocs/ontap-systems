...
--
Ethernet host cabling is based on the I/O modules installed in the controllers.
...
.FC host cabling
--
FC host cabling is based on the I/O modules installed in the controllers.
