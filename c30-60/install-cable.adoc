...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_2card_cabling_ieops-2011.svg[a30 and a60 switchless cluster cabling diagram using two 100gbe io modules]
...
image::../media/oie_cable100_gbe_qsfp28.png[Cluster HA 100 GbE cable]
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_1card_cabling_ieops-1925.svg[a30 and a60 switchless cluster cabling diagram using one 100gbe io module]
...
+
image::../media/drw_isi_a30-50_switched_2p_100gbe_2card_cabling_ieops-2013.svg[a30 and a60 switched cluster cabling diagram using two 100gbe io modules]
