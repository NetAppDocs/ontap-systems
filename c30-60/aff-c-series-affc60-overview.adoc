---
permalink: c30-60/specifications.html
sidebar: sidebar
keywords: AFF C60 specifications, AFF C60 specs, NetApp AFF C60, AFF C60 hardware
summary: Key specifications for the AFF C60 storage system
---
...
[.lead]
The following are select specifications for the AFF C60. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF C60 specifications. This page is reflective of a single high availability pair. 
