...
---
= Install the cabinet interconnect kit for ONTAP hardware system cabinets
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_sys_cab_remove_brimstone_back_banel.png[How to unplug the power to the illuminated bezel]
+
|===
a|
...
+
image::../media/drw_sys_cab_front_door_daiginjo.png[How to remove the front door]
+
|===
a|
image:../media/icon_round_1.png[Callout number 1]
...
image:../media/drw_syscab_interconnect_bracket_side_panels_on.gif[How to install the interconnect brackets with system cabinet side panels on]
...
image:../media/drw_syscab_interconnect_bracket_side_panels_off.gif[How to install the interconnect brackets with the system cabinet side panels off]
