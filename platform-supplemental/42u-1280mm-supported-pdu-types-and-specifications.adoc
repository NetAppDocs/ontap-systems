...
summary: The system cabinet supports different Power Distribution Unit types. The PDUs are compliant with NEMA or IEC.
---
= Supported PDU types and specifications for an ONTAP hardware system cabinet
:icons: font
:imagesdir: ../media/
