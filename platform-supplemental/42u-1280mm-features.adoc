...
---
= ONTAP hardware system cabinet features
:icons: font
:imagesdir: ../media/

[.lead]
The ONTAP hardware system cabinet consists of side panels, front and rear doors, an optional bolt-down kit, an optional interconnect kit, PDUs for your equipment, and an integrated cable management system.
