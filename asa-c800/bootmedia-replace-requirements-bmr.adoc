...
summary: Before replacing the boot media in your ASA C800, ensure you meet the necessary requirements for a successful replacement. This includes verifying that you have the correct replacement boot media, confirming that the e0S or e0M wrench port on the impaired controller is not faulty, and determining whether Onboard Key Manager or External Key Manager is enabled.
---
= Review requirements for automated boot media recovery in your ASA C800 system
:icons: font
:imagesdir: ../media/
