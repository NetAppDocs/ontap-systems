...
summary: 'Choose the install method that best fits your needs for setting up an ASA C800 system, using quick graphic instructions, video walkthroughs, or detailed step-by-step guidance.'
---
= Choose how to install an ASA C800 storage system
:icons: font
:imagesdir: ../media/
