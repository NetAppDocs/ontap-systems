...
---
= Replace or add a PCIe card in an ASA C800 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace or add a PCIe card in your ASA C800 system when the card fails, requires an upgrade to support higher performance, or additional features. The replacement process involves shutting down the controller, replacing the failed PCIe card, rebooting the controller, and returning the failed part to NetApp.
