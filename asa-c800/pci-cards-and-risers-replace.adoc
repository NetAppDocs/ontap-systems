...
[.lead]
Replace a PCIe card in your ASA C800 system when it fails, or add or upgrade a card to support higher performance or additional features. The replacement process involves shutting down the controller, replacing the failed PCIe card, rebooting the controller, and returning the failed part to NetApp.
