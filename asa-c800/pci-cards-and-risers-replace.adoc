...
---
= Replace a PCIe card in your ASA C800 system
:icons: font
:imagesdir: ../media/

[.lead]

Replace or add an I/O module in your ASA C800 system when the module fails,  requires an upgrade to support higher performance, or additional features. The replacement process involves shutting down the controller, replacing the failed I/O module, rebooting the controller, and returning the failed part to NetApp.
