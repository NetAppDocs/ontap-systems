...
summary: To restore your ASA C800 system to full operation, restore the NetApp Storage Encryption configuration if necessary, install licenses for the new controller, and return the failed part to NetApp.
---
= Complete the controller replacement for your ASA C800 system
:icons: font
:imagesdir: ../media/
