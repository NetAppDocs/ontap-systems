...
summary: Follow detailed, step-by-step instructions to prepare for installation, install the hardware, cable the system, and complete initial configuration of an ASA C800 system.
---
= Install and set up an ASA C800 system using detailed step-by-step instructions
:icons: font
:imagesdir: ../media/

[.lead]
Follow detailed, step-by-step instructions to prepare for installation, install the hardware, cable the system, and complete initial configuration of an ASA C800 system.
...
a|
image:../media/oie_cable100_gbe_qsfp28.png[10 GbE QSFP28 connector]
a|
* Data
a|
25 GbE cable
...
a|
image:../media/oie_cable100_gbe_qsfp28.png[25 GbE QSFP28 connector]
a|
* Data
a|
...
a|
Connecting the PSUs to power source
|===
...
a|
image:../media/icon_square_1_dark_purple.png[Callout number 1]
a|
