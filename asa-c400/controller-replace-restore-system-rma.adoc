...
summary: To restore your ASA C400 system to full operation, restore the NetApp Storage Encryption configuration if necessary, install licenses for the new controller, and return the failed part to NetApp.
---
