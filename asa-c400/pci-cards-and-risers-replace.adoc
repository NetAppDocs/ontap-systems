...
---
= Replace a PCIe or mezzanine card in an ASA C400 system
:icons: font
:imagesdir: ../media/

[.lead]
Remove and swap out a failed PCIe or mezzanine card in the controller module of an ASA C400 system.
