---
permalink: asa-c400/specifications.html
sidebar: sidebar
keywords: ASA C400 specifications, ASA C400 specs, NetApp ASA C400, ASA C400 hardware
summary: Key specifications for the ASA C400 storage system
---
...
[.lead]
The following are select specifications for the ASA C400. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA C400 specifications. This page is reflective of a single high availability pair. 
