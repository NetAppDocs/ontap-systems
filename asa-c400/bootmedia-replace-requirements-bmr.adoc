...
summary: Before replacing the boot media in your ASA C400 system, ensure you meet the necessary requirements for a successful replacement.
---
= Requirement to replace the boot media - ASA C400
:icons: font
:imagesdir: ../media/
