...
[.lead]
The following are a selection of key specifications for an ASA A90 system in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA A90 specifications.
