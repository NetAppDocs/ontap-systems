---
permalink: fas-r2-70-90/maintain-overview.html
sidebar: sidebar
keywords: fas70 fas90 maintenance, maintenance, repairing fas70 fas90
summary: Maintain the FAS70, FAS90 hardware
---
...
The procedures in this section assume that the FAS70 and FAS90 systems have already been deployed as a storage node in the ONTAP environment.

== System components
For the FAS70 and FAS90 storage systems, you can perform maintenance procedures on the following components.
