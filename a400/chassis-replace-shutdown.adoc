...
---
= Shut down your AFF A400 controllers to replace the chassis
:icons: font
:imagesdir: ../media/

[.lead]
Shut down the controllers in your AFF A400 storage system to prevent data loss and ensure system stability when replacing the chassis.
