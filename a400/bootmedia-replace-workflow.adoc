...
---
= Boot media replacement workflow for an AFF A400 system using the manual boot recovery process
:icons: font
:imagesdir: ../media/

[.lead]
Get started with replacing the boot media in your AFF A400 system using the manual boot recovery process. You must download the appropriate ONTAP recovery image from the NetApp Support Site and copy it to a USB drive to perform the recovery and restore the system to operational status.
