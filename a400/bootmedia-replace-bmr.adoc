...
summary: The boot media in your AFF A400 system stores essential firmware and configuration data. The replacement process involves removing the controller module, removing the impaired boot media, installing the replacement boot media in the controller module, and then reinstalling the controller module.
---
= Replace the boot media in your AFF A400 system using the automated boot recovery process
:icons: font
:imagesdir: ../media/
