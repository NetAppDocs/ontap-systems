...
summary: Key specifications for the AFF A400 storage system
---
...
[.lead]
The following are select specifications for the AFF A400. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A400 specifications. This page is reflective of a single high availability pair. 
