...
---
= Key specifications for an AFF A400 system
:icons: font
:imagesdir: ../media/

[.lead]
Review select specifications for the AFF A400. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A400 specifications. This page reflects a single high-availability pair.
