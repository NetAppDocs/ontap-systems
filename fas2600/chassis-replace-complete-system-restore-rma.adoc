...
summary: "Complete the chassis replacement for your FAS2600 system by verifying the HA state of the chassis and returning the failed component to NetApp."
---
= Complete the chassis replacement for your FAS2600 system
:icons: font
:imagesdir: ../media/

[.lead]
Complete the chassis replacement for your FAS2600 system by verifying the HA state of the chassis and returning the failed part to NetApp, as described in the RMA instructions shipped with the kit.
