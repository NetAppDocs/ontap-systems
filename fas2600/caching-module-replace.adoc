...
summary: "Replace the caching module in your FAS2600 system when your system registers a single AutoSupport message that the module has gone offline. Failure to do so results in performance degradation."
---
= Replace the caching module in your FAS2600 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the caching module in your FAS2600 system when your system registers a single AutoSupport (ASUP) message that the module has gone offline. Failure to do so results in performance degradation.

* You must replace the failed component with a replacement FRU component you received from your provider.

link:https://youtu.be/LaMzvnAwM_I[AFF FAS2600 caching module replacement video^]
...
The caching module is referred to as the M.2 PCIe card on the controller label. Locate the slot inside the controller and follow this sequence of steps.
...
+
image::../media/drw_2600_fcache_repl_animated_gif.png[Removing a caching module]
