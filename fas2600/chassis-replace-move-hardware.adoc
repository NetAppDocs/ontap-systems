...
summary: "Move the power supplies, hard drives, and controller modules from the impaired chassis to the replacement chassis in your FAS2600 system, and then swap the old chassis in the equipment rack or system cabinet for the new one of the same model."
---
= Replace the chassis in your FAS2600 system
:icons: font
:imagesdir: ../media/

[.lead]
Move the power supplies, hard drives, and controller modules from the impaired chassis to the replacement chassis in your FAS2600 system, and then swap the old chassis in the equipment rack or system cabinet for the new one of the same model.
...
For HA pairs with two controller modules in the same chassis, install order matters because each controller reboots as soon as it's fully seated in the chassis.
