...
summary: "Replace the controller in your FAS2600 system by removing the impaired controller, moving FRU components to the replacement controller module, installing it in the chassis, and booting the system to Maintenance mode."
---
= Replace the controller in your FAS2600 system
:icons: font
:imagesdir: ../media/
