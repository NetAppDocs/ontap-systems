...
summary: "Boot the ONTAP recovery image from the USB drive on a FAS2600 system to restore the boot media. The FAS2600 system supports only manual boot media recovery procedures. Automated boot media recovery is not supported."
---
= Boot the recovery image on your FAS2600 system
:icons: font
:imagesdir: ../media/

[.lead]
Boot the ONTAP recovery image from the USB drive on a FAS2600 system to restore the boot media. This procedure includes booting from the USB flash drive, restoring the file system, verifying environmental variables, and returning the controller to normal operation after boot media replacement.
