...
summary: "Replace the NVMEM battery in your FAS2600 system by removing the controller module, replacing the battery, and reinstalling the controller module."
---
= Replace the NVMEM battery in your FAS2600 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the NVMEM battery in your FAS2600 system by removing the controller module, opening it, replacing the battery, and closing and reinstalling the controller module.

If any other components in the system aren't functioning properly, contact technical support.

link:https://youtu.be/dgEMcYxya5M[AFF FAS2600 NVMEM battery replacement video^]
