...
summary: "Recable the storage, confirm disk reassignment, and complete the remaining tasks to give back the controller and restore your FAS2600 system to full operation."
---
= Give back the controller in your FAS2600 system to resume normal operations
:icons: font
:imagesdir: ../media/

[.lead]
Recable the storage, confirm disk reassignment, and complete the remaining tasks to give back the controller and restore your FAS2600 system to full operation.
