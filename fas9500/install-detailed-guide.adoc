...
sidebar: sidebar
keywords: FAS9500
summary: 'This page gives detailed step-by-step instructions for installing your FAS9500 system.'
---
= Install a FAS9500 storage system using detailed instructions
:icons: font
:imagesdir: ../media/

[.lead]
This page gives detailed step-by-step instructions for installing your FAS9500 system. Use these instructions if you want more detailed installation instructions.
...
X66033A (112-00438), 3m
a|
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[Mini SAS connector]
a|
Storage
a|
...
image::../media/drw_9500_tnsc_network_cabling.svg[TNSC network cabling diagram]
+
...
PSU1 and PSU3 provide power to all side A components, while PSU2 and PSU4 provide power to all side B components.
...
image::../media/drw_9500_switched_network_cabling.svg[Switched cluster network cabling]
...
* Be sure to check the illustration arrow for the proper cable connector pull-tab orientation. The cable pull-tab for the storage modules is up, while the pull tabs on the shelves are down.
...
.Steps
. Use the following animation or drawings to cable your controllers to three (one stack of one drive shelf and one stack of two drive shelves) DS224C drive shelves.

+
video::c958aae6-9d08-4d3d-a213-ae7c017040cd[panopto, title="Animation Cable your drive shelves"]
+

image::../media/drw_9500_sas_shelf_cabling.svg[SAS shelf cabling]
+
...
|Step|Perform on each controller
a|
image::../media/icon_square_1_blue.png[Callout icon 1]
a|
Connect drive shelf stack one to the controllers, using the graphic for reference.

*Mini-SAS cable*

image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[Mini-SAS HD cable]
...
image::../media/drw_power-on_set_shelf_ID_set.svg[Power on and set shelf ID]
+
...
image::../media/drw_a900_power-on_IEOPS-941.svg[Power on system]
+
...
image::../media/dwr_laptop_to_switch_only.svg[Laptop to switch cabling]
...
+
image::../media/drw_9500_cable_console_switch_controller.svg[Console to switch connection]
...
image::../media/drw_9500_power-on.svg[Power on system]
+
NOTE: Initial booting may take up to eight minutes.
