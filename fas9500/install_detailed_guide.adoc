...
a|
image::../media/oie_cable_fiber_lc_connector.png[width=85px]
a|
FC optical network
a|
...
Not applicable
a|
image::../media/oie_cable_micro_usb.pngMicro USB connector]
a|
...
Remove the end cap.
a|
image::../media/icon_round_02.svg[width=20]
a|
...
a|
image::../media/icon_round_03.svg[width=20]
a|
...
Replace the end cap.
a|
image::../media/icon_round_05.svg[width=20]
a|
