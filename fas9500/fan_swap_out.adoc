...
---
= Hot-swap a fan module in a FAS9500 system
:icons: font
:imagesdir: ../media/

[.lead]
To hot-swap a fan module in your FAS9500 system without interrupting service, you must perform a specific sequence of tasks.

IMPORTANT: It is a best practice to replace the fan module within two minutes of removing it from the chassis. The system continues to function, but ONTAP sends messages to the console about the degraded fan module until the fan module is replaced.
...
+
image::../media/drw_9500_remove_install_fan.svg[Replace the fan]
+
