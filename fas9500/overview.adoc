...
summary: Key specifications for the FAS9500 storage system
---
...
[.lead]
The following are select specifications for the FAS9500. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of FAS9500 specifications. This page is reflective of a single high availability pair. 
...
* Operating Temp/Altitude/Humidity: 10°C to 35°C (50°F to 95°F) at up to 3048m (10000 ft) elevation;8% to 90% relative humidity, noncondensing
