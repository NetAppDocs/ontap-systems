...
---
= Key specifications for a FAS9500 system
:icons: font
:imagesdir: ../media/

[.lead]
Review select specifications for the FAS9500 storage system in a single high-availability (HA) pair, and visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of FAS9500 specifications.
