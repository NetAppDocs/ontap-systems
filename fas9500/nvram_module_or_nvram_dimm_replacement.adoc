...
summary: 'The NVRAM module consists of the NVRAM11 and DIMMs and up to two NVMe SSD Flash Cache modules (Flash Cache or caching modules) per NVRAM module.'
---
= Replace the NVRAM module or NVRAM DIMM in your FAS9500 system
:icons: font
:imagesdir: ../media/

[.lead]
The NVRAM module in your FAS9500 system consists of the NVRAM11 and DIMMs. You can replace a failed NVRAM module or an NVRAM DIMM to keep your system operating normally.

To replace a failed NVRAM module, you must remove it from the chassis, move the DIMMs to the replacement module, and install the replacement NVRAM module into the chassis.
...
+
image::../media/drw_9500_move-remove_NVRAM_module.svg[Remove the NVRAM module]
+
...
image::../media/drw_9500_remove_NVRAM_module_contents.svg[Remove the NVRAM module contents]
+
...
You must confirm the system ID change when you boot the replacement controller and then verify that the change is correct.
