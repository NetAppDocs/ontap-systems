...
---
= Replace the controller in your FAS9500 system
:icons: font
:imagesdir: ../media/
...
image::../media/drw_9500_remove_boot_dev.svg[Remove the boot device]
+
...
image::../media/drw_9500_replace_PCM_dimms.svg[Move the DIMMs]
...
+
image::../media/drw_9500_remove_PCM.svg[Reinstall the controller]
+
