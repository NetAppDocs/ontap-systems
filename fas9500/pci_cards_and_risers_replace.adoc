...
---
= Replace an I/O module in your FAS9500 system
:icons: font
:imagesdir: ../media/

[.lead]
To replace an I/O module in your FAS9500 system, you must shut down the impaired node, remove and install the I/O module, and then reboot the node.
