...
---
= Install a FAS9500 storage system using quick steps
:icons: font
:imagesdir: ../media/

[.lead]
Use these graphic instructions for a typical installation of your FAS9500 system, from racking and cabling through initial system bring-up. Use this content if you are familiar with installing NetApp systems.
