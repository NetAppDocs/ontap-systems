...
summary: Replace the real-time clock battery in the controller module.
---
= Replace the real-time clock battery in your FAS9500 system
:icons: font
:imagesdir: ../media/
...
* All other components in the system must be functioning properly; if they aren't, you must contact technical support.
...
After you replace the RTC battery, you must reinstall the controller module. If the RTC battery has been left out of the controller module for more than 10 minutes, you might have to reset the time and date.
