...
summary: Before replacing the boot media in your FAS9500 system, ensure you meet the necessary requirements for a successful replacement.
---
= Requirement to replace the boot media - FAS9500
:icons: font
:imagesdir: ../media/
