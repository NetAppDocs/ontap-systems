...
summary: "Replace the DIMM in a FAS9500 system when the system reports excessive correctable ECC memory errors through Health Monitor alerts, or uncorrectable ECC errors. A failing DIMM can prevent the storage system from booting ONTAP, so replacing it restores stable operation."
---
= Replace the DIMM in a FAS9500 system to fix memory errors
:icons: font
:imagesdir: ../media/

[.lead]
Replace the DIMM in a FAS9500 system when the system reports excessive correctable ECC memory errors through Health Monitor alerts, or uncorrectable ECC errors. A failing DIMM can prevent the storage system from booting ONTAP, so replacing it restores stable operation.
...
+
image::../media/drw_9500_remove_PCM.svg[Remove the controller]
+
...
+
image::../media/drw_9500_PCM_open.svg[Open the controller]
+
[cols="20%,80%"]
|===
a|
...
+
image::../media/drw_9500_DIMM_map.svg[System DIMM map]
...
+
image::../media/drw_9500_PCM_open.svg[Close the controller]
+
[cols="20%,80%"]
|===
a|
...
+
image::../media/drw_9500_remove_PCM.svg[Remove or install the controller]
+
[cols="20%,80%"]
|===
a|
