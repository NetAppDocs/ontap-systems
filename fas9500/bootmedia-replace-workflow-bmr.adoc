...
---
= Boot media replacement workflow for a FAS9500 system using the automated boot recovery process
:icons: font
:imagesdir: ../media/

[.lead]
Get started with replacing the boot media in your FAS9500 storage system using the automated boot recovery process. The system automatically identifies and selects the appropriate boot menu option, then uses the boot image on the partner node to reinstall ONTAP on the replacement boot media.
