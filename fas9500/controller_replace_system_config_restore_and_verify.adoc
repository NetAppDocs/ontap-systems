...
---
= Restore and verify the controller configuration in your FAS9500 system
:icons: font
:imagesdir: ../media/

[.lead]
After completing the hardware replacement, you verify the low-level system configuration of the replacement controller, including the system time and HA state, and reconfigure system settings as necessary.
