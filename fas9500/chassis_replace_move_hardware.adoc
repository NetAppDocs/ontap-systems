...
summary: 'To replace the chassis, you must remove the components from the impaired chassis and install them in the replacement chassis.'
---
= Replace the chassis in your FAS9500 system
:icons: font
:imagesdir: ../media/
...
You must remove the six fan modules, located in the front of the chassis, when replacing the chassis.
...
After the replacement chassis is installed into the rack or system cabinet, you must reinstall the de-stage controller power modules into it.
