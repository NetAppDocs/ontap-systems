...
summary: Add an I/O module to your ASA C30 system to enhance network connectivity and expand your system’s ability to handle data traffic.
---
...
[.lead]
Add an I/O module to your ASA C30 system to enhance network connectivity and expand your system’s ability to handle data traffic.

You can add an I/O module to your ASA C30 storage systems when there are slots available or when all slots are fully populated.
