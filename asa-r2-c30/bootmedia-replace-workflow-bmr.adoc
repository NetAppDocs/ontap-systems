...
summary: Get started with replacing the boot media in your ASA C30 storage system by reviewing the replacement requirements, shutting down the impaired controller, replacing the boot media, restoring the image on the boot media, and verifying the system functionality.
---
= Boot media replacement workflow for an ASA C30 system using the automated boot recovery process
:icons: font
:imagesdir: ../media/
