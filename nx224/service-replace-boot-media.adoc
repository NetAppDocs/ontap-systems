...
summary: You can replace a failed boot media in an NX224 shelf. Replacing the boot media can be done nondisruptively, while the shelf is powered on, and I/O is in progress.
---
= Replace the boot media in an NX224 shelf
:icons: font
:imagesdir: ../media/

[.lead]
You can replace a failed boot media in an NX224 shelf. Replacing the boot media can be done nondisruptively, while the shelf is powered on, and I/O is in progress.
