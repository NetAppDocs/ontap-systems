...
* *NX224 with NSM100 modules only*: Your HA pair must already be running ONTAP 9.7 or later, which has the minimum supported version of NSM firmware.
+
...
link:service-replace-nsm100.html[Replace an NSM - NX224 shelves^]
====
* *NX224 with NSM100 modules only*: You need a Phillips #1 screwdriver.
+
...
video::20ed85f9-1f80-4e0e-9219-ab4600070d8a[panopto, title="Replace the NX224 shelf boot media"]
