...
---
= Replace a DIMM in an NX224 shelf
:icons: font
:imagesdir: ../media/
...
. Verify that the NSM is cabled correctly, by https://mysupport.netapp.com/site/tools/tool-eula/activeiq-configadvisor[running Config Advisor^].
+
