...
---
= Replace an NSM in an NX224 shelf
:icons: font
:imagesdir: ../media/
...
+
CAUTION: Before you close the impaired NSM cover, make sure the ejector tabs on all empty DIMM slots are fully returned to the locked position.
