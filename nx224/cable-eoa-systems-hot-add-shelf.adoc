---
permalink: nx224/cable-eoa-systems-hot-add-shelf.html
sidebar: sidebar
...
---
= Cable shelf to end-of-availability systems - NX224 shelves
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_ns224_a320_2shelves_direct_attached.png[Cabling for an AFF A320 with two NX224 shelves and three sets of onboard ports]
...
How you cable an NX224 shelf to an AFF A700 HA pair depends on the number of shelves you are hot-adding and the number of RoCE-capable port sets (one or two) you are using on the controllers.
...
* If you are hot-adding the initial NX224 shelf (no NX224 shelf exists in your HA pair), you must install a core dump module (X9170A, NVMe 1TB SSD) in each controller to support core dumps (store core files). 
+
...
. If you are hot-adding one shelf using one set of RoCE-capable ports (one RoCE capable I/O module) on each controller, and this is the only NX224 shelf in your HA pair, complete the following substeps.
+
...
+
image::../media/drw_ns224_a700_1shelf.png[Cabling for an AFF A700 with one NX224 shelf and one set of IO module ports]
...
+
image::../media/drw_ns224_a700_2shelves.png[Cabling for an AFF A700 with two NX224 shelves and two sets of IO module ports]
...
When additional storage is needed, you can hot-add one NX224 shelf to a FAS500f HA pair.
...
+
image::../media/drw_ns224_a250_c250_f500f_1shelf_ieops-1824.svg[Cabling for a FAS500f AFF A250 or AFF C250 with one NX224 shelf and one set of ports]
