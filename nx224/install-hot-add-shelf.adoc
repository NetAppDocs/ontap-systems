...
+
It is recommended to install all shelves close to the switches. If a shelf is not in the same rack as the switches, you might need to use optical interconnect for your installation.
+
