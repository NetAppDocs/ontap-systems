...
+
A power supply is powered on as soon as the power cord is plugged in. Its bicolored LED should illuminate green. Wait at least 180 seconds before continuing to the next step. 
