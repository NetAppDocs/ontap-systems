...
image::../media/drw_ns224_nsm_leds_IEOPS-1270.svg[NX224 NSM100 module LEDs, width=550px]
...
image::../media/drw_ns224_nsmb_leds_ieops-2004.svg[NX224 NSM100B module LEDs, width=550px]
