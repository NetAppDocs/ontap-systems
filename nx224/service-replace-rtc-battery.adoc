...
summary: "You can replace a failed real-time clock (RTC) battery nondisruptively in an NX224 shelf that is powered on, and while I/O is in progress."
---
= Replace the RTC battery in an NX224 shelf
:icons: font
:imagesdir: ../media/
