---
permalink: nx224/prepare-hot-add-shelf.html
sidebar: sidebar
keywords: nx224, shelves, shelf, nx224 shelves, hot-add, ha, pair, requirement, preparation, applicable, complete, drive, hot-add an nx224 drive shelf
...
---
= Prepare for a hot-add - NX224 shelves
:icons: font
:imagesdir: ../media/

[.lead]
Complete the preparation tasks applicable to your HA pair before hot-adding an NX224 shelf.
...
If your HA pair has non-dedicated RoCE-capable Ethernet ports that you are using to hot-add an NX224 shelf, you must configure the ports for storage use (not networking use).
...
If you are manually assigning drive ownership for the NX224 shelf you are hot-adding, then you need to disable automatic drive assignment if it is enabled.
