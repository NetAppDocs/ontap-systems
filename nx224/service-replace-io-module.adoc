...
summary: You can replace a failed Ethernet I/O module nondisruptively in an NX224 shelf that is powered on, and while I/O is in progress.
---
= Replace the Ethernet I/O module in an NX224 shelf
:icons: font
:imagesdir: ../media/

[.lead]
You can replace a failed Ethernet I/O module nondisruptively in an NX224 shelf that is powered on, and while I/O is in progress. 
