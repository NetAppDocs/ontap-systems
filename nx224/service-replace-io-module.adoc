...
[.lead]
You can replace a failed Ethernet I/O module nondisruptively in an NX224 drive shelf that is powered on, and while I/O is in progress. 
...
+
image::../media/temp_io_module.png[Replace the I/O module.]
+
[cols="1,4"]
|===
a|
