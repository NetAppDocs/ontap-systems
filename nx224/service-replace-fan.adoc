...
summary: You can replace a failed fan nondisruptively in an NX224 drive shelf that is powered on, and while I/O is in progress.
---
...
[.lead]
If one or both of the fans in your fan module fail, you can replace your fan module. This procedure can be completed nondisruptively in an NX224 drive shelf that is powered on with I/O in progress.
...
.NSM100 modules
--
You can use the following animation to assist in replacing a fan in an NX224 with NSM100 modules.

video::29635ff8-ae86-4a48-ab2a-aa86002f3b66[panopto, title="Replace a fan in an NX224 shelf"]
