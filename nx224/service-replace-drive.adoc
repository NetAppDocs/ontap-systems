...
+
NOTE: You need to manually assign drive ownership if drives in the shelf are owned by both controller modules in the OAM cluster. You complete this task later in this procedure.
