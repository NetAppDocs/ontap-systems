...
---
= Hot-swap a drive in an NX224 shelf
:icons: font
:imagesdir: ../media/
...
* The drive that you are installing must be supported by the NX224 shelf. You can verify your shelf's compatible drives in the https://hwu.netapp.com[NetApp Hardware Universe^].
