...
---
= Complete the controller replacement for your AFF A220 system
:icons: font
:imagesdir: ../media/

[.lead]
Complete the controller replacement for your AFF A220 system by restoring the NetApp Storage Encryption configuration (if necessary), installing licenses for the new controller, and returning the failed part to NetApp.
