...
---
= Replace the chassis in your AFF A220 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the chassis in your AFF A220 system by moving the power supplies, hard drives, and controller modules from the impaired chassis to the replacement chassis.
