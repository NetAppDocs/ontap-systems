...
---
= Install your AFF A220 storage system using detailed steps
:icons: font
:imagesdir: ../media/

[.lead]
Install your AFF A220 storage system using detailed step-by-step instructions, from racking and cabling to initial system bring-up.
