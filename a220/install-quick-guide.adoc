...
---
= Install your AFF A220 storage system using quick steps
:icons: font
:imagesdir: ../media/

[.lead]
Install your AFF A220 storage system using quick graphic instructions, from racking and cabling through initial system bring-up.
