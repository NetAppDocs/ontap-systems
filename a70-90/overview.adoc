---
permalink: a70-90/overview.html
sidebar: sidebar
summary: Key specifications for the A70-90 platform group
---
= Key specifications for A70-90 platform group
:icons: font
:imagesdir: ../media/

[.lead]
The following are select specifications for the A70-90 platform group. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of specifications. This page is reflective of a single high availability pair.
