...
.What's next?
After you've reviewed the installation requirements and considerations, you link:prepare-hardware.html[prepare to install your AFF A70 or AFF A90 storage system].
