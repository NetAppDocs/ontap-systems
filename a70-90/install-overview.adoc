...
---
= AFF A70 and AFF A90 installation and configuration workflow
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Before you power on the controllers, power on each NS224 shelf and assign a unique shelf ID. Then connect the laptop or console to the controller, and connect the controllers to the power sources.
