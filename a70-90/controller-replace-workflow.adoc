...
---
= AFF A70 and AFF A90 controller replacement workflow
:icons: font
:imagesdir: ../media/

[.lead]
Replace the controller in your AFF A70 or AFF A90 storage system by shutting down the impaired controller, removing and replacing the controller, restoring the system configuration, and returning control of storage resources to the replacement controller. 
