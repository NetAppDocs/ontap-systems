...
summary: The AFF A70 and AFF A90 controller replacement includes steps to shut down the controller, remove and replace the controller, reconfigure system settings, and verify system operations. 
---
...
[.lead]
The AFF A70 and AFF A90 controller replacement includes steps to shut down the controller, remove and replace the controller, reconfigure system settings, and verify system operations. 
