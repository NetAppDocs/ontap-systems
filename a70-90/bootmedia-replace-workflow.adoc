...
---
= Boot media replacement workflow for an AFF A70 or AFF A90 system using the manual boot recovery process
:icons: font
:imagesdir: ../media/
...
If your storage system is running ONTAP 9.17.1 or later, use the link:bootmedia-replace-workflow-bmr.html[automated boot recovery procedure]. If your system is running an earlier version of ONTAP, use the manual boot recovery procedure.
