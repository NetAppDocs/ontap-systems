...
---
= Replace the NVRAM in your AFF A70 or AFF A90 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the NVRAM in your AFF A70 or AFF A90 system when the non-volatile memory becomes faulty or requires an upgrade. The replacement process involves shutting down the impaired controller, completely removing power by pulling the controller out a few inches, replacing the NVRAM module or the NVRAM DIMM, reassigning the disks, and returning the failed part to NetApp.
