...
[.lead]
Review select specifications for the AFF A90 storage system in a single high availability pair configuration. Visit NetApp Hardware Universe (HWU) for the complete specifications for this storage system.
