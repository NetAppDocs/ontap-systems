...
---
= Key specifications for an AFF A90 system
:icons: font
:imagesdir: ../media/

[.lead]
Review select specifications for the AFF A90 storage system in a single high availability pair configuration. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A90 specifications. 
