...
+
To use this procedure, your storage system must be running ONTAP 9.18.1 or later and meet specific requirements for the version of ONTAP your system is running.
