...
---
= Learn about adding and replacing I/O modules in your AFF A70 or AFF A90 system
:icons: font
:imagesdir: ../media/
...
+
You can hot-swap certain I/O modules for an equivalent I/O module to restore the storage system to its optimal operating state. You can hot-swap the module without performing a manual takeover.

To use this procedure, your storage system must be running ONTAP 9.18.1 or later.
