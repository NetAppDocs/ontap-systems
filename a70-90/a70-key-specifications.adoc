...
---
= Key specifications for an AFF A70 system
:icons: font
:imagesdir: ../media/

[.lead]
Review select specifications for the AFF A70 storage system in a single high availability pair configuration. Visit NetApp Hardware Universe (HWU) for the complete specifications for this storage system.
...
CE DoC,
UKCA DoC
* Standards EMC/EMI: BS-EN-55032, BS-EN55035,
CISPR 32,
EN55022,
EN55024,
EN55032,
