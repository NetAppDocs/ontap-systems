...
---
= Review requirements for manual boot media recovery in your AFF A70 or AFF A90 system
:icons: font
:imagesdir: ../media/
...
If your system is running ONTAP 9.17.1 or later, use the link:bootmedia-replace-workflow-bmr.html[automated boot recovery procedure].
