...
summary: Get started with replacing the chassis in your AFF A70 or AFF A90 storage system by shutting down the controllers, removing and replacing the chassis, and verifying system operations.
---
...
[.lead]
Get started with replacing the chassis in your AFF A70 or AFF A90 storage system by shutting down the controllers, removing and replacing the chassis, and verifying system operations. 
