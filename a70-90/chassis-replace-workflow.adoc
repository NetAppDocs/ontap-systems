...
Review the requirements for replacing your system chassis.
...
[role="quick-margin-para"]
Completing the chassis replacement includes bringing the controllers up, giving back the controllers, and returning the failed chassis to NetApp.
