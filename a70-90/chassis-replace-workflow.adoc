...
[role="quick-margin-para"]
Replacing the chassis includes removing the power supplies, hard drives, and controllers, removing and replacing the impaired chassis, reinstalling the controllers and controller components into the replacement chassis, and applying power th the controllers.
