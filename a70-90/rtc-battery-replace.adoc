...
summary: "Replace the real-time clock battery, commonly known as a coin cell battery, in your AFF A70 or AFF A90 system to ensure that services and applications relying on accurate time synchronization remain operational."
---
= Replace the real-time clock battery in your AFF A70 or AFF A90 system
:icons: font
:imagesdir: ../media/
