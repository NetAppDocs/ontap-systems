...
---
= Cable your AFF A70 or AFF A90 hardware for network and storage connectivity
:icons: font
:imagesdir: ../media/
...
+
. Connect your 10/25 GbE cards to your host network switches.
+
...
The following cabling procedures show how to connect your controllers to a storage shelf. Choose one of the following cabling options that match your setup.
