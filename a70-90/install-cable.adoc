...
---
= Cable the hardware - AFF A90, AFF A70
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_70-90_tnsc_cluster_cabling_ieops-1653.svg[Two-node switchless cluster cabling diagram AFF A90, AFF A70, width=500px]
+
...
+
image::../media/drw_70-90_network_cabling1_IEOPS-1654.svg[Cable to 100 Gb Ethernet network AFF A90, AFF A70,width=500px]
...
+
image::../media/drw_70-90_network_cabling2_ieops-1655.svg[Cable to 100Gb Ethernet network AFF A90, AFF A70,width=500px]
+
...
image::../media/oie_cable_sfp_gbe_copper.svg[100Gb Ethernet cable,width=100px]
+
image::../media/drw_70-90_network_cabling1_ieops-1654.svg[Cable to 100Gb Ethernet network AFF A90, AFF A70,width=500px]
...
+
image::../media/drw_70-90_network_cabling2_ieops-1655.svg[Cable to 10/25Gb Ethernet network AFF A90, AFF A70,width=500px]
+
...
*1000BASE-T RJ-45 cables*
+
image::../media/drw_70-90_management_connection_ieops-1656.svg[Connect to your management network AFF A90, AFF A70,width=500px]
...
+
image:../media/drw_A70-90_1shelf_cabling_A_ieops-1731.svg[Controller A e11a and e11b to a single NS224 shelf AFF A90, AFF A70]
...
.. Connect port e8a to shelf 2, NSM A port e0.

.. Connect port e8b to shelf 1, NSM A port e0b.
+
image:../media/drw_a70-90_2shelf_cabling_a_ieops-1733.svg[Controller-to-shelf connections for controller A AFF A-70-90]
+
...
.. Connect e8b to shelf 1, NSM A port e0b.
+
image:../media/drw_a70-90_2shelf_cabling_b_ieops-1734.svg[Controller-to-shelf connections for controller B AFF A-70-90]
+
