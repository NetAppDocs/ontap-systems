...
---
= Complete storage system setup and configuration - AFF A70, AFF A90
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_autodiscovery_controler_select.svg[How to discover your controllers with Windows File Explorer]
