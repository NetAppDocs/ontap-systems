...
---
= Complete storage system setup and configuration - AFF A90, AFF A70
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_autodiscovery_controler_select.svg[How to discover your controllers with Windows File Explorer AFF A90, AFF A70]
