...
[.lead]
Review select specifications for the AFF A70 storage system in a single high availability pair configuration. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A70 specifications. 
