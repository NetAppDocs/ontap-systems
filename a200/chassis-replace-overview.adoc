...
---
= Review the requirements for replacing a chassis in an AFF A200 system
:icons: font
:imagesdir: ../media/

[.lead]
Before replacing the chassis in your AFF A200 system, review the requirements for a successful replacement. The chassis replacement procedure moves all power supplies, drives, and controller modules from the impaired chassis to the replacement chassis and is disruptive.
