...
---
= Complete the chassis replacement for your AFF A200 system
:icons: font
:imagesdir: ../media/

[.lead]
Complete the chassis replacement for your AFF A200 system by verifying the HA state of the chassis and returning the failed component to NetApp.
