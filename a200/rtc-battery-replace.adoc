...
summary: "Replace the real-time clock battery in your AFF A200 system to ensure that services and applications that depend on accurate time synchronization continue to function."
---
= Replace the real-time clock battery in an AFF A200 system
:icons: font
:imagesdir: ../media/
