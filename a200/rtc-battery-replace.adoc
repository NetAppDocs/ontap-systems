...
---
= Replace the real-time clock battery in your AFF A200 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the real-time clock (RTC) battery in your AFF A200 system to ensure that services and applications that depend on accurate time synchronization continue to function.
...
+
image::../media/drw_2600_rtc_battery.png[Removing the RTC battery]
