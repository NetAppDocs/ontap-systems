...
---
= Choose how to install an AFF A200 storage system
:icons: font
:imagesdir: ../media/

[.lead]
You can choose from different content formats to guide you through installing and setting up your AFF A200 storage system.
