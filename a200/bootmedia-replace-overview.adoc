...
summary: "The boot media stores a primary and secondary set of system boot image files that the system uses when it boots. Depending on your network configuration, you can perform either a nondisruptive or disruptive replacement. The AFF A200 system supports only manual boot media recovery procedures."
---
= Learn about boot media replacement in your AFF A200 system
:icons: font
:imagesdir: ../media/
