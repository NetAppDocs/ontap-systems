...
---
= Hot-swap a power supply in your AFF A200 system
:icons: font
:imagesdir: ../media/

[.lead]
Hot-swap a power supply in your AFF A200 system by turning off, disconnecting, and removing the failed unit, then installing and reconnecting the replacement.
