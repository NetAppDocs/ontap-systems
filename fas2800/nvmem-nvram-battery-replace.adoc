...
summary: "To replace an NVMEM battery in your FAS2820 system, you must remove the controller module, open it, replace the battery, and then close and reinstall the controller module."
---
= Replace the NVMEM battery in your FAS2820 system
:icons: font
:imagesdir: ../media/

[.lead]
To replace an NVMEM battery in your FAS2820 system, you must remove the controller module, open it, replace the battery, and then close and reinstall the controller module.

If any other components in the system aren't functioning properly, contact https://mysupport.netapp.com/site/global/dashboard[NetApp Support].
...
+
image::../media/drw_2850_open_controller_module_cover_IEOPS-695.svg[Remove the controller cover]
