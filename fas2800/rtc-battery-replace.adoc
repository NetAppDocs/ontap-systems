...
summary: "You replace the real-time clock battery in the controller module of your FAS2820 system so that services and applications that depend on accurate time synchronization continue to function."
---
= Replace the real-time clock battery in your FAS2820 system
:icons: font
:imagesdir: ../media/

[.lead]
You replace the real-time clock (RTC) battery in the controller module of your FAS2820 system so that services and applications that depend on accurate time synchronization continue to function.
...
Replace the RTC battery by locating it inside the controller and following the specific sequence of steps.
