...
summary: "After completing the hardware replacement and booting the replacement controller in your FAS2820 system, verify the low-level system configuration of the replacement controller and reconfigure system settings as necessary."
---
= Restore and verify the controller configuration in your FAS2820 system
:icons: font
:imagesdir: ../media/

[.lead]
After completing the hardware replacement and booting the replacement controller in your FAS2820 system, verify the low-level system configuration of the replacement controller and reconfigure system settings as necessary.
