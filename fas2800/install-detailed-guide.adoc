...
a|
image::../media/oie_cable_25Gb_Ethernet_SFP28_IEOPS-1069.svg[]
a|
Network cable
a|
32Gb Fiber Channel,
...
X66032A, 2m
a|
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.svg[]
a|
Storage
a|
USB-C console cable
...
+
image::../media/oie_fas2800_weight_caution_IEOPS-1070.svg[]
...
+
image::../media/drw_2800_tnsc_cluster_cabling_IEOPS-892.svg[]
. Cable the e0M ports to the management network switches with the RJ45 cables:
+
image::../media/oie_cable_rj45.png[RJ-45 cables]
*RJ45 cables*
+
image::../media/drw_2800_management_connection_IEOPS-1077.svg[]
+
. Cable the mezzanine card ports to your host network. 
+
image::../media/drw_2800_network_cabling_IEOPS-894.svg[]
...
image::../media/oie_cable_25Gb_Ethernet_SFP28_IEOPS-1069.svg[]
+
image::../media/drw_2800_switched_cluster_cabling_IEOPS-893.svg[]
. Cable the e0M ports to the management network switches with the RJ45 cables:
+
image::../media/oie_cable_rj45.png[RJ-45 cables]
+
...
+
image::../media/drw_2800_shelf-to-shelf_cabling_IEOPS-895.svg[]
+
...
*mini-SAS HD to mini-SAS HD cables*
+
image::../media/dwr-2800_controller1-to shelves_IEOPS-896.svg[]     
+
...
*mini-SAS HD to mini-SAS HD cables*
+
image::../media/dwr-2800_controller2-to shelves_IEOPS-897.svg[]
...
image::../media/dwr_2800_turn_on_power_IEOPS-898.svg[]
...
+
image::../media/drw_autodiscovery_controler_select_ieops-1849.svg[]
...
+
image::../media/drw_2800_laptop_to_switch_to_controller_IEOPS-1084.svg[]
