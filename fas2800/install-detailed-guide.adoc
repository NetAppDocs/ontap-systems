...
summary: "This procedure gives detailed, step-by-step instructions for installing your FAS2820 storage system."
---
= Install your FAS2820 system using detailed instructions
:icons: font
:imagesdir: ../media/

[.lead]
This procedure provides detailed, step-by-step instructions for preparing, installing, cabling, and powering on your FAS2820 storage system. Use these steps if you prefer thorough explanations rather than the abbreviated quick guide.
...
.. Review the requirements and procedure steps.
.. Gather information about your storage system by completing the setup worksheet.
...
NOTE: If your system has no external shelves, see link:../sas3/install-cabling-worksheets-examples-fas2600.html#fas2820-platform-in-a-multipath-ha-configuration-with-no-external-shelves[cabling instructions for FAS2820 in a multipath HA configuration without external shelves].
...
Complete your storage system setup and configuration using either Option 1: if network discovery is enabled, or Option 2: if network discovery is not enabled.
...
.. Select https://mysupport.netapp.com[mysupport.netapp.com]
.. Select _Create Account_ if you need to create an account or log into your account.
