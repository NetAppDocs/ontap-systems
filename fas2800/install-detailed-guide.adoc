...
[.lead]
This procedure gives detailed, step-by-step instructions for installing your FAS2820 storage system. Use this procedure if you want more detailed installation instructions.
