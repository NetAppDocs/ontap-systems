...
a|
image::../media/square_icon_1_green.png[Callout icon three]]
a|
...
| Cabling|Connection type
a|
image::../media/square_icon_1_blue.png[width=40px]
a|
Shelf-to-shelf cabling
a|
image::../media/square_icon_2_yellow.png[width=40px]
a|
Controller A to the drive shelves
a|
image::../media/square_icon_3_orange.png[width=40px]
a|
