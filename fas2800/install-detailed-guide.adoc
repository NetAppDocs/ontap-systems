...
NOTE: If you have no external storage, see link:../sas3/install-cabling-worksheets-examples-fas2600.html[FAS2820 platform in a multipath HA configuration with no external shelves] for cabling instructions for this configuration.
