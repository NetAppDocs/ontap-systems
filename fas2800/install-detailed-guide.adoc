...
Depending on your system configuration, you can ust the applicable animation or detailed steps in the table to cable your controllers to your network as either a two-node switchless cluster or a switched cluster.
