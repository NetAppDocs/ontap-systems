...
+
image::../media/drw_2850_pcm_remove_install_IEOPS-694.svg[]
...
+
image::../media/drw_2850_open_controller_module_cover_IEOPS-695.svg[]
...
image:../media/drw_2850_replace_boot_media_IEOPS-696.svg[]
