...
summary: "Hot-swapping a power supply in your FAS2820 system involves turning off, disconnecting, and removing the impaired power supply, and installing, connecting, and turning on the replacement power supply."
---
= Hot-swap a power supply in your FAS2820 system
:icons: font
:imagesdir: ../media/

[.lead]
Hot-swap a power supply in your FAS2820 system if it fails or degrades, without interrupting system operation. This procedure involves turning off and removing the impaired power supply, then installing and powering on the replacement.
