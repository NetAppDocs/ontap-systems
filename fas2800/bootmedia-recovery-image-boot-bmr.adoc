...
summary: Restore the ONTAP image on the replacement boot media in your fas2800 system. The process involves initiating the boot recovery process from the LOADER prompt and monitoring the recovery process until it completes and the node reboots.
---
= Restore the image on the boot media - FAS2800
:icons: font
:imagesdir: ../media/
