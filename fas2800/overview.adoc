...
[.lead]
The following are a selection of key specifications for an FAS2820 system in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of FAS2820 specifications.
