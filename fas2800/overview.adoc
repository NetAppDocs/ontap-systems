...
summary: Key specifications for the FAS2820 platform group
---
= Key specifications for a FAS2820 system
:icons: font
:imagesdir: ../media/

[.lead]
These are select specifications for the FAS2820 storage system in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] for the complete specifications for this storage system.
