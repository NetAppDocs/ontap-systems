...
summary: "In your FAS2820 system, replace the impaired controller module hardware by removing the impaired controller, moving FRU components to the replacement controller module, installing the replacement controller module in the chassis, and then booting the replacement controller module."
---
= Replace the controller in your FAS2820 system
:icons: font
:imagesdir: ../media/

[.lead]
In your FAS2820 system, replace the impaired controller module hardware by removing the impaired controller, moving FRU components to the replacement controller module, installing the replacement controller module in the chassis, and then booting the replacement controller module.
...
+
image::../media/drw_2850_open_controller_module_cover_IEOPS-695.svg[Remove the cover]
...
image::../media/drw_2850_replace_nvbattery_IEOPS-715.svg[Move the NV battery]
...
+
NOTE: Do not plug the battery in yet. You plug it in after the rest of the components are moved to the replacement controller module.

== Step 3:  Remove the mezzanine card 

Remove the IO Plate and PCIe mezzanine card from the impaired controller module.

image::../media/drw_2850_replace_HIC_IEOPS-700.svg[Move the mezzanine card]
...
+
image::../media/drw_2850_replace_boot_media_IEOPS-696.svg[Move the boot media]
+
...
. Install the boot media to the replacement controller module:
...
image::../media/drw_2850_replace_dimms_IEOPS-699.svg[Move the DIMMs]
...
Remove the caching module from the impaired controller module and install it into the replacement controller module.

image::../media/drw_2850_replace_caching module_IEOPS-697.svg[Move the caching module]
...
. Turn the controller module over.
