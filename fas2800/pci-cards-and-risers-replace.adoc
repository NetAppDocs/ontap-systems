...
[.lead]
Replace the mezzanine card in your FAS2820 system if it fails or if you want to change the card protocol.

* You can use this procedure with all versions of ONTAP supported by your system.
* You can replace the mezzanine card with the same or a different type.
* Capture the ifgrp and VLAN information before shutdown.
* If you are changing mezzanine card types, update LIF and port settings after the controller restarts.
* Check that all other system components work. If they do not, contact technical support.
...
Remove the controller module, then remove its cover.
