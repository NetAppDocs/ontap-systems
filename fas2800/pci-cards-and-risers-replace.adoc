...
summary: "Replace the mezzanine card in your FAS2820 system if the card fails, or upgrade it to a different protocol by installing a new card."
---
= Replace a mezzanine card in your FAS2820 system
:icons: font
:imagesdir: ../media/
