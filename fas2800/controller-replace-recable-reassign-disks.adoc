...
summary: "To complete the controller replacement and restore your FAS2820 system to full operation, you must recable the storage, confirm disk reassignment, restore the NetApp Storage Encryption configuration (if necessary), and install licenses for the new controller."
---
= Give back the controller in your FAS2820 system to resume normal operations
:icons: font
:imagesdir: ../media/

[.lead]
To complete the replacement procedure and restore your FAS2820 system to full operation, you must recable the storage, confirm disk reassignment, restore the NetApp Storage Encryption configuration (if necessary), and install licenses for the new controller.
