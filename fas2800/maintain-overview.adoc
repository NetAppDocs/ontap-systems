...
summary: "Maintain the hardware of your FAS2820 storage system to ensure long-term reliability and optimal performance."
---
= Learn about maintaining your FAS2820 storage system
:icons: font
:imagesdir: ../media/
...
== System components
You can perform maintenance procedures on these components of your FAS2820 storage system.
...
a| A Mezzanine card is an expansion card that inserts into a specialized slot on the motherboard and holds the card I/O cards.
