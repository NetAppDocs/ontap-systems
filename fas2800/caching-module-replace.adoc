...
summary: "You must replace the caching module in the controller module when your system registers a single AutoSupport ASUP message that the module has gone offline. If you do not replace the failed module, your storage system will experience performance degradation."
---
