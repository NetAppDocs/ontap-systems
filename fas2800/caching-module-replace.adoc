...
summary: "You must replace the caching module in the controller module of your FAS2820 system when it registers a single AutoSupport message that the module has gone offline. If you don't replace the failed module, your storage system experiences performance degradation."
---
= Replace the caching module in your FAS2820 system
:icons: font
:imagesdir: ../media/

[.lead]
You must replace the caching module in the controller module of your FAS2820 system when it registers a single AutoSupport (ASUP) message that the module has gone offline. If you don't replace the failed module, your storage system experiences performance degradation.
...
+
image::../media/drw_2850_open_controller_module_cover_IEOPS-695.svg[Open the controller module]
...
+
image::../media/drw_2850_replace_caching module_IEOPS-697.svg[Replace the caching]
+
[cols="1,3"]
|===
