...
summary: "You must replace a DIMM in the controller when your storage system encounters errors such as excessive correctable ECC errors based on Health Monitor alerts, or uncorrectable ECC errors that prevent the storage system from booting ONTAP."
---
