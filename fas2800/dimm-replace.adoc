...
summary: "You must replace a DIMM in the controller of your FAS2820 system when it encounters errors such as excessive CECC (Correctable Error Correction Codes) errors based on Health Monitor alerts or uncorrectable ECC errors, typically caused by a single DIMM failure that prevents the storage system from booting ONTAP."
---
= Replace a DIMM in your FAS2820 system to fix memory errors
:icons: font
:imagesdir: ../media/

[.lead]
You must replace a DIMM in the controller of your FAS2820 system when it encounters errors such as excessive CECC (Correctable Error Correction Codes) errors based on Health Monitor alerts or uncorrectable ECC errors, typically caused by a single DIMM failure that prevents the storage system from booting ONTAP.
