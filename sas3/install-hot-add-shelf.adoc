...
---
= Hot-add a shelf (DS212C, DS224C, or DS460C shelves)
:icons: font
:imagesdir: ../media/
...
== Install disk shelves with IOM12/IOM12B/IOM12C modules for a hot-add
...
== Cable disk shelves with IOM12/IOM12B/IOM12C modules for a hot-add
