...
** If the shelf will have a combination of IOM12 modules and any number of DCM3 drive drawers, you must upgrade the IOM12 FW to version 0400 or later.
** If the shelf will have a combination of IOM12B modules and any number of DCM3 drive drawers, you must upgrade the IOM12B FW to version 0200 or later.
+
