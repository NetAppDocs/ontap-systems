...
---
= Monitor DS212C, DS224C, or DS460C shelf LEDs
:icons: font
:imagesdir: ../media/
...
Solid amber
a|
An error occurred with the function of one or more FRUs: the disk shelf, disk drives, IOM12, IOM12B, or IOM12C modules, or power supplies.
...
The location LED on the operator display panel and both IOM12, IOM12B, or IOM12C modules illuminate when this LED function is activated. Location LEDs automatically turn off after 30 minutes.
|===
...
The LEDs on the IOM12, IOM12B, or IOM12C module indicate whether the module is functioning normally, whether it is ready for I/O traffic, and whether there are any problems with the hardware.

The following table describes IOM12, IOM12B, or IOM12C module LEDs associated with the function of the module and the function of each SAS port on the module.

The IOM12, IOM12B, or IOM12C module is used in DS460C, DS224C, and DS212C disk shelves.
...
Solid amber
a|
IOM12, IOM12B, or IOM12C module function: An error occurred with the function of the IOM12, IOM12B, or IOM12C module.
...
Solid blue
a|
The system administrator activated this LED function to aid in physically locating the disk shelf with the failed IOM12, IOM12B, or IOM12C module.
...
image::../media/drw_iom12.gif[IOM12 module, width=828px, height=147px]

The IOM12B modules are distinguished by a blue stripe and an "IOM12B" label:

image::../media/iom12b.png[IOM12B module, width=828px, height=147px]

The IOM12C modules are distinguished by a blue and gray stripe and an "IOM12C" label:

image::../media/drw_iom12c_ieops-2175.svg[IOM12C module, width=828px, height=147px]
