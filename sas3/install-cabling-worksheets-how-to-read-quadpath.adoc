...
summary: You can use this example to guide you through how to read and apply a completed worksheet to cable stacks of disk shelves with IOM12, IOM12B, or IOM12C modules for quad-pathed connectivity.
---
= Read a worksheet to cable controller-to-stack connections for DS212C, DS224C, or DS460C quad-pathed connectivity 
:icons: font
:imagesdir: ../media/

[.lead]
You can use this example to guide you through how to read and apply a completed worksheet to cable stacks of disk shelves with IOM12, IOM12B, or IOM12C modules for quad-pathed connectivity.
