...
summary: "If your new system did not come installed in a cabinet, you must install and cable the disk shelves in a rack."
---
= Install and cable a DS212C, DS224C, or DS460C shelf
:icons: font
:imagesdir: ../media/
...
* Disk shelves with IOM12, IOM12B, or IOM12C modules are shipped with shelf IDs preset to 00.
+
...
* If you do not configure the system to use automatic disk ownership assignment at system setup and configuration, you will need to manually assign disk ownership.
