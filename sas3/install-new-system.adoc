...
---
= Install and cable shelves for a new system installation (DS212C, DS224C, or DS460C shelves)
:icons: font
:imagesdir: ../media/
...
* You can familiarize yourself with the considerations for properly handling SAS cables:
...
* You can familiarize yourself with the considerations for properly handling DS460C drives:
...
== Step 1: Install disk shelves with IOM12/IOM12B/IOM12C modules for a new system installation
