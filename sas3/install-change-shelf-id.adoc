...
summary: "Change a shelf ID in a system when ONTAP is not yet running, when hot-adding a shelf prior to it being cabled to the system, or when ONTAP is up and running and all drives in the shelf are unowned, spares, or part of offlined aggregate(s)."
---
...
. Repeat the preceding steps for each additional disk shelf.
