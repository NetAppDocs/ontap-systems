...
summary: "You can hot-remove a disk shelf when it needs to be removed or replaced from a system that is powered on and I/O is in progress."
---
= Hot-remove a DS212C, DS224C, or DS460C shelf
:icons: font
:imagesdir: ../media/

[.lead]
You can hot-remove a disk shelf when it needs to be removed or replaced from a system that is powered on and I/O is in progress. You can hot-remove one or more disk shelves from anywhere within a stack of disk shelves or remove a stack of disk shelves.
...
This includes controller-to-shelf cables and shelf-to-shelf cables for all disk shelves in the stack you are removing.
 ...
 .. Skip ahead to reenabling automatic assignment if needed (several steps below).
 ...
 ** The IOM12, IOM12B, or IOM12C modules are arranged side-by-side as in a DS224C or DS212C disk shelf; if you have a DS460C, the IOM12, IOM12B, or IOM12C modules are arranged one above the other.
...
If you move a DS460C shelf to a different part of the data center or transport the shelf to a different location, you must remove the drives from the drive drawers to avoid possible damage to the drive drawers and drives.
