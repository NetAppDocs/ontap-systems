...
summary: "If a fan module fails in a DS460C drive shelf, you must replace it as soon as possible to ensure that the shelf has adequate cooling."
---
= Replace a DS460C fan module
:icons: font
:imagesdir: ../media/
