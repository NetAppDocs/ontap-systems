...
summary: "You can use a cabling worksheet to define the controller SAS port pairs you can use to cable controllers to stacks of disk shelves to achieve multipathed connectivity."
---
