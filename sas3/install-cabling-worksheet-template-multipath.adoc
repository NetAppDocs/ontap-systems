...
---
= Cabling worksheet for DS212C, DS224C, or DS460C multipathed connectivity
:icons: font
:imagesdir: ../media/

[.lead]
You can use a cabling worksheet to define the controller SAS port pairs you can use to cable controllers to stacks of disk shelves to achieve multipathed connectivity in an HA pair or single-controller configuration. You can also use the completed worksheet to walk yourself through cabling the multipathed connections for your configuration.
