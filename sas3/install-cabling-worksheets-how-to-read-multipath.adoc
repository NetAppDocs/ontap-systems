...
summary: "Use this example to guide you through reading and applying a completed worksheet to cable controller-to-stack connections for disk shelves for multipathed connectivity."
---
= Read a cabling worksheet for DS212C, DS224C, or DS460C multipathed controller-to-stack connections
:icons: font
:imagesdir: ../media/

[.lead]
You can use this example to guide you through how to read and apply a completed worksheet to cable controller-to-stack connections for disk shelves with IOM12, IOM12B, or IOM12C modules for multipathed connectivity.
...
+
The configuration used in this example is a multipath HA configuration with two quad-port SAS HBAs (eight SAS ports) on each controller and two stacks of disk shelves with IOM12, IOM12B, or IOM12C modules. Port pairs are cabled by skipping every other port pair in the worksheet.
+
