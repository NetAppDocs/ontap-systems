...
---
= Cabling worksheet for a DS212C, DS224C, or DS460C quad-path HA configuration with two quad-port SAS HBAs
:icons: font
:imagesdir: ../media/

[.lead]
You can use the completed controller-to-stack cabling worksheet and cabling example to cable a quad-path HA configuration that has two quad-port SAS HBAs. This applies to shelves with IOM12, IOM12B, or IOM12C modules.
