...
summary: "You can use the controller-to-stack cabling worksheets and examples to cable your HA pair as a multipath HA configuration."
---
= Cabling worksheets for DS212C, DS224C, or DS460C multipath HA configurations
:icons: font
:imagesdir: ../media/
...
This applies to shelves with IOM12, IOM12B, or IOM12C modules.
