...
[.lead]
You can use the controller-to-stack cabling worksheets and cabling examples to cable your HA pair as a multipath HA configuration. This applies to shelves with IOM12, IOM12B, or IOM12C modules.
