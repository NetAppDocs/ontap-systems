...
---
= Cabling worksheets for DS212C, DS224C, or DS460C shelves with internal storage platforms
:icons: font
:imagesdir: ../media/

[.lead]
You can use the completed controller-to-stack cabling worksheets and cabling examples to cable platforms with internal storage. This applies to shelves with IOM12, IOM12B, or IOM12C modules.
...
NOTE: This section does not apply to FAS2820 systems.
