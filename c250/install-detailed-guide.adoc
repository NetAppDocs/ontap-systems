...
---
= Install an AFF C250 storage system using detailed steps
:icons: font
:imagesdir: ../media/

[.lead]
Install an AFF C250 storage system using detailed, step-by-step instructions covering racking, cabling, and initial system bring-up.
...
.Steps
. Cable the cluster interconnect ports e0c to e0c and e0d to e0d with the 25 GbE cluster interconnect cables.
+
...
.Option 2: Cable to a 25 GbE data or host network
--
