...
summary: Key specifications for the ASA A250 storage system
---
= Key specifications for an ASA A250 system
:icons: font
:imagesdir: ../media/

[.lead]
The following are select specifications for the ASA A250. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA A250 specifications. This page is reflective of a single high availability pair. 
