...
summary: After installing the new boot media device in your AFF C800 system, you can start the automated boot media recovery process to restore the configuration from the partner node.
---
