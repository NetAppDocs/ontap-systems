...
---
= Install and set up an AFF C800 system using detailed step-by-step instructions
:icons: font
:imagesdir: ../media/
...
+
link:../platform-supplemental/superrail-install.html[SuperRail kit installation instructions]
