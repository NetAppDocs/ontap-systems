...
---
= Review requirements before replacing the controller in your AFF C800 system
:icons: font
:imagesdir: ../media/
...
After you've reviewed the requirements to replace your AFF C800 controller, you need to link:controller-replace-shutdown.html[shut down the impaired controller].