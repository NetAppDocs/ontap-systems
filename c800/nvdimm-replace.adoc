...
summary: "Replace the NVDIMM in your AFF C800 system when your system registers that the flash lifetime is almost at an end or that the identified NVDIMM is not healthy in general."
---
= Replace an NVDIMM in your AFF C800 system
:icons: font
:imagesdir: ../media/
