...
summary: Get started with replacing the chassis of your AFF C800 storage system by reviewing the replacement requirements, shutting down the controllers, replacing the chassis, and verifying system operations.
---
= AFF C800 chassis replacement workflow
:icons: font
:imagesdir: ../media/

[.lead]
Get started with replacing the chassis of your AFF C800 storage system by reviewing the replacement requirements, shutting down the controllers, replacing the chassis, and verifying system operations. 
