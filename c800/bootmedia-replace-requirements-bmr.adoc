...
summary: Before replacing the boot media in your AFF C800 system, ensure you meet the necessary requirements for a successful replacement.
---
= Review requirements for automated boot media recovery in your AFF C800 system
:icons: font
:imagesdir: ../media/
