...
---
= Replace the chassis in your AFF C800 system
:icons: font
:imagesdir: ../media/
...
After you have replaced the impaired AFF C800 chassis and reinstalled the components, you need to link:chassis-replace-complete-system-restore-rma.html[complete the chassis replacement]
