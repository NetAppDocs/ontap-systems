...
summary: "Replace the controller in your AFF C800 system when a hardware failure requires it. The replacement process involves removing the impaired controller, moving the components to the replacement controller, installing the replacement controller, and rebooting it."
---
= Replace the controller in an AFF C800 system
:icons: font
:imagesdir: ../media/
...
After you've replaced the impaired AFF C800 controller, you need to link:controller-replace-system-config-restore-and-verify.html[restore the system configuration]
