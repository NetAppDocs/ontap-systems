...
---
= Replace a PCIe card in an AFF C800 system
:icons: font
:imagesdir: ../media/

[.lead]
Replace a PCIe card in your AFF C800 system when the card fails, requires an upgrade to support higher performance, or additional features. The replacement process involves shutting down the controller, replacing the failed PCIe card, rebooting the controller, and returning the failed part to NetApp.
