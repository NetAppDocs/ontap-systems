...
After you’ve the reviewed the requirements to replace your FAS70 or FAS90 controller, you need to link:controller-replace-shutdown.html[shut down the impaired controller].
