...
summary: This workflow uses a USB drive to reinstall ONTAP onto the replacement boot media in your FAS70 or FAS90 system. Download the appropriate ONTAP recovery image from the NetApp Support Site, copy it to the USB drive, and use it to restore the system to operational status.
---
= Boot media replacement workflow for a FAS70 or FAS90 system using the manual boot recovery process
:icons: font
:imagesdir: ../media/

[.lead]
This workflow uses a USB drive to reinstall ONTAP onto the replacement boot media in your FAS70 or FAS90 system. Download the appropriate ONTAP recovery image from the NetApp Support Site, copy it to the USB drive, and use it to restore the system to operational status.
