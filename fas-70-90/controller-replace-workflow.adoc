...
summary: Get started with replacing the controller in your FAS70 or FAS90 storage system by shutting down the impaired controller, removing and replacing the controller, reconfiguring the system settings, and verifying system operations.
---
= Quick start for controller replacement - FAS70 and FAS90
:icons: font
:imagesdir: ../media/

[.lead]
Get started with replacing the controller in your FAS70 or FAS90 storage system by shutting down the impaired controller, removing and replacing the controller, restoring the system configuration, and verifying system operations.
