...
. Locate the failed FlashCache module carrier, in slot 6, by the lit amber Attention LED on the front of the caching module.

+

image::../media/drw_remove_caching_module_carrier_ieops-1772.svg[Remove the caching module carrier]
