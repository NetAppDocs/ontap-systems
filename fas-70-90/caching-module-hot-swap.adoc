...
* Replace the FlashCache drive carrier
...
.About this task
The drives in the carrier are not a field replaceable unit (FRU). You must replace the entire FlashCache drive carrier. 
