...
summary: The NVMe SSD FlashCache module carrier contains one or two FlashCache modules (caching modules) with a single SSD caching drive integrated into each caching module. 
---
= Replace the FlashCache module carrier - FAS70 and FAS90
:icons: font
:imagesdir: ../media/

[.lead]
The NVMe SSD FlashCache module carrier contains one or two FlashCache modules (caching modules) with a single SSD FlashCache drive integrated into each FlashCache drive carrier. 
...
.Option 1: Replace the FlashCache module carrier
...
--
.Option 2: Replace a FlashCache module
--
