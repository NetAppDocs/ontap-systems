...
---
= Hot-swap a caching module or FlashCache drive carrier - FAS70 and FAS90
:icons: font
:imagesdir: ../media/
...
* The FlashCache module is located in slot 6 and is not hot-swappable. * The Flashcache module houses one or two FlashCache drive carriers in Slot 6-1 and/or 6-2 of FAS70 or FAS90 systems only. 
* Individual FlashCache drive carriers are hot-swappable. 
* The drives in the carrier are not a FRU. You must replace the whole FlashCache drive carrier. 
* FlashCache drive carrier must have the same capacity as existing drives or different supported vendor.
...
The FlashCache module is located in slot 6. The FlashCache module is the carrier for the two FlashCache drive carriers.
...
The FlashCache drive carriers are located in Slot 6-1 or 6-2 or both of the FAS70 and FAS90 systems. You can hot-swap the individual FlashCache drive carriers with drives of the same capacity from the same or different supported vendor.
