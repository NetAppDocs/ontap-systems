...
---
= FAS70 and FAS90 installation and configuration workflow
:icons: font
:imagesdir: ../media/
...
Review the equipment and tools needed to install your storage system and storage shelves. Also review the lifting and safety precautions.
...
[role="quick-margin-para"]
Before you power on the controllers, power on each NS224 shelf and assign a unique shelf ID so each shelf is uniquely identified. Then connect the laptop or console to the controller, and connect the controllers to the power sources.
