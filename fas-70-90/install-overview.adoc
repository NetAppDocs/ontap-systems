...
summary: 'Follow these high-level steps to install and set up your FAS70 or FAS90 storage system and deploy it as a node in your ONTAP system.'
---
...
[.lead]
Follow these workflow steps to install, set up, and deploy your FAS70 and FAS90 storage systems.
