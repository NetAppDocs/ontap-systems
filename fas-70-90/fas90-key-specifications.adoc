...
---
= Key specifications for a FAS90 system
:icons: font
:imagesdir: ../media/

[.lead]
These are select specifications for the FAS90 storage system in a single high-availability pair. Visit NetApp Hardware Universe (HWU) for the complete specifications for this storage system.
