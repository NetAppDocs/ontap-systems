...
summary: Add an IO module to yourFAS70 and FAS90 system to enhance network connectivity and expand your system's ability to handle data traffic.
---
= Add an I/O module to your FAS70 or FAS90 system to enhance network connectivity
:icons: font
:imagesdir: ../media/
