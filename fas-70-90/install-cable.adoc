...
---
= Cable your FAS70 or FAS90 hardware for network and storage connectivity
:icons: font
:imagesdir: ../media/
...
For additional SAS shelf cabling guidance, see link:https://docs.netapp.com/us-en/ontap-systems/sas3/install-cabling-rules.html[SAS cabling rules and concepts - shelves with IOM12/IOM12B modules].
...
The FAS70 and FAS90 storage systems support DS212C, DS224C, DS460C, and NS224 shelves with either the NSM100 or NSM100B module.
...
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.png[mini-SAS HD cable,width=100px]
