...
+
image:../media/drw_fas70-90_twoshelf_ds460c_cabling_controller1_ieops-1918.svg[Cable controller A ports e10a, e11c and e11b and e11d to two DS460C shelves]
+

. On controller B, cable the following connections:

+
image:../media/drw_fas70-90_twoshelf_ds460c_cabling_controller2_ieops-1919.svg
+
