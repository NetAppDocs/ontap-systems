...
---
= Key specifications for a FAS70 system
:icons: font
:imagesdir: ../media/

[.lead]
These are select specifications for the FAS70 storage system in a single high-availability pair. Visit NetApp Hardware Universe (HWU) for the complete specifications for this storage system.
...
* Memory: 256.0000 GB
* Form Factor: 2U chassis with one HA controller 
...
* Depth: 30.0" (35.2" with cable management bracket)
...
* Acoustic Noise: Declared sound power (LwAd): 8.5; Sound pressure (LpAm) (bystander positions): 67.7 dB

== Compliance
* Certifications EMC/EMI: AMCA, FCC,
ICES,
KC,
Morocco,
VCCI
