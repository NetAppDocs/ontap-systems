...
summary: To ensure data security on your FAS70 or FAS90 storage system, you need to verify the encryption key support and status on your boot media. Check if your ONTAP version supports NetApp Volume Encryption, and before you shut down the controller check if the key manager is active.
---
= Check encryption support on the boot media in a FAS70 or FAS90 system using the manual boot recovery process
:icons: font
:imagesdir: ../media/
