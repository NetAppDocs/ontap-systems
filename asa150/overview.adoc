...
summary: Key specifications for the ASA A150 storage system
---
= Key specifications for an ASA A150 system
:icons: font
:imagesdir: ../media/

[.lead]
The following are select specifications for the ASA A150. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of ASA A150 specifications. This page is reflective of a single high availability pair. 
