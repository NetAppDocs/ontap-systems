...
summary: "Use the following videos to learn how to rack and cable your system and perform initial system configuration."
---
= Install your ASA A150 storage system with video steps
:icons: font
:imagesdir: ../media/
