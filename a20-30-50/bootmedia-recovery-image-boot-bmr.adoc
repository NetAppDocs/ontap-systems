...
summary: After installing the new boot media device in your AFF A20, AFF A30, or AFF A50 storage system, you can start the automated boot media recovery process to restore the configuration from the partner node.  
---
