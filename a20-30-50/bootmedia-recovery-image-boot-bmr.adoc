...
summary: After installing the new boot media device in your AFF A20, AFF A30, or AFF A50 storage system, you can start the automatic boot media recovery process to restore the configuration from the partner node.  
---
= Automatic boot media recovery from the partner node - AFF A20, AFF A30, and AFF A50
:icons: font
:imagesdir: ../media/

[.lead]
After installing the new boot media device in your AFF A20, AFF A30, or AFF A50 storage system, you can start the automatic boot media recovery process to restore the configuration from the partner node. During the recovery process, the system checks whether encryption is enabled and determines the type of key encryption in use. If key encryption is enabled, the system guides you through the appropriate steps to restore it. 
