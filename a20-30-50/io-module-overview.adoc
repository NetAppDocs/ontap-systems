...
When an I/O module fails or when you need to expand your network connectivity, you have several options for maintaining your I/O modules:

// You can replace a failed I/O module in your storage system with the same type of I/O module, or with a different type of I/O module. You can hot-swap certain I/O modules when your storage system meets specific requirements. You can also add an I/O module to a storage system with available slots.
...
+
To use this procedure, your storage system must be running ONTAP 9.17.1 or ONTAP 9.18.1 or later and meet specific ONTAP version requirements for your storage system.

* link:io-module-replace.html[Replace an I/O module]
+
You can replace a failed I/O module to restore the storage system to its optimal operating state. This procedure requires a manual takeover of the impaired controller by the healthy controller.
