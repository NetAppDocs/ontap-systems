...
---
= Learn about adding and replacing I/O modules in your AFF A20, AFF A30, or AFF A50 system
:icons: font
:imagesdir: ../media/
...
+
You can hot-swap certain I/O modules for an equivalent I/O module to restore the storage system to its optimal operating state. You don't need to perform a manual takeover to hot-swap the module.
+
//manually take over the controller with the failed I/O module.
+
