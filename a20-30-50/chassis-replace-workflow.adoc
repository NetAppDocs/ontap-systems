...
---
= AFF A20, AFF A30, and AFF A50 chassis replacement workflow
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Replacing the chassis includes moving the drives, drive blanks, controllers (with power supplies), and bezel from the impaired chassis to the new chassis. You then swap out the impaired chassis for a new chassis of the same model.
