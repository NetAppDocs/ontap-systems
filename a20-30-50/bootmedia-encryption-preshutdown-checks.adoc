...
summary: To ensure data security on your A20, AFF A30, or AFF A50 storage system, you need to verify the encryption key support and status on your boot media.
---
