...
[role="quick-margin-para"]
Replacing the controller includes removing the impaired controller, moving the FRU components to the replacement controller, installing the replacement controller in the chassis, setting the time and date, and then recabling.
