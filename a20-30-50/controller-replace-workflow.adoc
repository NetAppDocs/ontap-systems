...
[.lead]
Follow these workflow steps to replace your impaired controller.
...
[role="quick-margin-para"]
Replacing the controller includes removing the impaired controller, moving the FRU components to the replacement controller, and then installing the replacement controller in the chassis.
