...
[.lead]
Add an I/O module to your AFF A20, AFF A30, or AFF A50 storage system to enhance network connectivity and expand your system’s ability to handle data traffic. The adding process involves shutting down one controller, adding the new I/O module, rebooting the controller, shutting down the other controller, adding the new I/O module,and rebooting the controller.
