---
permalink: a20-30-50/specifications.html
sidebar: sidebar
keywords: AFF A50 specifications, AFF A50 specs, NetApp AFF A50, AFF A50 hardware
summary: Key specifications for the AFF A50 storage system
---
...
[.lead]
The following are select specifications for the AFF A50. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A50 specifications. This page is reflective of a single high availability pair. 
