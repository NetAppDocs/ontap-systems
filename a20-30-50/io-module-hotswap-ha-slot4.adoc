...
// Add content as an include or keep as is? Well, for Gizo it's slot 4, for Vino is will be slot 1.
...
include::../_include/g_io_module_hotswap_ha_slot4_move_hardware.adoc[]
...
// Add content as an include or keep as is? Well, for Gizo it's slot 4, for Vino is will be slot 1: g_io_module_hotswap_ha_slot4_bring_online
