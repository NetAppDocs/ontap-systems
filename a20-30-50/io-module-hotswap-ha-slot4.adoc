...
[.lead]
The I/O module in slot 4, also known as the cluster/HA module, supports interconnects for clustering and high-availability. You can hot-swap a cluster/HA I/O module in your AFF A20, AFF A30, or AFF A50 storage system when the module fails. 
