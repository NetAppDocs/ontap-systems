...
** The controller with the failed cluster/HA I/O module must have taken over the healthy controller. The take over should have occured automatically if the I/O module is failed.
+
