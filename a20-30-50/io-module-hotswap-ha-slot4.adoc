...
//old: Hot-swap the cluster/HA module in slot 4 - AFF A20, AFF A30, and AFF A50

[.lead]
The I/O module in slot 4, also known as the cluster/HA I/O module, supports interconnects for clustering and high-availability. You can hot-swap a cluster/HA I/O module in your AFF A20, AFF A30, or AFF A50 storage system when the module fails.

The hot-swap process involves preparing slot 4 for cluster/HA I/O module removal, hot-swapping the failed cluster/HA I/O module for an equivalent module, bringing the replacement cluster/HA I/O module online, and returning the failed part to NetApp.
...
** The I/O module that failed must be a cluster/HA I/O module in slot 4 and you must be replacing it with an equivalent I/O module. You cannot change the I/O module type.
** Your storage system configuration must have only one cluster/HA I/O module located in slot 4, not two cluster/HA I/O modules.
** The controller with the failed cluster/HA I/O module (the impaired controller) must have taken over the healthy controller. The take over should have occured automatically if the I/O module is failed.
+
