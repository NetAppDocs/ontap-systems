...
summary: "To complete the controller replacement for your AFF A20, AFF A30, or AFF A50 storage system, restore the NetApp Storage Encryption configuration and install the required licenses on the new controller. Confirm that the logical interfaces are reporting to their home ports and perform a cluster health check. Register the new controller's serial number and return the failed part to NetApp."
---
= Complete the controller replacement for your AFF A20, AFF A30, or AFF A50 system
:icons: font
:imagesdir: ../media/
