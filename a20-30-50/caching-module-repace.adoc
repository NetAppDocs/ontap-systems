---
permalink: a20-30-50/caching-module-replace.html
sidebar: sidebar
keywords: a20, a30, a50, hot swap, replace, FlashCache module, FlashCache drive carrier
...
---
= Replace the FlashCache module - AFF A20, A30, and A50 
:icons: font
:imagesdir: ../media/
...
+
// Add image of cashing module image::../media/drw_fas70-90_remove_caching_module_carrier_ieops-1772.svg[Remove the FlashCache module carrier]
...
// Add image of caching module  image::../media/drw_fas70-90_caching_module_remove_ieops-1773.svg[Remove the caching module]
