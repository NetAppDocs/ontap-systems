...
---
= Boot media replacement workflow for an AFF A20, AFF A30, or AFF A50 system using the manual boot recovery process
:icons: font
:imagesdir: ../media/
...
If your system is running ONTAP 9.17.1 or later, use the link:bootmedia-replace-workflow-bmr.html[automatic boot recovery procedure].
