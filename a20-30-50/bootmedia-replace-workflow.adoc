...
summary: Get started with replacing the boot media in your AFF A20, AFF A30, or AFF A50 storage system by reviewing the replacement requirements, checking encryption status, shutting down the impaired controller, replacing the boot media, booting the recovery image, restoring encryption, and verifying the system functionality.
---
