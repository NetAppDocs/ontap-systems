...
summary: Restore encryption on the replacement boot media in your AFF A20, AFF A30, or AFF A50 storage system to ensure continued data protection. The replacement process involves verifying key availability, reapplying encryption settings, and confirming secure access to your data.
---
= Restore encryption on the boot media in your AFF A20, AFF A30, or AFF A50 system using the manual boot recovery process
:icons: font
:imagesdir: ../media/
