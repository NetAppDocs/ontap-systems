...
sidebar: sidebar
keywords: AFF A20 specifications, AFF A20 specs, NetApp AFF A20, AFF A20 hardware
summary: Key specifications for the AFF A20 storage system
---
...
[.lead]
The following are select specifications for the AFF A20. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF A20 specifications. This page is reflective of a single high availability pair. 
