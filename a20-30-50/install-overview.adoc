...
[.lead]
To install and set up your AFF A20, AFF A30, or AFF A50 system, you review installation requirements, prepare your site, install and cable the hardware components, power on the system, and set up the ONTAP cluster.
