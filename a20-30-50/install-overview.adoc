...
[.lead]
To install and set up your AFF A20, AFF A30, or AFF A50 storage system, your storage system must meet the installation requirements and you must review the considerations, prepare your site, install and cable the hardware components, power on the system, and set up the ONTAP cluster.
