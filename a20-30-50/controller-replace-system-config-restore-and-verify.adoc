...
After you’ve restored and verified the system configuration for your AFF A20, AFF A30, or AFF A50 system, you need to link:controller-replace-recable-reassign-disks.html[give back the controller].