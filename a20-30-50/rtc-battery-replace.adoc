...
summary: "Replace the real-time clock battery, commonly known as a coin cell battery, in your AFF A20, AFF A30, or AFF A50 storage system to ensure that services and applications relying on accurate time synchronization remain operational."
---
= Replace the real-time clock battery in your AFF A20, AFF A30, or AFF A50 system
:icons: font
:imagesdir: ../media/
...
. Turn the thumbscrew counterclockwise to loosen it, and then open the controller cover.
...
NOTE: After you replace the RTC battery, insert the controller, and power on the system for the first BIOS reset, you see the following error messages: 
...
. At the LOADER prompt, enter `bye` to reinitialize the I/O modules and other components, and to reboot the controller.
