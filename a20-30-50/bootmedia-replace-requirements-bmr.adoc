...
summary: "Before replacing the boot media in your AFF A20, AFF A30, and AFF A50 storage system, ensure you meet the necessary requirements for a successful replacement. This includes verifying that you have the correct replacement boot media, confirming that the e0M port on the impaired controller is working properly, and determining whether Onboard Key Manager or External Key Manager is enabled."
---
= Review requirements for automated boot media recovery in your AFF A20, AFF A30, or AFF A50 system
:icons: font
:imagesdir: ../media/
