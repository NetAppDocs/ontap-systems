...
summary: Replace the chassis in your AFF A20, AFF A30, or AFF A50 system when a hardware failure requires it. The replacement process involves removing the controller and power supply units (PSUs), removing the drives from the impaired chassis, installing the replacement chassis, and reinstalling the chassis components.
---
