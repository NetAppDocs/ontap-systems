...
After you’ve cabled the hardware for your AFF A20, AFF A30, or AFF A50 storage system system, you link:install-power-hardware.html[power on the AFF A20, AFF A30, or AFF A50 storage system].
