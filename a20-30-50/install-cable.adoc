...
summary: After you install your AFF A20, AFF A30, or AFF A50 storage system hardware, cable the controllers to the network and shelves.
---
= Cable your AFF A20, AFF A30, or AFF A50 hardware for network and storage connectivity
:icons: font
:imagesdir: ../media/
...
image:../media/oie_cable_sfp_gbe_copper.png[GbE SFP copper connector]
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg[a20 switched cluster cabling diagram using one 25 GbE io module]
--
====
...
.AFF A20, AFF A30, or AFF A50 with one 4-port 10/25 GbE I/O module
...
.AFF A20, AFF A30, or AFF A50 with one 4-port 64 Gb/s FC I/O module
