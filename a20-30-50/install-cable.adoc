...
+
image::../media/drw_isi_g_switchless_2p_100gbe_cabling_ieops-1925.svg[Two-node switchless cluster cabling diagram, width=500px]
...
+
. Cable the Ethernet ports to your host network. 
+
The following examples show some typical host network cabling. See  link:https://hwu.netapp.com[NetApp Hardware Universe^] for your specific storage system configuration.

.. Cable ports e9a and e9b on each controller to the Ethernet data network switch.
...
The following procedures show how to cable the controllers to one shelf and to two shelves. 

For the maximum number of shelves supported for your storage configuration, see link:https://hwu.netapp.com[NetApp Hardware Universe^]??
...
--
Cable each controller to each NSM module on the NS224 shelf. 
...
. On controller A, cable the following ports:
.. Cable port e11a to shelf 1, NSM A port e0a.

.. Cable port e11b to shelf 2, NSM B port e0b.

.. Cable port e8a to shelf 2, NSM A port e0a.

.. Cable port e8b to shelf 1, NSM B port e0b.
+
image:../media/drw_a70-90_2shelf_cabling_a_ieops-1733.svg[Controller-to-shelf connections for controller A]
+

. On controller B, cable the following ports:
.. Cable port e11a to shelf 1, NSM B port e0a.

.. Cable port e11b to shelf 2, NSM A port e0b.

.. Cable port e8a to shelf 2, NSM B port e0a.

.. Cable port e8b to shelf 1, NSM A port e0b.
+
