...
[.lead]
After you install the rack hardware for your AFF A20, AFF A30, or AFF A50 storage system, install the network cables for the controllers, and connect the cables between the controllers and storage shelves.
