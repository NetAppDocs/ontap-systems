...
The I/O modules in slots 2 and 4 are 40/100 GbE modules...The ports on I/O modules in slot 2 and 4 are 40/100 GbE ports. ???? Do I have to change the heading for all 30-50 cabling from "100 GbE I/O modules" to "40/100 GbE I/O modules"?????
