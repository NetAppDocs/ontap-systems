...
*40/100 GbE cables*
+
image::../media/oie_cable_sfp_gbe_copper.png[40/100 Gb cable, width=100pxx]
+
...
*64 Gb/s FC cables*
+
image::../media/oie_cable_sfp_gbe_copper.png[BAD 64 Gb fc cable,width=100pxx]
+
image:../media/oie_cable_sfp_gbe_copper.png[TEST GOOD One GbE SFP copper connector, width=100pxx]
+
image:../media/oie_cable_sfp_gbe_copper.png[TEST 2 64 Gb fc cable,width=100pxx]
+
