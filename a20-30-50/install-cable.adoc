...
NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNBelow

== Step 1: Cable controllers to the network
...
Add tabbed orange and red options here.

. Cable the management network connections.
...
.AFF A20 with one 2-port 100GbE I/O module
...
== Step 2: Cable controllers to the shelves

NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN ABove
...
Add note: The 40/100GbE ports e2b and e4b on the I/O modules in slots 2 and 4 are unused and available for front-end (host) connectivity, if needed.
...
Cable the controllers to your host network. Host connectivity is 40/100 GbE. This procedure differs depending on your configuration.
...
+
image::../media/drw_isi_g_4p_25gbe_optional_cabling_ieops-1923.svg[Cable to 40/100gbe ethernet host network switches]
+
...
Cable the controllers to your management network. This procedure is the same for all of the configurations.
...
This procedure show you how to cable the controllers to one NS224 shelf. This procedure is the same for all of the configurations.
