...
+
The following graphics show common host network cabling examples. If needed, see  link:https://hwu.netapp.com[NetApp Hardware Universe^] for your specific storage system configuration.
...
== Step 2: Cable the controllers to the shelf
