...
--
Cable the controllers to the cluster network switches to create the ONTAP cluster connections, and then cable the controllers to your host network.
...
.. Cable controller A port e3b to NSM B port e0b.
+
