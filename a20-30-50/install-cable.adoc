...
* The NS224 shelves shown in this cabling example use NSM100B modules instead of NSM100 modules. However, the cabling would be the same for NSM100 modules, only the port names would be different: 
