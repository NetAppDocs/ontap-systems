...
Cable the controllers to each other to create the ONTAP cluster connections. This procedure differs depending on your storage system model and I/O module configuration.
...
Cable the controllers to your Ethernet or FC host network. This procedure differs depending on your storage system model and I/O module configuration.

The following are examples of host network cabling. If needed, see link:https://hwu.netapp.com[NetApp Hardware Universe^] for your specific storage system configuration.
