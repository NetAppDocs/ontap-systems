...
[.lead]
[.lead]
After installing the new boot media device in your AFF FF A20, AFF A30, or AFF A50 system, you can boot the recovery image from a USB drive and restore the configuration from the partner node.
