...
After you’ve the reviewed the requirements to replace your AFF A20, AFF A30, or AFF A50 controller, you need to link:controller-replace-shutdown.html[shut down the controllers].