...
---
= Install a FAS9000 storage system using video instructions
:icons: font
:imagesdir: ../media/

[.lead]
Install your FAS9000 system using video instructions that show how to install and cable your system.
