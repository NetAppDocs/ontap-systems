...
---
= Install a FAS9000 storage system using quick steps
:icons: font
:imagesdir: ../media/

[.lead]
Install your FAS9000 system using quick graphic instructions, from racking and cabling through initial system bring-up. Use these steps if you're already familiar with installing NetApp systems.
