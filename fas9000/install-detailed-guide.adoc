...
---
= Install your FAS9000 system using detailed instructions
:icons: font
:imagesdir: ../media/

[.lead]
These detailed, step-by-step instructions guide you through installing your FAS9000 system, from racking and cabling to initial setup. Use these steps if you want more in-depth installation guidance than the quick steps provide.
...
You can cable your new system to DS212C, DS224C, or NS224 shelves, depending on whether it is an AFF or FAS system.
...
You must cable each controller to the NSM modules on the NS224 drive shelf on an AFF A700 or ASA AFF A700 system running ONTAP 9.8 or later.

* This task applies to ASA AFF A700 running ONTAP 9.8 or later only.
* The systems must have at least one X91148A module installed in slot 3 or 7 for each controller. The animation or illustrations show this module installed in both slots 3 and 7.
...
You must cable each controller to the NSM modules on the NS224 drive shelves on an AFF A700 or ASA AFF A700 system running ONTAP 9.8 or later.
...
+
If your system has NS224 drive shelves, the shelves are pre-set to shelf ID 00 and 01. If you want to change the shelf IDs, you must create a tool to insert into the hole where the button is located.
+
...
+
NOTE: The value shown is the system serial number for the target node.
+
