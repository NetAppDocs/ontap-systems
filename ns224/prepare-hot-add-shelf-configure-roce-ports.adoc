---
permalink: ns224/prepare-hot-add-shelf-configure-roce-ports.html
sidebar: sidebar
keywords: ns224, shelves, shelf, ns224 shelves, hot-add, ha, pair, preparation, roce, storage ports
summary: Configure non-dedicated RoCE-capable Ethernet ports for storage use before hot-adding an NS224 shelf.
---
= Configure RoCE-capable ports for storage use for a hot-add - NS224 shelves
:icons: font
:imagesdir: ../media/

[.lead]
Configure non-dedicated RoCE-capable Ethernet ports for storage use before hot-adding an NS224 shelf.

If your HA pair has non-dedicated RoCE-capable Ethernet ports that you are using to hot-add an NS224 shelf, you must configure the ports for storage use and not networking use.
...
If you need to recable existing shelves for your platform model, link:prepare-hot-add-shelf-recable-shelves.html[recable existing shelves]. Otherwise, link:prepare-hot-add-shelf-disable-auto-drive-assign.html[disable automatic drive assignment if needed].
