...
+
image::../media/drw_ns224_a250_c250_f500f_1shelf_IEOPS-963.svg[Cabling for a FAS500f AFF A250 or AFF C250 with one NS224 shelf and one set of ports, width=452px]
