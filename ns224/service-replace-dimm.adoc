...
video::eef28b10-ed93-4aa7-bfce-aa86002f20a2[panopto, title="Replace a DIMM in an NS224 shelf"]
...
. Open the NSM module cover by turning the thumbscrew counterclockwise to loosen, and then open the cover.

+
The FRU label on the NSM module cover shows the location of the DIMMs and DIMM blanks in the center of the NSM module.
