...
video::5794da63-99aa-425a-825f-aa86002f154d[Animation, Hot-swap a power supply in an NS224 shelf"]
...
[cols="1,3"]
|===
a| image:../media/icon_round_01.png[Callout icon 1]
a| Thumb screws
a| image:../media/icon_round_02.png[Callout number 2] 
a| D-SUB DC power cable connector
a| image:../media/icon_round_03.png[Callout number 3] 
a| Power supply handle
a| image:../media/icon_round_04.png[Callout number 4]
