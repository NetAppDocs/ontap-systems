...
---
= Hot-swap an NS224 power supply
:icons: font
:imagesdir: ../media/
...
* If you are replacing an AC power supply for an NS224 shelf, you can watch the following animation to familiarize yourself with the procedure before beginning. The animation shows an NS224 with NSM100 modules, but the steps are the same for shelves with NSM100B modules.
+
