...
+
image::../media/drw_g_t_psu_replace_ieops-1899.svg[Remove a AC PSU]
+
[cols="1,3"]
|===
a| 
...
. Remove the power supply:
.. Rotate the handle up, to its horizontal position, and then grasp it.
.. With your thumb, press the tab to release the locking mechanism. The color of the tab depends on your module model:
+
|===
a| Model a| Tab color
