...
. Open the module air duct on the top of the NSM module.
...
. Locate the RTC battery under the air duct and replace it.
...
+
image::../media/drw_g_and_t_handles_reinstall_ieops-1838.svg[Replace the NSM module.]
