...
---
= Replace the chassis in your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the chassis in your AFF A700s system by moving the power supplies, hard drives, and controller modules from the impaired chassis to the replacement chassis.
