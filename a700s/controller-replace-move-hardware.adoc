...
summary: "Replace the controller in your AFF A700s system by removing the impaired controller, moving FRU components to the replacement module, installing it in the chassis, and booting to Maintenance mode."
---
