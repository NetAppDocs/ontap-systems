...
---
= Replace the controller in your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the controller in your AFF A700s system by removing the impaired controller, moving FRU components to the replacement module, installing it in the chassis, and booting to Maintenance mode.
...
+
image::../media/drw_a700s_nvme_replace.png[Replace the NVRAM card]
+
...
+
image::../media/drw_a700s_nvme_battery_replace.png[Replace the NVRAM battery]
+
...
+
image::../media/drw_a700s_replace_psu.gif[Replace a PSU]
+
