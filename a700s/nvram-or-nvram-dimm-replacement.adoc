...
---
= Replace the NVRAM module and NVRAM DIMMs in your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the NVRAM module and NVRAM DIMMs in your AFF A700s system by removing the NVRAM riser, replacing the failed card, and reinstalling the riser.
