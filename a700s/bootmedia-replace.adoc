...
summary: "Replace the failed boot media on an AFF A700s controller module. The AFF A700s system supports only manual boot media recovery procedures. Automated boot media recovery is not supported."
---
= Replace the boot media in your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the failed boot media on an AFF A700s controller module. This procedure includes removing the controller module from the chassis, locating the failed boot media using the lit LED indicator, physically replacing the boot media component, and restoring the system to normal operation.
