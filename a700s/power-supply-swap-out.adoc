...
summary: "Swap out a power supply in your AFF A700s system by disconnecting the target PSU from the power source, unplugging the power cable, removing the old PSU, installing the replacement PSU, and then reconnecting it to the power source."
---
= Hot-swap a power supply in your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Hot-swap a power supply in your AFF A700s system by disconnecting, removing, and replacing the failed unit, then reconnecting it to the power source.
...
+
image::../media/drw_a700s_replace_psu.png[Replace a PSU]
+
