...
---
= Replace the NVRAM battery in your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Replace the NVRAM battery in your AFF A700s system by removing the controller module, replacing the battery, and reinstalling the controller module.
