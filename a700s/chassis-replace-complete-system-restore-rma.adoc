...
---
= Complete the chassis replacement for your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Complete the chassis replacement for your AFF A700s system by verifying the HA state of the chassis and returning the failed component to NetApp.
