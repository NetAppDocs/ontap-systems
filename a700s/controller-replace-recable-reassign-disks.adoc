...
---
= Recable the system and reassign disks in your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Complete the controller replacement for your AFF A700s system by recabling the storage, restoring the NetApp Storage Encryption configuration (if necessary), and installing licenses for the new controller.
