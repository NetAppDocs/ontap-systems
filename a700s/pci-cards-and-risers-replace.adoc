...
---
= Replace a PCIe card in your AFF A700s system
:icons: font
:imagesdir: ../media/

[.lead]
Replace a PCIe card in your AFF A700s system by disconnecting cables, removing the riser, replacing the card, and recabling.
