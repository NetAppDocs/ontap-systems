...
summary: The AFF C80 controller replacement includes steps to shut down the controller, remove and replace the controller, reconfigure system settings, and verify system operations.
---
...
[.lead]
The AFF C80 controller replacement includes steps to shut down the controller, remove and replace the controller, reconfigure system settings, and verify system operations. 
