...
summary: Key specifications for the AFF C80 storage system
---
= Key specifications for an AFF C80 system
:icons: font
:imagesdir: ../media/

[.lead]
The following are select specifications for the AFF C80. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of AFF C80 specifications. This page is reflective of a single high availability pair. 
