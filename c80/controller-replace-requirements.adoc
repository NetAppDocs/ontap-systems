...
---
= Review requirements before replacing the controller in your AFF C80 storage system
:icons: font
:imagesdir: ../media/
...
After you’ve reviewed the requirements to replace your AFF C80 controller, you need to link:controller-replace-shutdown.html[shut down the impaired controller].