...
After you’ve the reviewed the requirements to replace your AFF C80 controller, you need to link:controller-replace-shutdown.html[shut down the impaired controller].