...
summary: Replace an IO module in your AFF C80 system when the module fails or requires an upgrade to support higher performance or additional features.
---
= Replace an I/O module in your AFF C80 storage system
:icons: font
:imagesdir: ../media/
