...
summary: Get started with replacing the boot media in your AFF C80 storage system by preparing the replacement media, installing it in the system, restoring the boot image, and verifying the system functionality.
---
...
[.lead]
Get started with replacing the boot media in your AFF C80 storage system by preparing the replacement media, installing it in the system, restoring the boot image, and verifying the system functionality.
