...
---
= Cable your AFF C80 hardware for network and storage connectivity
:icons: font
:imagesdir: ../media/
...
The AFF C80 storage system supports NS224 shelves with either the NSM100 or NSM100B module. The major differences between the modules are:
