...
[.lead]
After you install the rack hardware for your AFF C80storage system, install the network cables for the controllers, and connect the cables between the controllers and storage shelves.
...
After you’ve cabled the hardware for your AFF C80system, you link:install-power-hardware.html[power on the AFF C80storage system].
