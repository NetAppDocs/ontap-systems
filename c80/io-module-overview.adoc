...
summary: You can replace a failed IO module in your AFF C80 storage system with the same type of IO module, or with a different kind of IO module. You can also add an IO module into a system with empty slots.
---
= Learn about adding and replacing I/O modules in your AFF C80 storage system
:icons: font
:imagesdir: ../media/
...
+
Hot swapping an I/O module allows you to replace a failed module without shutting down the system, minimizing downtime and maintaining system availability.
