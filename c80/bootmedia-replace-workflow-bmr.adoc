...
summary: The automated recovery of the boot image involves the system automatically identifying and selecting the appropriate boot menu option. It uses the boot image on partner node to reinstall ONTAP on the replacement boot media in your AFF C80 storage system.
---
= Boot media replacement workflow for an AFF C80 system using the automated boot recovery process
:icons: font
:imagesdir: ../media/
