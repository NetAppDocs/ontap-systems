...
---
= FAS50 controller replacement workflow
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Replacing the controller involves removing the impaired controller, moving FRU components to the replacement controller, installing the replacement controller, setting the time and date, and recabling it.
