...
summary: The FAS50 storage systems offer flexibility in expanding or replacing I/O modules to enhance network connectivity and performance. Adding, hot-swapping, or replacing an I/O module is essential when upgrading network capabilities or addressing a failed module.
---
= Learn about adding and replacing I/O modules in your FAS50 system
:icons: font
:imagesdir: ../media/
