...
* You cable each controller to each IOM12 module on each SAS shelf (DS460C shelves are shown).
+
...
--
Connect each controller to the IOM modules on each DS460C shelf.
