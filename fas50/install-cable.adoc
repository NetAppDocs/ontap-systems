...
image::../media/drw_isi_fas50_switchless_2p_100gbe_cabling_ieops-1937.svg[fas50 switchless cluster cabling diagram using two 100gbe io modules]
...
+image::../media/fas50_4p_25gbe_optional_cabling_ieops-1934.svg[cable fas50 to 25gbe ethernet host network switches]
