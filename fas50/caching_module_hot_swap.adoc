...
sidebar: sidebar
keywords: fas50, hot swap, replace, FlashCache, flash cache
summary: "The NVMe SSD FlashCache modules (FlashCache or caching modules) are located in the front of the NVRAM11 module in Slot 6 of FAS9500 systems only. You can hot-swap the caching module of the same capacity from the same or different supported vendor."
---
