...
summary: Replace an AC or DC power supply unit in your FAS50 storage system when it fails or becomes faulty, ensuring that your system continues to receive the required power for stable operation. The replacement process involves disconnecting the faulty power supply from the power source, unplugging the power cord, replacing the faulty power supply, and then reconnecting it to the power source.
---
= Hot-swap a power supply unit in your FAS50 system
:icons: font
:imagesdir: ../media/
