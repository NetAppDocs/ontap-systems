...
summary: Maintain the FAS50 hardware
---
...
[.lead]
You might need to perform maintenance procedures on your hardware. Procedures specific to maintaining your FAS50 system components are in this section.

The procedures in this section assume that the FAS50 storage systems have already been deployed as storage nodes in the ONTAP environment.
...
a| A caching module (Flash Cache module) utilizes high-speed SSDs to store frequently accessed data ("hot data") for quicker retrieval.
