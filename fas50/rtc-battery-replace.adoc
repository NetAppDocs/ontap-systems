...
summary: Replace the real-time clock battery, commonly known as a coin cell battery, in your FAS50 storage system to ensure that services and applications relying on accurate time synchronization remain operational.
---
= Replace the real-time clock battery in your FAS50 system
:icons: font
:imagesdir: ../media/
...
NOTE: After you replace the RTC battery, insert the controller, and power it on for the first BIOS reset, you see the following error messages:
