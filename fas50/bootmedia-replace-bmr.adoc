...
summary: The boot media in your FAS50 storage system stores essential firmware and configuration data. The replacement process involves removing the controller module, removing the impaired boot media, installing the replacement boot media, and then reinstalling the controller module.
---
= Replace the boot media in your FAS50 system using the automated boot recovery process
:icons: font
:imagesdir: ../media/
