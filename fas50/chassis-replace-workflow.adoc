...
summary: Follow these workflow steps to replace your FAS50 storage system chassis.
---
= FAS50 chassis replacement workflow
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Replacing the chassis includes moving the drive blanks, any caching modules, controllers (with the power supplies), and bezel from the impaired chassis to the new chassis. You then swap out the impaired chassis with a new chassis of the same model.
