...
[.lead]
The following are a selection of key specifications for an FAS50 system in a single high availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of FAS50 specifications.
