...
summary: Key specifications for the FAS50 storage system
---
...
[.lead]
The following are select specifications for the FAS50. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of FAS50 specifications. This page is reflective of a single high availability pair. 
