...
---
= Key specifications for a FAS50 system
:icons: font
:imagesdir: ../media/

[.lead]
These specifications for the FAS50 reflect a single high-availability pair. Visit https://hwu.netapp.com[NetApp Hardware Universe^] (HWU) for a complete list of FAS50 specifications.
